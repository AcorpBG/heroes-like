...
constexpr int32_t DIRECT_ENTRY_OPTIONAL_HANDLER_SENTINEL_0X4602C1 = 1;
...
struct SourceOrderSchedulerCall4a8db2 {
	...
	bool early_direct_0x4a901a = false;
	int32_t source_pair_success_byte_0x3c_before = 0;
	int32_t source_pair_success_byte_0x3c_after = 0;
	int32_t direct_candidate_vector_index_0x4a93a2 = -1;
	int32_t direct_candidate_accepted_count_0x4a93a2 = 0;
...
struct SourceOrderSchedulerResult4a8db2 {
	...
	int32_t direct_prepass_call_count = 0;
	int32_t weighted_call_count = 0;
	int32_t early_direct_call_count_0x4a901a = 0;
	int32_t committed_call_count = 0;
...
struct GeneratorRelationOwnerState4a218c {
	...
	bool boundary_payload_span_limit_0x1c_known = false;
	int32_t boundary_payload_span_limit_0x1c = 1;
...
struct SourceNodeFootprintResult4a3a03 {
	...
	int32_t synthetic_source_candidate_count_0x4a3b48 = 0;
...
struct FootprintFinalizerResult4a3710 {
	...
	int32_t generator_mode_0x10b8 = 0;
	int32_t caller_level_argument_0x0c = 0;
...
struct RewardGuardProjectionObject540b14 {
	...
	bool base_wrapper_pointer_plus_0x04_known = false;
	int32_t base_wrapper_index_plus_0x04 = -1;
	bool base_coordinate_plus_0x08_0x10_known = false;
	int32_t base_x_plus_0x08 = -1;
	int32_t base_y_plus_0x0c = -1;
	int32_t base_level_plus_0x10 = -1;
...
struct RewardGuardProjectionChainResult49c0a6 {
	...
	bool generator_wrapper_vector_available_0x88_0x8c = false;
	int32_t generator_wrapper_vector_scan_count_0x4ad947 = 0;
	bool generator_wrapper_vector_match_found_0x4ad947 = false;
	int32_t selected_wrapper_index_0x4ad947 = -1;
	int32_t previous_wrapper_index_0x4ad947 = -1;
	bool wrapper_reference_switch_applied_0x4ad947 = false;
	bool projection_coordinate_plus_0x08_0x10_known = false;
	int32_t projection_x_plus_0x08 = -1;
	int32_t projection_y_plus_0x0c = -1;
	int32_t projection_level_plus_0x10 = -1;
	bool projection_generated_cell_word_0x20_known = false;
...
struct ConnectionFallbackMaterializationRecord4a7605_4a5e03 {
	...
	bool require_source_cell_prestate_0x4a5e03 = true;
	bool object_record_vtable_0x00_known = false;
	uint32_t object_record_vtable_0x00 = 0U;
	bool object_record_sequence_0x1c_known = false;
	int32_t object_record_sequence_0x1c = -1;
	bool object_record_selected_index_0x20_known = false;
...
struct ObjectRecordReference4a54a7 {
	...
	bool connection_pre_border_record_0x4a61bc_0x4a5e03_known = false;
	uint32_t connection_pre_border_arg0_0x4a5e03 = 0U;
	uint32_t connection_pre_border_descriptor_pointer = 0U;
	bool connection_direct_endpoint_record_0x4a7312_0x4a54a7_known = false;
	uint32_t connection_direct_endpoint_descriptor_pointer = 0U;
	int32_t connection_direct_endpoint_expected_owner_byte2 = -1;
...
struct ConnectionTailReplayResult4a79a3 {
	...
	bool pre_border_materialization_known = false;
	bool pre_border_materialization_applied = false;
	int32_t pre_border_materialization_commit_count = 0;
	bool direct_endpoint_materialization_known = false;
	bool direct_endpoint_materialization_applied = false;
	int32_t direct_endpoint_materialization_commit_count = 0;
...
struct GeneratorObjectPrivateState {
	...
	bool connection_pre_border_materialization_0x4a61bc_0x4a5e03_known = false;
	bool connection_pre_border_materialization_records_available_for_scope = false;
	int32_t connection_pre_border_materialization_record_count = 0;
	int32_t connection_pre_border_materialization_commit_count = 0;
	int32_t connection_pre_border_materialization_blocked_count = 0;
	int32_t connection_pre_border_materialization_first_blocked_record_index = -1;
	std::string connection_pre_border_materialization_first_blocked_reason;
	std::vector<ConnectionFallbackMaterializationRecord4a7605_4a5e03> connection_pre_border_materialization_records_0x4a61bc_0x4a5e03;
	bool connection_direct_endpoint_materialization_0x4a7312_0x4a54a7_known = false;
	bool connection_direct_endpoint_materialization_records_available_for_scope = false;
	int32_t connection_direct_endpoint_materialization_record_count = 0;
	int32_t connection_direct_endpoint_materialization_commit_count = 0;
	int32_t connection_direct_endpoint_materialization_blocked_count = 0;
	int32_t connection_direct_endpoint_materialization_first_blocked_record_index = -1;
	std::string connection_direct_endpoint_materialization_first_blocked_reason;
	std::vector<ConnectionFallbackMaterializationRecord4a7605_4a5e03> connection_direct_endpoint_materialization_records_0x4a7312_0x4a54a7;
...
bool relation_owner_coordinate_recenter_from_generated_cells_0x4a2ffa(const GeneratedCellRecordGrid0x30 &grid, GeneratorRelationOwnerState4a218c &owner, int32_t *scanned_cell_count = nullptr, int32_t *matched_cell_count = nullptr, bool *coordinate_changed = nullptr);
