...
std::string manifest_json(const Options &options, const std::filesystem::path &absolute_output_dir, const std::vector<CaseReport> &case_reports, int skipped_count) {
	...
	out << "  \"required_next_slice\": \"port_source_order_mine_resource_coordinate_builder_0x4a9641_and_density_followup_0x4a9c7c_before_relation_reward_connection_final_writeout\",\n";
