...
Dictionary h3_materialized_static_candidate_record(const Dictionary &source_record, int32_t vector_index, const char *source_group) {
	...
	record["candidate_vector_index"] = vector_index;
	record["static_subset_index"] = -1;
...
void h3_append_materialized_static_candidates_range(Array &target, const Array &source_records, int32_t source_begin, int32_t source_count, int32_t first_candidate_vector_index, const char *source_group) {
	for (int32_t offset = 0; offset < source_count; ++offset) {
		const int32_t source_index = source_begin + offset;
		if (source_index < 0 || source_index >= source_records.size() || Variant(source_records[source_index]).get_type() != Variant::DICTIONARY) {
			continue;
		}
		Dictionary record = h3_materialized_static_candidate_record(source_records[source_index], first_candidate_vector_index + offset, source_group);
		record["static_subset_index"] = int32_t(target.size());
		target.append(record);
	}
}

void h3_append_materialized_static_candidates(Array &target, const Array &source_records, int32_t first_candidate_vector_index, const char *source_group) {
	for (int64_t index = 0; index < source_records.size(); ++index) {
		if (Variant(source_records[index]).get_type() != Variant::DICTIONARY) {
			continue;
		}
		Dictionary record = h3_materialized_static_candidate_record(source_records[index], first_candidate_vector_index + int32_t(index), source_group);
		record["static_subset_index"] = int32_t(target.size());
		target.append(record);
	}
}

Array h3_materialized_static_candidate_records() {
	Array records;
	h3_append_materialized_static_candidates(records, Array::make(
			h3_static_candidate_record("0x49f97b", "0x540ba0", 2, 0, 100, 20),
			h3_static_candidate_record("0x49f9be", "0x540ba0", 4, 0, 3000, 50)), 0, "0x49f95a_static_prefix");
	h3_append_materialized_static_candidates(records, h3_fixed_type6_value_band_records(), 120, "0x49fa54_0x49ff54_fixed_type6_value_bands");
	const Array static_tail = h3_static_tail_after_artifact_pool_records();
	h3_append_materialized_static_candidates_range(records, static_tail, 0, 14, 178, "0x4a00cc_0x4a03cf_static_tail_before_type17");
	h3_append_materialized_static_candidates_range(records, static_tail, 14, int32_t(static_tail.size()) - 14, 250, "0x4a0466_0x4a0eeb_static_tail_after_type17");
	h3_append_materialized_static_candidates(records, h3_static_tail_after_terrain_loop_records(), 675, "0x4a1194_0x4a1701_static_constructor_tail");
	return records;
}
...
Dictionary h3_materialized_single_level_candidate_vector_order_boundary() {
	...
	boundary["segments"] = Array::make(
			...
			h3_candidate_vector_order_segment("type10_object_bucket_loop", "0x49ff59..0x4a00c7", 138, 40, false),
			...
			h3_candidate_vector_order_segment("type53_object_bucket_loop", "0x4a0eeb..0x4a1194", 297, 378, false),
...
Dictionary h3_materialized_static_candidate_boundary() {
	Array records = h3_materialized_static_candidate_records();
	Dictionary boundary;
	boundary["status"] = "static_candidate_records_materialized_dynamic_subset_pending";
	boundary["source_groups"] = Array::make("0x49f95a_static_prefix", "0x49fa54_0x49ff54_fixed_type6_value_bands", "0x4a00cc_0x4a03cf_static_tail_before_type17", "0x4a0466_0x4a0eeb_static_tail_after_type17", "0x4a1194_0x4a1701_static_constructor_tail");
	boundary["materialized_static_candidate_record_count"] = records.size();
...
Dictionary h3_object_metadata_initializer_boundary() {
	Dictionary boundary;
	boundary["status"] = "metadata_bucket_remap_materialized_for_type10_bucket";
	boundary["initializer_range"] = "0x401d24..0x401e0c";
	...
	boundary["default_bucket_index_initializer"] = "0x401d5d..0x401d83 writes entry+0x08 = source_type";
	boundary["bucket_remap_override_source_range"] = "0x52fa04..0x52fb74";
	boundary["bucket_remap_override_count"] = 46;
	boundary["type10_has_bucket_remap_override"] = false;
	boundary["bucket10_has_inbound_remap_override"] = false;
	boundary["type10_bucket_index"] = 10;
	boundary["type10_bucket_index_source"] = "default source_type bucket index";
	boundary["serialize_first_pass_source_range"] = "0x52fb74..0x52fcf0";
	boundary["serialize_first_pass_count"] = 95;
	boundary["primary_gate_source_range"] = "0x52fd78..0x52fe20";
	boundary["primary_gate_count"] = 42;
	boundary["secondary_gate_source_range"] = "0x52fcf0..0x52fd78";
	boundary["secondary_gate_count"] = 34;
	boundary["wide_placement_source_range"] = "0x52fe20..0x52fec8";
	boundary["wide_placement_count"] = 42;
	boundary["type10_in_any_flag_array"] = false;
	return boundary;
}

Dictionary h3_type10_object_bucket_vector_layout_boundary() {
	Dictionary boundary;
	boundary["status"] = "producer_layout_and_type10_source_rows_materialized";
	...
	boundary["type10_bucket_id"] = 10;
	boundary["type10_bucket_struct_offset_formula"] = "generator+0x34 + 10*0x10";
	boundary["type10_bucket_struct_offset"] = "generator+0xd4";
	boundary["type10_bucket_begin_offset"] = "generator+0xd8";
	boundary["type10_bucket_end_offset"] = "generator+0xdc";
	boundary["type10_bucket_capacity_offset"] = "generator+0xe0";
	boundary["producer_source_table_pointer_address"] = "0x58d27c";
	boundary["producer_source_table_loader_address"] = "0x490c4c";
	boundary["producer_source_table_name"] = "objects.txt";
	...
	boundary["metadata_initializer"] = h3_object_metadata_initializer_boundary();
	boundary["producer_remap_materialized"] = true;
	boundary["source_rows_materialized"] = true;
	boundary["single_level_filter_accepts_type10"] = true;
	boundary["two_level_filter_accepts_type10"] = true;
	boundary["source_type10_row_count"] = 8;
	boundary["source_type10_subtypes"] = Array::make(0, 1, 2, 3, 4, 5, 6, 7);
	boundary["type10_pool_count_materialized"] = true;
	boundary["type10_pool_count"] = 8;
	return boundary;
}

Dictionary h3_type10_object_bucket_candidate_loop_boundary() {
	Dictionary boundary;
	boundary["source_range"] = "0x49ff59..0x4a00c7";
	boundary["type10_bucket_vector_offset"] = "generator+0xd8..+0xdc";
	boundary["type10_bucket_vector_layout_status"] = "type10_object_bucket_vector_layout_materialized";
	boundary["type10_bucket_vector_layout"] = h3_type10_object_bucket_vector_layout_boundary();
	...
	boundary["type_id"] = 10;
	boundary["subtype_source"] = "type10_bucket_index";
	boundary["values"] = Array::make(5000, 7500, 10000, 15000, 20000);
	boundary["weight"] = 10;
	boundary["candidate_records_per_bucket_entry"] = 5;
	boundary["iteration_order"] = "descending_type10_bucket_index";
	boundary["type10_bucket_entry_count"] = 8;
	boundary["record_shape_materialized"] = true;
	boundary["candidate_record_values_materialized"] = true;
	boundary["candidate_pool_count_materialized"] = true;
	boundary["candidate_pool_count"] = 8;
	boundary["materialized_candidate_record_count"] = 40;
	boundary["materialized_candidate_records"] = true;
	return boundary;
}

Dictionary h3_type10_object_bucket_materialization_boundary() {
	Dictionary boundary;
	boundary["status"] = "type10_object_bucket_pool_count_materialized";
	boundary["producer_layout"] = h3_type10_object_bucket_vector_layout_boundary();
	boundary["consumer_source_range"] = "0x49ff59..0x4a00c7";
	boundary["consumer_pool_count_formula"] = "(generator+0xdc - generator+0xd8) / 4";
	boundary["consumer_iteration_order"] = "descending_type10_bucket_index";
	...
	boundary["selection_state_buffer_offset"] = "generator+0x1104";
	boundary["selection_state_helper_address"] = "0x48d21c";
	boundary["selection_state_helper_semantics"] = "ensure byte-vector length is at least type-10 bucket count and initialize new bytes from stack seed byte";
	boundary["selection_state_write_source"] = "0x49ff99..0x49ffa4 clears selection byte for each descending type-10 bucket index before appending its five value records";
	...
	boundary["producer_required_before_materialization"] = false;
	boundary["known_consumer_record_shape_safe"] = true;
	boundary["known_pool_contents_safe"] = true;
	boundary["materialized_candidate_record_count"] = 40;
	boundary["materialized_candidate_records"] = true;
	return boundary;
}
...
Dictionary h3_materialized_type17_candidate_record(int32_t relative_loop_index, int32_t subtype, int32_t candidate_vector_index) {
	Dictionary record = h3_static_candidate_record("0x4a0402", "0x540c00", 0x11, subtype, -1, 0x28);
	record["relative_loop_index"] = relative_loop_index;
	record["candidate_vector_index"] = candidate_vector_index;
	record["source_group"] = "0x4a0402_0x4a045a_single_level_type17_loop";
	record["materialized_candidate_record"] = true;
	record["constructor_address"] = "0x49c523";
	record["constructor_vtable_address"] = "0x540ba0";
	record["overridden_vtable_address"] = "0x540c00";
	record["record_size_bytes"] = 0x14;
...
Dictionary h3_materialized_single_level_type17_candidate_boundary() {
	Dictionary boundary;
	boundary["status"] = "single_level_type17_candidate_loop_materialized_with_candidate_indices";
	boundary["source_range"] = "0x4a0402..0x4a045a";
	boundary["constructor_address"] = "0x49c523";
	boundary["constructor_vtable_address"] = "0x540ba0";
	boundary["overridden_vtable_address"] = "0x540c00";
	boundary["record_size_bytes"] = 0x14;
	boundary["type_id"] = 0x11;
	boundary["value"] = -1;
	boundary["weight"] = 0x28;
	boundary["single_level_iteration_count"] = 0x3a;
	boundary["extended_iteration_count"] = 0x50;
	boundary["loop_iteration_order"] = "descending_subtype";
	boundary["first_subtype"] = 0x39;
	boundary["last_subtype"] = 0;
	boundary["first_candidate_vector_index"] = 192;
	boundary["last_candidate_vector_index"] = 249;
	boundary["candidate_vector_indices_materialized"] = true;
	boundary["extended_type17_loop_materialized"] = false;
	Array records;
	for (int32_t subtype = 0x3a - 1; subtype >= 0; --subtype) {
		records.append(h3_materialized_type17_candidate_record(int32_t(records.size()), subtype, 192 + int32_t(records.size())));
	}
	boundary["candidate_record_count"] = records.size();
	boundary["records"] = records;
	return boundary;
...
Dictionary h3_terrain_specialized_candidate_loop_boundary() {
	...
	boundary["materialized_candidate_records"] = true;
	boundary["first_candidate_vector_index"] = 297;
	boundary["last_candidate_vector_index"] = 674;
	boundary["candidate_vector_indices_materialized"] = true;
	return boundary;
}
...
Dictionary h3_static_tail_after_terrain_loop_boundary() {
	...
	boundary["first_candidate_vector_index"] = 675;
	boundary["last_candidate_vector_index"] = 703;
	boundary["candidate_vector_indices_materialized"] = true;
...
Dictionary h3maped_generic_value_selector_boundary() {
	...
	boundary["candidate_builder_type10_object_bucket_loop_status"] = "0x49ff59_0x4a00c7_type10_object_bucket_loop_materialized";
	boundary["candidate_builder_type10_object_bucket_loop"] = h3_type10_object_bucket_candidate_loop_boundary();
	boundary["candidate_builder_type10_object_bucket_materialization_status"] = "type10_object_bucket_pool_count_materialized";
	boundary["candidate_builder_type10_object_bucket_materialization"] = h3_type10_object_bucket_materialization_boundary();
	...
	boundary["materialized_single_level_type17_candidate_boundary_status"] = "single_level_type17_candidate_loop_materialized_with_candidate_indices";
	boundary["materialized_single_level_type17_candidate_boundary"] = h3_materialized_single_level_type17_candidate_boundary();
