...
const OBJECT_LANDMARK_VISIBLE_EXTENT_TILES := 0.55
const OBJECT_BLOCKER_VISIBLE_EXTENT_TILES := 0.50
const OBJECT_DECORATION_VISIBLE_EXTENT_TILES := 0.44
const OBJECT_DEFAULT_VISIBLE_EXTENT_TILES := 0.46
const MULTI_TILE_INTERACTIVE_SPRITE_EXTENT_BASE_MIN_TILES := 0.56
const MULTI_TILE_INTERACTIVE_SPRITE_EXTENT_MIN_STEP_TILES := 0.08
const MULTI_TILE_INTERACTIVE_SPRITE_EXTENT_BASE_CAP_TILES := 0.64
const MULTI_TILE_INTERACTIVE_SPRITE_EXTENT_CAP_STEP_TILES := 0.08
const MULTI_TILE_INTERACTIVE_SPRITE_EXTENT_ABSOLUTE_CAP_TILES := 0.88
...
const GENERATED_DECORATIVE_BODY_SPRITE_EXTENT_TILES := 0.50
