...
const OBJECT_DEFAULT_VISIBLE_EXTENT_TILES := 0.42
const MULTI_TILE_INTERACTIVE_SPRITE_EXTENT_BASE_MIN_TILES := 0.56
const MULTI_TILE_INTERACTIVE_SPRITE_EXTENT_MIN_STEP_TILES := 0.14
...
const MULTI_TILE_INTERACTIVE_SPRITE_EXTENT_ABSOLUTE_CAP_TILES := 1.04
...
const TOWN_SPRITE_EXTENT_FACTOR := 0.60
