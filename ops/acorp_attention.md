...
- Object schema migration should confirm whether visible neutral encounters become first-class object records with guard-target links, danger cues, cleared states, and AI path-blocking hints, separate from camps, dwellings, and guarded reward sites.
...
- Additive overworld object report review/follow-up, safe additive schema planning, and `safe_metadata_bundle_001` implementation are complete locally. The next current companion slice is neutral encounter representation planning before first-class neutral encounter production migration.
