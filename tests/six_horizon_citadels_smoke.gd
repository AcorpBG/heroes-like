...
const CASES := [
	{"town_id":"town_rainwrit_bastion","faction_id":"faction_embercourt","placement_id":"ninefold_rainwrit_bastion","position":Vector2i(11,8),"owner":"player","role":"floodgate_levy_court","asset_id":"town_identity_rainwrit_bastion","atlas_region":Rect2(0,0,512,512),"objective_id":"hold_rainwrit_bastion"},
	{"town_id":"town_hollowreed_sanctuary","faction_id":"faction_mireclaw","placement_id":"ninefold_hollowreed_sanctuary","position":Vector2i(34,59),"owner":"enemy","role":"oathmire_sanctuary","asset_id":"town_identity_hollowreed_sanctuary","atlas_region":Rect2(512,0,512,512),"objective_id":"claim_hollowreed_sanctuary"},
	{"town_id":"town_meridian_choirhold","faction_id":"faction_sunvault","placement_id":"ninefold_meridian_choirhold","position":Vector2i(37,31),"owner":"enemy","role":"resonant_horizon_hold","asset_id":"town_identity_meridian_choirhold","atlas_region":Rect2(1024,0,512,512),"objective_id":"claim_meridian_choirhold"},
	{"town_id":"town_crownroot_refuge","faction_id":"faction_thornwake","placement_id":"ninefold_crownroot_refuge","position":Vector2i(27,49),"owner":"enemy","role":"living_recovery_refuge","asset_id":"town_identity_crownroot_refuge","atlas_region":Rect2(1536,0,512,512),"objective_id":"claim_crownroot_refuge"},
	{"town_id":"town_blackbell_foundry","faction_id":"faction_brasshollow","placement_id":"ninefold_blackbell_foundry","position":Vector2i(46,38),"owner":"enemy","role":"quenchbell_fortress","asset_id":"town_identity_blackbell_foundry","atlas_region":Rect2(2048,0,512,512),"objective_id":"claim_blackbell_foundry"},
	{"town_id":"town_pale_sounding_harbor","faction_id":"faction_veilmourn","placement_id":"ninefold_pale_sounding_harbor","position":Vector2i(55,49),"owner":"enemy","role":"echo_chart_harbor","asset_id":"town_identity_pale_sounding_harbor","atlas_region":Rect2(2560,0,512,512),"objective_id":"claim_pale_sounding_harbor"},
]
