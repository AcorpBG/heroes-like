#!/usr/bin/env python3
"""Retain a normal generated Large Thornwake opening through the shared driver."""
...
def script_text():
    ...
    for old, new in (('"homm3_medium"', '"homm3_large"'),
                     ...
                     ('"hero_vaska"', '"hero_thornwake_ardren_briarmarshal"'),
                     ('"town_duskfen"', '"town_thornwake_graftroot_caravan"'),
                     ('did not produce Duskfen', 'did not produce Graftroot Caravan')):
