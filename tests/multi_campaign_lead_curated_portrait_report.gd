...
const CASES := [
	{
		"hero_id": "hero_caelen",
		"hero_name": "Caelen Ashgrove",
		"faction_id": "faction_embercourt",
		"archetype": "warden",
		"campaign_id": "campaign_stonewake",
		"scenario_id": "stonewake-watch",
		"chapters": [
			{"campaign_id": "campaign_stonewake", "scenario_id": "stonewake-watch"},
			{"campaign_id": "campaign_stonewake", "scenario_id": "reedbarrow-ferry"},
			{"campaign_id": "campaign_stonewake", "scenario_id": "nightglass-redoubt"},
			{"campaign_id": "campaign_ninefold_survey", "scenario_id": "glassfen-breakers"},
		],
		...
		"portrait_path": "res://art/heroes/portraits/hero_caelen.png",
		"portrait_sha256": "02fc9dccd67059024692ee99d87c38e8b4d2993d1cb59f0cd1f17fb6f3638a10",
		"starting_spell_ids": ["spell_trailglyph", "spell_stone_veil", "spell_lantern_phalanx"],
	...
	{
		"hero_id": "hero_mira",
		"hero_name": "Mira Flintmere",
		"faction_id": "faction_embercourt",
		"archetype": "marshal",
		"campaign_id": "campaign_ninefold_survey",
		"scenario_id": "ironbridge-stand",
		"chapters": [
			{"campaign_id": "campaign_ninefold_survey", "scenario_id": "ironbridge-stand"},
			{"campaign_id": "campaign_ninefold_survey", "scenario_id": "ninefold-confluence"},
		],
		...
		"portrait_path": "res://art/heroes/portraits/hero_mira.png",
		"portrait_sha256": "0849f0043fa68041f60090ef6c120f00c082f343380be5276fb91ee441d1aa76",
		"starting_spell_ids": ["spell_quickmarch_hymn", "spell_bulwark_litany", "spell_lantern_phalanx"],
...
func _portrait_contained(frame: Control, portrait: Control, viewport_size: Vector2i) -> bool:
	...
	if not contained:
		print("MULTI_CAMPAIGN_LEAD_PORTRAIT_GEOMETRY ", JSON.stringify({
