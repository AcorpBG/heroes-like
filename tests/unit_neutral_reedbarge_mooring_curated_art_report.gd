...
const REPORT_ID := "UNIT_NEUTRAL_REEDBARGE_MOORING_CURATED_ART_REPORT"
const OUTPUT_DIR := "res://.artifacts/unit_neutral_reedbarge_mooring_curated_art_report"
const SHARED_ARMY_ID := "army_neutral_reedbarge_mooring_watch"
...
const AUTHORED_SITE_ROWS := [
	{"scenario_id": "ninefold-confluence", "placement_id": "dwelling_reedbarge_mooring", "site_id": "site_reedbarge_mooring"},
]
const UNITS := [
	{
		"unit_id": "unit_neutral_reedbarge_poles", "label": "Reedbarge Poles", "count": 8, "tier": 1, "role": "melee", "growth": 7, "cost": {"gold": 60}, "ability_ids": ["reach"], "hp": 9, "attack": 4, "defense": 4, "min_damage": 2, "max_damage": 3, "speed": 4, "initiative": 6, "retaliations": 1, "ranged": false, "shots": -1,
		"source_path": "res://art/units/source/curated/unit_neutral_reedbarge_poles.png", "portrait_path": "res://art/units/portraits/unit_neutral_reedbarge_poles.png", "icon_path": "res://art/units/battle_icons/unit_neutral_reedbarge_poles.png", "overworld_icon_path": "res://art/units/overworld_icons/unit_neutral_reedbarge_poles.png", "sheet_path": "res://art/animation/runtime/units/unit_neutral_reedbarge_poles.png",
		"source_sha256": "af2abca50db6649c2d3dcd2ec7d2ffc14dbbd54e05af10761d256740f7b4babd", "portrait_sha256": "f88220174682cd826565819d64380735f84bcf36250c63404de052333cdfcf6a", "icon_sha256": "63f4cf40b79662510578d8d75ab09d59f1e155332750e7ae750834c3a44d50df", "overworld_icon_sha256": "280a7b447752087ad800e7799656bdecaa515378e19debef4d4366e8c53541d6", "sheet_sha256": "823d823fd036714db9980c3183e9aa10c263168bb693b09b4cfab98ee1783c29",
		"old_portrait_sha256": "e8a956a897bc635d2856b39cb88bcf96af8d65a2732e19ea3983df008ddd1c1d", "old_icon_sha256": "a7d83f0011c02e3509962f413e59973750768ed0654a979e656fb49b17f37926", "old_overworld_icon_sha256": "dcf392282d3d2fc82f3dabbea01ae207cf4d0fb9f0b7626686d851d4e87953ea", "old_sheet_sha256": "fbcfe8eae596d64926fa009c6e53816cb632be69fc4bd33ede09ba7b10b47cc2",
	},
	{
		"unit_id": "unit_neutral_lanternet_throwers", "label": "Lanternet Throwers", "count": 4, "tier": 2, "role": "ranged", "growth": 5, "cost": {"gold": 85}, "ability_ids": ["harry"], "hp": 7, "attack": 5, "defense": 3, "min_damage": 2, "max_damage": 3, "speed": 4, "initiative": 7, "retaliations": 1, "ranged": true, "shots": 7,
		"source_path": "res://art/units/source/curated/unit_neutral_lanternet_throwers.png", "portrait_path": "res://art/units/portraits/unit_neutral_lanternet_throwers.png", "icon_path": "res://art/units/battle_icons/unit_neutral_lanternet_throwers.png", "overworld_icon_path": "res://art/units/overworld_icons/unit_neutral_lanternet_throwers.png", "sheet_path": "res://art/animation/runtime/units/unit_neutral_lanternet_throwers.png",
		"source_sha256": "63409f8f2bf17a119b09c6e2523ebb4f6866270d0917a12667b75690cd04d83f", "portrait_sha256": "4172ad88ce73ed45f8235467a846a19a46e92a231934a075c921ad11e9cf48a7", "icon_sha256": "dcc0c1093c65c8ca712b4a5d81766e37086176b438ae591bb0419b33b9d60d97", "overworld_icon_sha256": "68e27cf96c266e8d8343b4bfc7f345c3bf9c3d7610640edd70099988be32167a", "sheet_sha256": "3bf0a66fbbbdab7add199d6503680c67d4d499a6e4b617119cb99ad2d6b35503",
		"old_portrait_sha256": "3b17afff145fadb5c62551b2bb7d49c30e99d2c41574fe38d675d4348508ba01", "old_icon_sha256": "f59adabbf1cb1ba0cd4af95ef79cbc6ecb1278ec2e180031bb5b7d5f2c656d5f", "old_overworld_icon_sha256": "baf5324fbd45db8e6479e005de94009dd114376e67c4a6dcf1f29e03588b0747", "old_sheet_sha256": "3233b03b042018a566a2d44fff7619f41a60912ea390fab138af6171d87c9539",
	},
]
...
func _run() -> void:
	...
	await _validate_live_reedbarge_battle_board()
...
func _validate_content_authority() -> void:
	var dwelling: Dictionary = ContentService.get_neutral_dwelling("neutral_dwelling_reedbarge_mooring")
	_expect(dwelling.get("unit_ids", []) == ["unit_neutral_reedbarge_poles", "unit_neutral_lanternet_throwers"], "Reedbarge Mooring unit order changed.")
	_expect(dwelling.get("site_ids", []) == ["site_reedbarge_mooring"] and dwelling.get("map_object_ids", []) == ["object_reedbarge_mooring"], "Reedbarge Mooring site/object graph changed.")
	_expect(dwelling.get("army_group_ids", []) == [SHARED_ARMY_ID] and dwelling.get("encounter_ids", []) == ["encounter_reedbarge_mooring_watch"], "Reedbarge Mooring army/encounter graph changed.")
	...
	var native_proxy_rows: Array = proxy_entries.filter(func(row): return row is Dictionary and String(row.get("id", "")) == "dwelling_creature_generator_lizard_reedbarge_mooring_proxy")
	_expect(native_proxy_rows.size() == 1 and int(native_proxy_rows[0].get("homm3_re_object_type_id", -1)) == 17 and int(native_proxy_rows[0].get("homm3_re_object_subtype", -1)) == 30 and int(native_proxy_rows[0].get("homm3_re_object_source_row", -1)) == 208 and String(native_proxy_rows[0].get("homm3_re_object_def_ref", "")) == "AVGlzrd0.def" and String(native_proxy_rows[0].get("native_proxy_object_id", "")) == "object_reedbarge_mooring", "Native-RMG Reedbarge Mooring subtype-30 projection changed.")
	_report["native_rmg_proxy"] = native_proxy_rows[0].duplicate(true) if native_proxy_rows.size() == 1 else {}
	var site: Dictionary = ContentService.get_resource_site("site_reedbarge_mooring")
	_expect(_resource_cost_contract(site.get("claim_rewards", {})) == {"gold": 90} and _resource_cost_contract(site.get("claim_recruits", {})) == {"unit_neutral_reedbarge_poles": 2, "unit_neutral_lanternet_throwers": 1}, "Reedbarge Mooring claim reward/recruit contract changed.")
	_expect(_resource_cost_contract(site.get("control_income", {})) == {"gold": 35} and _resource_cost_contract(site.get("weekly_recruits", {})) == {"unit_neutral_reedbarge_poles": 1}, "Reedbarge Mooring control income/weekly muster changed.")
	var encounter: Dictionary = ContentService.get_encounter("encounter_reedbarge_mooring_watch")
	_expect(String(encounter.get("enemy_group_id", "")) == SHARED_ARMY_ID and String(encounter.get("terrain", "")) == "mire" and int(encounter.get("max_rounds", 0)) == 14, "Reedbarge Mooring encounter authority changed.")
...
func _validate_authored_site_authority() -> void:
	...
	for expected_variant in AUTHORED_SITE_ROWS:
		...
		_expect(not placement.is_empty() and String(placement.get("site_id", "")) == String(expected["site_id"]), "%s must retain authored Reedbarge Mooring site %s." % [String(expected["scenario_id"]), String(expected["placement_id"])])
...
func _validate_live_reedbarge_battle_board() -> void:
	...
	var expected_counts := {"unit_neutral_reedbarge_poles": 8, "unit_neutral_lanternet_throwers": 4}
	var shared_army: Dictionary = ContentService.get_army_group(SHARED_ARMY_ID)
	_expect(String(shared_army.get("id", "")) == SHARED_ARMY_ID and _stack_counts(shared_army) == expected_counts, "Shared Reedbarge Mooring Watch ids/counts changed.")
	var placement := {"placement_id": "reedbarge_mooring_curated_art_fixture", "encounter_id": "encounter_reedbarge_mooring_watch", "enemy_army": shared_army.duplicate(true), "x": 4, "y": 4, "resolved": false}
	...
	_expect(_battle_stack_counts(enemy_stacks) == expected_counts, "Public Reedbarge Mooring battle payload changed its exact enemy roster.")
	for spec_variant in UNITS:
		var spec: Dictionary = spec_variant
	...
	for spec_variant in UNITS:
		...
		_expect(matches.size() == 1, "BattleBoard must expose exactly one %s Reedbarge Mooring stack." % String(spec["label"]))
		if matches.size() == 1:
	...
	_expect(session.to_dict() == authority_before, "BattleBoard art observation must not mutate the live Reedbarge Mooring battle/session.")
