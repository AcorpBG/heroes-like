...
const CASES := [
	{
		...
		"counts": {"unit_blackbranch_cutthroat": 15, "unit_mire_slinger": 10},
		"expected": {"outcome_state": "victory", "matchup_band": "player_disadvantaged", "pacing_band": "extended", "round_reached": 7, "terminal_health_margin_pct": 58, "enemy_damage_per_round": 7},
	...
	},
	{
		...
		"expected": {"outcome_state": "defeat", "matchup_band": "even", "pacing_band": "standard", "round_reached": 5, "terminal_health_margin_pct": 22, "enemy_damage_per_round": 38},
	...
	},
	{
		...
		"expected": {"outcome_state": "defeat", "matchup_band": "even", "pacing_band": "extended", "round_reached": 8, "terminal_health_margin_pct": 35, "enemy_damage_per_round": 18},
	...
	},
	{
		...
		"expected": {"outcome_state": "defeat", "matchup_band": "player_advantaged", "pacing_band": "standard", "round_reached": 4, "terminal_health_margin_pct": 48, "enemy_damage_per_round": 29},
	...
	},
	{
		...
		"counts": {"unit_blackbranch_cutthroat": 14, "unit_mire_slinger": 11, "unit_mireclaw_gorefen_rippers": 2},
		"expected": {"outcome_state": "defeat", "matchup_band": "even", "pacing_band": "extended", "round_reached": 7, "terminal_health_margin_pct": 44, "enemy_damage_per_round": 42},
