...
const LOCAL_ARMY_CONTRACTS := {
	"barrow_pickets": {
		...
		"stack_counts": {"unit_blackbranch_cutthroat": 16, "unit_mire_slinger": 11},
	},
	"reedbarrow_chain": {
...
const UNCHANGED_SAMPLE_CONTRACTS := {
	"barrow_pickets": {"outcome_state": "victory", "pacing_band": "standard", "round_reached": 5, "terminal_health_margin_pct": 76, "enemy_damage_per_round": 6},
