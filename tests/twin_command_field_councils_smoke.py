...
REPORT_ID = "TWIN_COMMAND_FIELD_COUNCILS_SMOKE"
REPORT_PATH = ROOT / ".artifacts/twin_command_field_councils_smoke/report.json"
CAPTURE_DIR = ROOT / ".artifacts/twin_command_field_councils_smoke/captures"
SCENE = "res://tests/twin_command_field_councils_smoke.tscn"
...
def main() -> int:
    ...
    environment["TWIN_COMMAND_FIELD_COUNCILS_CAPTURE_DIR"] = str(CAPTURE_DIR)
    ...
    expected = {"ok": True, "case_count": 6, "exact_art_count": 6, "missing_partner_control_count": 6, "wrong_town_control_count": 6, "enemy_owned_town_control_count": 6, "wrong_hero_control_count": 6, "production_hire_count": 6, "production_transfer_count": 12, "production_battle_count": 18, "production_claim_count": 6, "production_capture_count": 6, "paired_station_count": 6, "scoped_dependency_count": 6, "scenario_victory_count": 6, "save_version": 9, "single_consolidated_smoke": True}
