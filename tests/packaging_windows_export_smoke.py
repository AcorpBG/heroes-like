        ...
        with PCK_PATH.open("rb") as handle:
            ...
            for _ in range(entry_count):
                ...
                if entry_path.startswith(".godot/imported/") and entry_path.endswith(".ctex"):
                    ...
                    if imported_name in {REQUIRED_RECURRING_ENCOUNTER_ATLAS_NAME, REQUIRED_DISSIDENT_ENCOUNTER_ATLAS_NAME, REQUIRED_STANDALONE_CONTRACT_ATLAS_NAME, REQUIRED_OUTER_REACH_CONTRACT_ATLAS_NAME, REQUIRED_MIRE_SUN_CONTRACT_ATLAS_NAME, REQUIRED_ASCENDANT_COMPANY_ATLAS_NAME, REQUIRED_WAYWATCH_TRIAL_ATLAS_NAME, REQUIRED_SPELLWRIGHT_EXPEDITION_ATLAS_NAME, REQUIRED_RITUAL_RELAY_CIRCUIT_ATLAS_NAME, REQUIRED_GRAND_CONVERGENCE_MARCH_ATLAS_NAME, REQUIRED_SYSTEMIC_ENCOUNTER_ATLAS_NAME}:
