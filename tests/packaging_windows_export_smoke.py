...
def main() -> int:
    ...
    generated_runtime_command = [
        ...
        "--live-validation-town-building-sequence=building_market_square,building_veilmourn_fog_signal_buoys,building_veilmourn_salvage_ledger,building_veilmourn_ransom_exchange,building_veilmourn_mirror_drydock",
    ...
    generated_report_ok = (
        ...
        and generated_flow_report.get("town_building_sequence") == ["building_market_square", "building_veilmourn_fog_signal_buoys", "building_veilmourn_salvage_ledger", "building_veilmourn_ransom_exchange", "building_veilmourn_mirror_drydock"]
