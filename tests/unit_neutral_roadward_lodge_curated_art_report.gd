...
const REPORT_ID := "UNIT_NEUTRAL_ROADWARD_LODGE_CURATED_ART_REPORT"
const OUTPUT_DIR := "res://.artifacts/unit_neutral_roadward_lodge_curated_art_report"
const SHARED_ARMY_ID := "army_neutral_roadward_lodge_watch"
...
const AUTHORED_SITE_ROWS := [
	{"scenario_id": "river-pass", "placement_id": "river_free_company", "site_id": "site_riverwatch_free_company_yard"},
	{"scenario_id": "lockmarsh-surge", "placement_id": "surge_free_company", "site_id": "site_free_company_yard"},
	{"scenario_id": "ninefold-confluence", "placement_id": "dwelling_roadward_lodge", "site_id": "site_free_company_yard"},
]
const UNITS := [
	{
		"unit_id": "unit_neutral_roadwardens", "label": "Roadwardens", "count": 8, "tier": 1, "role": "melee", "growth": 7, "cost": {"gold": 55}, "ability_ids": ["reach"], "shots": -1,
		"source_path": "res://art/units/source/curated/unit_neutral_roadwardens.png", "portrait_path": "res://art/units/portraits/unit_neutral_roadwardens.png", "icon_path": "res://art/units/battle_icons/unit_neutral_roadwardens.png", "overworld_icon_path": "res://art/units/overworld_icons/unit_neutral_roadwardens.png", "sheet_path": "res://art/animation/runtime/units/unit_neutral_roadwardens.png",
		"source_sha256": "625b2deb46cd667b28824cb2833338073406d411dc2adaea6e3a116d7a5c14b7", "portrait_sha256": "402be879aaab20d62be5129d7878d976b6af6782cc54c7bbaf45c2a6008f9237", "icon_sha256": "847ed1410ebb068d7dfa5c8581532dcdb8523bf4fe42b3c3031bf1b57cb3d9ce", "overworld_icon_sha256": "e1e048d61238b84d79a1d62501f1c8617cc58f7581f2bb46dfb4d1f89537e402", "sheet_sha256": "a41d5bbca64312bd53348890d7ce4a5a977a6cf9be987d71781a8cfa37dd1dc5",
		"old_portrait_sha256": "f80b12854e0e2fe5ba4e5ae59c0046ab325b4fee8666f18a28c354773aebafc4", "old_icon_sha256": "4e67b40731ea2e74e4c0c299a17dc0bc4d46b35ccae1742a20165cd2e0d1ad4f", "old_overworld_icon_sha256": "e2f1a78b4eeb50dc7554ba03a9d4c0dad3b968a43e9fd0e6f988eeb3f2ea724f", "old_sheet_sha256": "682b9e2757816ee7e20eda0b0089518114f867232136fc0a3c548ff0f91e082b",
	},
	{
		"unit_id": "unit_neutral_hearthbow_carriers", "label": "Hearthbow Carriers", "count": 4, "tier": 2, "role": "ranged", "growth": 5, "cost": {"gold": 80}, "ability_ids": ["harry"], "shots": 7,
		"source_path": "res://art/units/source/curated/unit_neutral_hearthbow_carriers.png", "portrait_path": "res://art/units/portraits/unit_neutral_hearthbow_carriers.png", "icon_path": "res://art/units/battle_icons/unit_neutral_hearthbow_carriers.png", "overworld_icon_path": "res://art/units/overworld_icons/unit_neutral_hearthbow_carriers.png", "sheet_path": "res://art/animation/runtime/units/unit_neutral_hearthbow_carriers.png",
		"source_sha256": "6557279fcd3e442ed0baafe591073874a4242ce246f6e2722d736171ceb812a0", "portrait_sha256": "5b0afc9a417bd74f0fe8956c81f3fc9e8201142fbdc4dc220c556679d18720af", "icon_sha256": "08cb8c7ebeb97fe3e00fe145b06ffc9ac6d061da15671221155db246489a9f2b", "overworld_icon_sha256": "c99df2fc485913eb2d19c83765a349de1d21c419237ae62a49fc4887f37b397a", "sheet_sha256": "da05081536ea798deb36437365f2b0b9c9317d9a9c846d1daa3469e32bfbe5f0",
		"old_portrait_sha256": "e0be6b076d76948d249c3025d7f7c9dfee33f8c5138d459422148c20333baca6", "old_icon_sha256": "8c9f64c42a50f52dd571fad918f1f4d87b50f24fc084e87a9b0cba7c39b30957", "old_overworld_icon_sha256": "4bc5b051015ec74a0cc11da405552829c9e06da8ee9a63b42a64898d0bfdac2a", "old_sheet_sha256": "42cd2c4ef749522915d9172c7fc6ee9578df0faf2971cd18c2835dcd9765195c",
	},
]
...
func _run() -> void:
	...
	await _validate_live_roadward_battle_board()
...
func _validate_content_authority() -> void:
	var dwelling: Dictionary = ContentService.get_neutral_dwelling("neutral_dwelling_roadward_lodge")
	_expect(dwelling.get("unit_ids", []) == ["unit_neutral_roadwardens", "unit_neutral_hearthbow_carriers"], "Roadward Lodge unit order changed.")
	_expect(dwelling.get("site_ids", []) == ["site_free_company_yard"] and dwelling.get("map_object_ids", []) == ["object_roadward_lodge"], "Roadward Lodge site/object graph changed.")
	_expect(dwelling.get("army_group_ids", []) == [SHARED_ARMY_ID] and dwelling.get("encounter_ids", []) == ["encounter_roadward_lodge_watch"], "Roadward Lodge army/encounter graph changed.")
	var rows := []
	for spec_variant in UNITS:
		var spec: Dictionary = spec_variant
...
func _validate_authored_site_authority() -> void:
	...
	for expected_variant in AUTHORED_SITE_ROWS:
		...
		_expect(not placement.is_empty() and String(placement.get("site_id", "")) == String(expected["site_id"]), "%s must retain authored Roadward Lodge site %s." % [String(expected["scenario_id"]), String(expected["placement_id"])])
...
func _validate_live_roadward_battle_board() -> void:
	var session: SessionStateStoreScript.SessionData = ScenarioFactory.create_session("river-pass", "normal", SessionStateStoreScript.LAUNCH_MODE_SKIRMISH)
	var expected_counts := {"unit_neutral_roadwardens": 8, "unit_neutral_hearthbow_carriers": 4}
	var shared_army: Dictionary = ContentService.get_army_group(SHARED_ARMY_ID)
	_expect(String(shared_army.get("id", "")) == SHARED_ARMY_ID and _stack_counts(shared_army) == expected_counts, "Shared Roadward Lodge Watch ids/counts changed.")
	var placement := {"placement_id": "roadward_lodge_curated_art_fixture", "encounter_id": "encounter_roadward_lodge_watch", "enemy_army": shared_army.duplicate(true), "x": 4, "y": 4, "resolved": false}
	...
	_expect(_battle_stack_counts(enemy_stacks) == expected_counts, "Public Roadward Lodge battle payload changed its exact enemy roster.")
	for spec_variant in UNITS:
		var spec: Dictionary = spec_variant
	...
	for spec_variant in UNITS:
		...
		_expect(matches.size() == 1, "BattleBoard must expose exactly one %s Roadward Lodge stack." % String(spec["label"]))
		if matches.size() == 1:
	...
	_expect(session.to_dict() == authority_before, "BattleBoard art observation must not mutate the live Roadward Lodge battle/session.")
