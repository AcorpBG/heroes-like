...
const CASES := [
	...
	},
	{
		...
		"expected": {"outcome_state": "victory", "matchup_band": "even", "pacing_band": "standard", "round_reached": 4, "terminal_health_margin_pct": 48, "enemy_damage_per_round": 20},
	},
	{
		...
		"expected": {"outcome_state": "victory", "matchup_band": "player_advantaged", "pacing_band": "standard", "round_reached": 3, "terminal_health_margin_pct": 62, "enemy_damage_per_round": 35},
	},
	{
		...
		"expected": {"outcome_state": "defeat", "matchup_band": "even", "pacing_band": "standard", "round_reached": 4, "terminal_health_margin_pct": 73, "enemy_damage_per_round": 38},
	},
	{
		"scenario_id": "ninefold-confluence",
	...
	},
	{
		...
		"expected": {"outcome_state": "victory", "matchup_band": "player_advantaged", "pacing_band": "standard", "round_reached": 3, "terminal_health_margin_pct": 34, "enemy_damage_per_round": 22},
	},
]
