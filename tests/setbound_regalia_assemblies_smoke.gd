...
const CASES := [
	...
	{"scenario_id":"sunvein-meridian-relay-assembly","prefix":"meridianassembly","hero_id":"hero_sunvault_calis_sunvein","set_id":"set_meridian_relay","pieces":["artifact_prismward_mantle","artifact_zenith_prism_pennon","artifact_meridian_relay_lens"],"site_id":"site_meridian_relay_reliquary","asset_id":"resource_site_regalia_meridian_relay_reliquary","region":Rect2(384,0,192,192)},
	{"scenario_id":"mossvein-rootpath-covenant-assembly","prefix":"rootpathassembly","hero_id":"hero_thornwake_ralka_mossvein","set_id":"set_rootpath_covenant","pieces":["artifact_graftbark_cuirass","artifact_briarcrown_covenant_standard","artifact_rootpath_seed_compass"],"site_id":"site_rootpath_covenant_reliquary","asset_id":"resource_site_regalia_rootpath_covenant_reliquary","region":Rect2(576,0,192,192)},
	{"scenario_id":"blackgauge-redline-survey-assembly","prefix":"redlineassembly","hero_id":"hero_brasshollow_kestra_blackgauge","set_id":"set_redline_survey_warrant","pieces":["artifact_quenchplate_vambrace","artifact_redline_warrant_gonfalon","artifact_redline_survey_dial"],"site_id":"site_redline_survey_reliquary","asset_id":"resource_site_regalia_redline_survey_reliquary","region":Rect2(768,0,192,192)},
	{"scenario_id":"tidehook-drowned-wake-chart-assembly","prefix":"drownedwakeassembly","hero_id":"hero_veilmourn_olan_tidehook","set_id":"set_drowned_wake_chart","pieces":["artifact_fogwake_deckboots","artifact_wakebell_mourning_ensign","artifact_black_sail_compass"],"site_id":"site_drowned_wake_reliquary","asset_id":"resource_site_regalia_drowned_wake_reliquary","region":Rect2(960,0,192,192)},
]
...
func _run() -> void:
	...
	_expect(atlas != null and atlas.get_size() == Vector2(1152, 192), "Setbound Regalia atlas must remain exactly 1152x192.")
