...
REPORT_ID = "SIX_SEALED_COMPANIES_CAMPAIGN_SMOKE"
REPORT_PATH = ROOT / ".artifacts/six_sealed_companies_campaign_smoke/report.json"
CAPTURE_DIR = ROOT / ".artifacts/six_sealed_companies_campaign_smoke/captures"
SCENE = "res://tests/six_sealed_companies_campaign_smoke.tscn"
...
def main() -> int:
    ...
    environment["SIX_SEALED_COMPANIES_CAPTURE_DIR"] = str(CAPTURE_DIR)
