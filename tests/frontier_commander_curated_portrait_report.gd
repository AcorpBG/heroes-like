...
const CASES := [
	{
		...
		"portrait_path": "res://art/heroes/portraits/hero_brasshollow_marka_ironclause.png",
		"portrait_sha256": "efb202b3434eccf87f5f8af64acc4ef2b3661e9f8009ec4f1ee8cae3b9857198",
		"starting_spell_ids": ["spell_heat_rite", "spell_stone_veil", "spell_bulwark_litany"],
	...
	},
	{
		...
		"portrait_path": "res://art/heroes/portraits/hero_veilmourn_ivara_blacktide.png",
		"portrait_sha256": "8f1dfd491bf8ca4875a5d84fea31dd747c548a19b9db1d06a654f6807e80346f",
		"starting_spell_ids": ["spell_fogwake_step", "spell_obituary_mark", "spell_quickmarch_hymn"],
		"starting_specialties": ["drillmaster"],
...
func _portrait_contained(frame: Control, portrait: Control, viewport_size: Vector2i) -> bool:
	...
	if not contained:
		print("FRONTIER_COMMANDER_PORTRAIT_GEOMETRY ", JSON.stringify({
...
func _other_authored_hero_id() -> String:
	return "hero_veilmourn_ivara_blacktide" if String(_active_case.get("hero_id", "")) == "hero_brasshollow_marka_ironclause" else "hero_brasshollow_marka_ironclause"
