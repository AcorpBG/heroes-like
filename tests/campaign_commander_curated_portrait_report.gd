...
const CASES := [
	{
		...
		"portrait_path": "res://art/heroes/portraits/hero_lyra.png",
		"portrait_sha256": "f8b8e527e17af22a209a7a2e5f89e4c2a8116d471547b8eb014f9b6526c37543",
		"starting_spell_ids": ["spell_waystride", "spell_cinder_burst", "spell_stone_veil", "spell_quickmarch_hymn"],
		"starting_specialties": ["wayfinder"],
		"battle_traits": ["vanguard", "ambusher"],
		"command": {"attack": 1, "defense": 0, "power": 1, "knowledge": 2},
		"base_movement": 12,
		"recruit_cost": {"gold": 1400},
	},
	{
		"hero_id": "hero_vaska",
		"hero_name": "Vaska Reedmaw",
		...
		"portrait_path": "res://art/heroes/portraits/hero_vaska.png",
		"portrait_sha256": "8050f35ecb4b27d63768dcaf69d33407b39a032e06189fdcaa4e42af98b172dd",
		"starting_spell_ids": ["spell_relay_drum", "spell_cinder_burst", "spell_stone_veil", "spell_bloodwake_drum"],
...
func _validate_curated_provenance() -> bool:
	...
	for case_value in CASES:
		...
		if String(campaign.get("starting_scenario_id", "")) != String(case.get("scenario_id", "")) \
				...
				or RandomMapGeneratorRules.DEFAULT_HERO_BY_FACTION.get(String(case.get("faction_id", "")), "") != hero_id:
...
func _other_authored_hero_id() -> String:
	return "hero_vaska" if String(_active_case.get("hero_id", "")) == "hero_lyra" else "hero_lyra"
