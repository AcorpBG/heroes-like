...
const REPORT_ID := "UNIT_NEUTRAL_CLIFFHAWK_ROOST_CURATED_ART_REPORT"
const OUTPUT_DIR := "res://.artifacts/unit_neutral_cliffhawk_roost_curated_art_report"
const SHARED_ARMY_ID := "army_neutral_cliffhawk_roost_watch"
...
const AUTHORED_SITE_ROWS := [
	{"scenario_id": "ninefold-confluence", "placement_id": "dwelling_cliffhawk_roost", "site_id": "site_cliffhawk_roost"},
]
const UNITS := [
	{
		"unit_id": "unit_neutral_cliffhawk_wardens", "label": "Cliffhawk Wardens", "count": 7, "tier": 2, "role": "melee", "growth": 5, "cost": {"gold": 95}, "ability_ids": ["reach"], "hp": 11, "attack": 6, "defense": 4, "min_damage": 3, "max_damage": 5, "speed": 6, "initiative": 8, "retaliations": 1, "ranged": false, "shots": -1,
		"source_path": "res://art/units/source/curated/unit_neutral_cliffhawk_wardens.png", "portrait_path": "res://art/units/portraits/unit_neutral_cliffhawk_wardens.png", "icon_path": "res://art/units/battle_icons/unit_neutral_cliffhawk_wardens.png", "overworld_icon_path": "res://art/units/overworld_icons/unit_neutral_cliffhawk_wardens.png", "sheet_path": "res://art/animation/runtime/units/unit_neutral_cliffhawk_wardens.png",
		"source_sha256": "401027c1e06c9cb6aa7037ae07f6bf89c4c0b96f6a18f2456a8294d564e2ced1", "portrait_sha256": "110c8ffddde840dda28eeb8737fdc3d4577b049790161bb0cb8e05bcc2bb2646", "icon_sha256": "47b99a01dcf3e6eeb771c3be95da9e0dac61160ecb9f759fd162e0ae40326f43", "overworld_icon_sha256": "0584987d13b6183ce44edccf73b9adef47daee8e47f8650f8130ec435e13a76d", "sheet_sha256": "ba9a7c294cca10d6e4b5a9412dca191d20837a36055da0948dcd0cab5e40b762",
		"old_portrait_sha256": "429890b1478359dd37c70d8f992de2ee6ef4b448a3073e306ab44408f1253ad6", "old_icon_sha256": "987c960ea259dae4d3b36b295a54af04a7d48c3df8087c23fd03afbff1bf93ed", "old_overworld_icon_sha256": "3bc1407ef09a7fce1a263a65b19d4356b56024124317c5925f9b350ac5eeb1f8", "old_sheet_sha256": "fb63dd26cd9011fc1994791604685798b5ba176059e85b01b7daf2d353f73f03",
	},
	{
		"unit_id": "unit_neutral_windglass_slingers", "label": "Windglass Slingers", "count": 3, "tier": 2, "role": "ranged", "growth": 5, "cost": {"gold": 90}, "ability_ids": ["volley"], "hp": 7, "attack": 5, "defense": 3, "min_damage": 2, "max_damage": 4, "speed": 5, "initiative": 8, "retaliations": 1, "ranged": true, "shots": 8,
		"source_path": "res://art/units/source/curated/unit_neutral_windglass_slingers.png", "portrait_path": "res://art/units/portraits/unit_neutral_windglass_slingers.png", "icon_path": "res://art/units/battle_icons/unit_neutral_windglass_slingers.png", "overworld_icon_path": "res://art/units/overworld_icons/unit_neutral_windglass_slingers.png", "sheet_path": "res://art/animation/runtime/units/unit_neutral_windglass_slingers.png",
		"source_sha256": "e5d92d0e973c4695b16b77e36b7b7659bb60f8df55b68b80fa2e3d73ce3aba84", "portrait_sha256": "6244e343ba95c867aa2284d54c5147eb2890b76439b4dd71dbd3c6e9d75efd87", "icon_sha256": "05cd4c6f1080158afd54b6e31bc3b1be3f7c586c274f3b4dff067d3b2269322c", "overworld_icon_sha256": "a9173ac5c5fc40fee7616e33418330bf060adc6c2afb3a01f56d2d1aa64b4fcb", "sheet_sha256": "388ff6f9c9d3a1bc94483c1fcda8cefa481a4006f59801480f9f6259bc4b9363",
		"old_portrait_sha256": "c77983077f61eeceb791950ac033c47add33b7a4060f3e87cb1c2c875180a986", "old_icon_sha256": "9f1176bac07de0ab322cdde7f0e72429c448c11e29735be2e4b0d518d78b75c7", "old_overworld_icon_sha256": "34bf7d934a6446991c9ced72a68cfda7464236fdc23b260fef45074a86354717", "old_sheet_sha256": "3cce22255dab3cefda87e80f6f6be9d4954e0081c2315de5d27798b20ff179d8",
	},
]
...
func _run() -> void:
	...
	await _validate_live_cliffhawk_battle_board()
...
func _validate_content_authority() -> void:
	var dwelling: Dictionary = ContentService.get_neutral_dwelling("neutral_dwelling_cliffhawk_roost")
	_expect(dwelling.get("unit_ids", []) == ["unit_neutral_cliffhawk_wardens", "unit_neutral_windglass_slingers"], "Cliffhawk Roost unit order changed.")
	_expect(dwelling.get("site_ids", []) == ["site_cliffhawk_roost"] and dwelling.get("map_object_ids", []) == ["object_cliffhawk_roost"], "Cliffhawk Roost site/object graph changed.")
	_expect(dwelling.get("army_group_ids", []) == [SHARED_ARMY_ID] and dwelling.get("encounter_ids", []) == ["encounter_cliffhawk_roost_watch"], "Cliffhawk Roost army/encounter graph changed.")
	var generated_site_rows: Array = RandomMapGeneratorRulesScript.DWELLING_SITE_CANDIDATES.filter(func(row): return row is Dictionary and String(row.get("site_id", "")) == "site_cliffhawk_roost")
	_expect(generated_site_rows.size() == 1 and String(generated_site_rows[0].get("object_id", "")) == "object_cliffhawk_roost" and String(generated_site_rows[0].get("neutral_dwelling_family_id", "")) == "neutral_dwelling_cliffhawk_roost", "Generated-map Cliffhawk Roost site-family projection changed.")
...
func _validate_authored_site_authority() -> void:
	...
	for expected_variant in AUTHORED_SITE_ROWS:
		...
		_expect(not placement.is_empty() and String(placement.get("site_id", "")) == String(expected["site_id"]), "%s must retain authored Cliffhawk Roost site %s." % [String(expected["scenario_id"]), String(expected["placement_id"])])
...
func _validate_live_cliffhawk_battle_board() -> void:
	...
	var expected_counts := {"unit_neutral_cliffhawk_wardens": 7, "unit_neutral_windglass_slingers": 3}
	var shared_army: Dictionary = ContentService.get_army_group(SHARED_ARMY_ID)
	_expect(String(shared_army.get("id", "")) == SHARED_ARMY_ID and _stack_counts(shared_army) == expected_counts, "Shared Cliffhawk Roost Watch ids/counts changed.")
	var placement := {"placement_id": "cliffhawk_roost_curated_art_fixture", "encounter_id": "encounter_cliffhawk_roost_watch", "enemy_army": shared_army.duplicate(true), "x": 4, "y": 4, "resolved": false}
	...
	_expect(_battle_stack_counts(enemy_stacks) == expected_counts, "Public Cliffhawk Roost battle payload changed its exact enemy roster.")
	for spec_variant in UNITS:
		var spec: Dictionary = spec_variant
	...
	for spec_variant in UNITS:
		...
		_expect(matches.size() == 1, "BattleBoard must expose exactly one %s Cliffhawk Roost stack." % String(spec["label"]))
		if matches.size() == 1:
	...
	_expect(session.to_dict() == authority_before, "BattleBoard art observation must not mutate the live Cliffhawk Roost battle/session.")
