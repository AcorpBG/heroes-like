...
REPORT_ID = "SETBOUND_REGALIA_ASSEMBLIES_SMOKE"
REPORT_PATH = ROOT / ".artifacts" / "setbound_regalia_assemblies_smoke" / "report.json"
CAPTURE_DIR = ROOT / ".artifacts" / "setbound_regalia_assemblies_smoke" / "captures"
SCENE = "res://tests/setbound_regalia_assemblies_smoke.tscn"
...
def main() -> int:
    ...
    environment["SETBOUND_REGALIA_ASSEMBLIES_CAPTURE_DIR"] = str(CAPTURE_DIR)
    try:
    ...
    expected = {
        ...
        "case_count": 6,
        "exact_art_count": 6,
        "initially_pending_count": 6,
        "wrong_hero_control_count": 6,
        "inventory_only_control_count": 6,
        "wrong_set_control_count": 6,
        "partial_set_control_count": 6,
        "production_battle_count": 18,
        "artifact_pickup_claim_count": 12,
        "reliquary_claim_count": 6,
        "production_stow_count": 18,
        "production_equip_count": 18,
        "active_set_count": 6,
