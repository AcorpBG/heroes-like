...
const REPORT_ID := "UNIT_SUNVAULT_MIRROR_DUELIST_CURATED_ART_REPORT"
const OUTPUT_DIR := "res://.artifacts/unit_sunvault_mirror_duelist_curated_art_report"
...
const TARGET_IDS := ["unit_mirror_duelist"]
const DISTINCT_CURATED_UNIT_ID := "unit_sunvault_mirror_duelists"
const UNITS := [
	{
		"unit_id": "unit_mirror_duelist", "label": "Mirror Duelist", "ability_ids": ["reach", "backstab"],
		"source_path": "res://art/units/source/curated/unit_mirror_duelist.png", "portrait_path": "res://art/units/portraits/unit_mirror_duelist.png", "icon_path": "res://art/units/battle_icons/unit_mirror_duelist.png", "overworld_icon_path": "res://art/units/overworld_icons/unit_mirror_duelist.png", "sheet_path": "res://art/animation/runtime/units/unit_mirror_duelist.png",
		"source_sha256": "63045e93b1224aa4463d85de151b35274f4ac01aeaa69ae4b78f55554dad4ebf", "portrait_sha256": "7579e13a575c3ccdc8da3ed1c62b58ef5c9a1080d354c8c7b9975995c3e3cac1", "icon_sha256": "5b9cbd0b701d82f407af80b17c7d573ef9d483df6e489847ef54711696e4104e", "overworld_icon_sha256": "c2707d4a94c2a831f56241f42d44cb8985579de580f6ff63e137c1dba49ec39d", "sheet_sha256": "145741f8a4e6e402754da1f5aee430157f64e7f75518f2573e39def6262b098d",
		"old_portrait_sha256": "bd0c47055c7164e087c2844ff3ee96b613bbec3489bf6cae9bbc804dcca704a4", "old_icon_sha256": "e1ef2a8db2865d567d06047998a4c71e309fa7007abae782ed02c5a635429036", "old_overworld_icon_sha256": "562c8a8acee6ede799328095071ad6ffff5b2df306f88db62e07aa73971e3c6f", "old_sheet_sha256": "a529ece0bd7c39d9de5681e265c6d93b98bfbd2144460c391d21eacebb1b383d",
	},
]
const ENCOUNTERS := [
...
func _validate_assets_and_provenance() -> void:
	...
	_expect(String(distinct_art.get("unit_id", "")) == DISTINCT_CURATED_UNIT_ID and String(distinct_art.get("art_source_kind", "")) == "curated_original_character_v1" and String(distinct_art.get("curated_source", "")) == "res://art/units/source/curated/unit_sunvault_mirror_duelists.png", "Production Mirror Duelists must remain a distinct curated unit record.")
