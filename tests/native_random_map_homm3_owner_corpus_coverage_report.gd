...
func _native_comparison_for_sample(service: Variant, sample: Dictionary) -> Dictionary:
	...
	elif sample_id == "owner_discovered_xl_nowater":
		config = ScenarioSelectRulesScript.build_random_map_player_config(
	...
	elif sample_id == "owner_discovered_s_randomnumberofplayers":
		config = ScenarioSelectRulesScript.build_random_map_player_config(
	...
	elif sample_id == "owner_discovered_s_2playerss_normalwater_2level":
		config = ScenarioSelectRulesScript.build_random_map_player_config(
	...
	elif sample_id == "owner_discovered_s_randomnumberofplayers_islands_2level":
		config = ScenarioSelectRulesScript.build_random_map_player_config(
			"owner-corpus-small-random-players-islands-underground-10184",
			"",
			"",
			3,
			"islands",
