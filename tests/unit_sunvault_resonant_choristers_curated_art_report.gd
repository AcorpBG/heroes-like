...
const REPORT_ID := "UNIT_SUNVAULT_RESONANT_CHORISTERS_CURATED_ART_REPORT"
const OUTPUT_DIR := "res://.artifacts/unit_sunvault_resonant_choristers_curated_art_report"
...
const TARGET_IDS := ["unit_sunvault_resonant_choristers"]
const UNITS := [
	{
		"unit_id": "unit_sunvault_resonant_choristers", "label": "Resonant Choristers", "ability_ids": ["resonance_relay", "harry"],
		"source_path": "res://art/units/source/curated/unit_sunvault_resonant_choristers.png", "portrait_path": "res://art/units/portraits/unit_sunvault_resonant_choristers.png", "icon_path": "res://art/units/battle_icons/unit_sunvault_resonant_choristers.png", "overworld_icon_path": "res://art/units/overworld_icons/unit_sunvault_resonant_choristers.png", "sheet_path": "res://art/animation/runtime/units/unit_sunvault_resonant_choristers.png",
		...
		"old_portrait_sha256": "244d1d885ac4031b10018532e5d25aeecc75d318fecb5cce3496f23b72e78466", "old_icon_sha256": "b135913efe9c74e45101b3f352ba42b3c16de3ec5810a4c22760a1e4ec86e7ba", "old_overworld_icon_sha256": "750530a9d380aca9c0a836714ec76b8dc46baa7f28ace07d5f1cadaab9a0d345", "old_sheet_sha256": "25271d744b29f6bea0b1fa4b9108809e5a63f1510e4485bedced98b68dc4e036",
	},
]
const ENCOUNTERS := [
...
func _validate_live_encounters_and_board() -> void:
	...
	for encounter_variant in ENCOUNTERS:
		...
		if String(spec["placement_id"]) == "fogchart_mirror_lancers":
			board_session = session
			board_payload = battle_payload
	_report["encounters"] = encounter_rows
	_expect(board_session != null and not board_payload.is_empty(), "Fogchart Mirror Lancers Board fixture must retain the exact production Resonant Choristers line.")
	...
	for spec_variant in UNITS:
		...
		_expect(matches.size() == 1, "BattleBoard must expose exactly one %s Fogchart Mirror Lancers stack." % String(unit_spec["label"]))
		if matches.size() == 1:
	...
	_report["runtime"] = {"scenario_id": "fogchart-mooring", "placement_id": "fogchart_mirror_lancers", "entry_count": entries.size(), "entries": entries, "visible_stack_count": int(summary.get("visible_stack_count", 0)), "session_authority_exact": board_session.to_dict() == board_authority_before}
	board.queue_free()
	await get_tree().process_frame
