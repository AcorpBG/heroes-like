...
func _run() -> void:
	...
	var report := {"ok":_errors.is_empty(),"case_count":CASES.size(),"atlas_path":ATLAS_PATH,"atlas_size":[1152,192],"save_version":SessionStateStoreScript.SAVE_VERSION,"rows":_rows,"errors":_errors}
