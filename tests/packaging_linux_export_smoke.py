...
def pck_terrain_payload_summary() -> dict:
        ...
        with PCK_PATH.open("rb") as handle:
            ...
            for _ in range(entry_count):
                ...
                if entry_path.startswith(".godot/imported/") and entry_path.endswith(".ctex"):
                    ...
                    if imported_name in {REQUIRED_RECURRING_RESOURCE_SITE_ATLAS_NAME, REQUIRED_LIVE_FACTION_LANDMARK_ATLAS_NAME, REQUIRED_MAJOR_VAULT_UNSEALED_ATLAS_NAME, REQUIRED_CREATURE_BANK_OPENED_ATLAS_NAME, REQUIRED_MINOR_GUARDED_CACHE_OPENED_ATLAS_NAME, REQUIRED_NEUTRAL_DWELLING_CLAIMED_ATLAS_NAME, REQUIRED_REMAINING_NEUTRAL_DWELLING_CLAIMED_ATLAS_NAME, REQUIRED_FINAL_NEUTRAL_DWELLING_CLAIMED_ATLAS_NAME}:
    ...
    summary["recurring_resource_site_atlas_entries_present"] = len(required_recurring_resource_site_atlas_texture_entries) == 8 and set(summary["recurring_resource_site_atlas_import_entries"]) == set(REQUIRED_RECURRING_RESOURCE_SITE_ATLAS_PCK_IMPORT_ENTRIES) and set(summary["recurring_resource_site_atlas_texture_entries"]) == required_recurring_resource_site_atlas_texture_entries and set(summary["recurring_resource_site_atlas_texture_names"]) == {REQUIRED_RECURRING_RESOURCE_SITE_ATLAS_NAME, REQUIRED_LIVE_FACTION_LANDMARK_ATLAS_NAME, REQUIRED_MAJOR_VAULT_UNSEALED_ATLAS_NAME, REQUIRED_CREATURE_BANK_OPENED_ATLAS_NAME, REQUIRED_MINOR_GUARDED_CACHE_OPENED_ATLAS_NAME, REQUIRED_NEUTRAL_DWELLING_CLAIMED_ATLAS_NAME, REQUIRED_REMAINING_NEUTRAL_DWELLING_CLAIMED_ATLAS_NAME, REQUIRED_FINAL_NEUTRAL_DWELLING_CLAIMED_ATLAS_NAME}
