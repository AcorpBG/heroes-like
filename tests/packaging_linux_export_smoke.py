...
REQUIRED_CAMPAIGN_EMBLEM_NAMES = (
    ...
    "charterless_compact", "six_sealed_companies", "wild_atlas_accord",
)
...
def pck_terrain_payload_summary() -> dict:
    ...
    summary["recurring_resource_site_atlas_entries_present"] = len(required_recurring_resource_site_atlas_texture_entries) == 49 and set(summary["recurring_resource_site_atlas_import_entries"]) == set(REQUIRED_RECURRING_RESOURCE_SITE_ATLAS_PCK_IMPORT_ENTRIES) and set(summary["recurring_resource_site_atlas_texture_entries"]) == required_recurring_resource_site_atlas_texture_entries and len(set(summary["recurring_resource_site_atlas_texture_names"])) == 49 and REQUIRED_GRAND_ARCANUM_CONVOCATIONS_ATLAS_NAME in summary["recurring_resource_site_atlas_texture_names"]
