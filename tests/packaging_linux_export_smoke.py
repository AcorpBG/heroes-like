...
def pck_terrain_payload_summary() -> dict:
    ...
    summary["recurring_resource_site_atlas_entries_present"] = len(required_recurring_resource_site_atlas_texture_entries) == 20 and set(summary["recurring_resource_site_atlas_import_entries"]) == set(REQUIRED_RECURRING_RESOURCE_SITE_ATLAS_PCK_IMPORT_ENTRIES) and set(summary["recurring_resource_site_atlas_texture_entries"]) == required_recurring_resource_site_atlas_texture_entries and set(summary["recurring_resource_site_atlas_texture_names"]) == {REQUIRED_RECURRING_RESOURCE_SITE_ATLAS_NAME, REQUIRED_LIVE_FACTION_LANDMARK_ATLAS_NAME, REQUIRED_MAJOR_VAULT_UNSEALED_ATLAS_NAME, REQUIRED_CREATURE_BANK_OPENED_ATLAS_NAME, REQUIRED_MINOR_GUARDED_CACHE_OPENED_ATLAS_NAME, REQUIRED_NEUTRAL_DWELLING_CLAIMED_ATLAS_NAME, REQUIRED_REMAINING_NEUTRAL_DWELLING_CLAIMED_ATLAS_NAME, REQUIRED_FINAL_NEUTRAL_DWELLING_CLAIMED_ATLAS_NAME, REQUIRED_GUARDED_ROUTE_OPENED_ATLAS_NAME, REQUIRED_REPEATABLE_SERVICE_VISITED_ATLAS_NAME, REQUIRED_PROGRESSION_SHRINE_AWAKENED_ATLAS_NAME, REQUIRED_SCOUTING_STRUCTURE_CONTROLLED_ATLAS_NAME, REQUIRED_ROADS_OBJECTIVES_STATE_ATLAS_NAME, REQUIRED_LAND_TRANSIT_ACTIVE_ATLAS_NAME, REQUIRED_COAST_ROUTE_OPERATIONAL_ATLAS_NAME, REQUIRED_ROUTE_CONTROL_OPENED_ATLAS_NAME, REQUIRED_FOURTEEN_MARKS_STATE_ATLAS_NAME, REQUIRED_EIGHTFOLD_GUARDED_RELIQUARY_ATLAS_NAME, REQUIRED_FRONTIER_MARKER_ATLAS_NAME, REQUIRED_THIRD_HEARTHS_ATLAS_NAME}
