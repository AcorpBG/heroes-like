...
REPORT_ID = "GRAND_ARCANUM_CONVOCATIONS_SMOKE"
REPORT_PATH = ROOT / ".artifacts" / "grand_arcanum_convocations_smoke" / "report.json"
CAPTURE_DIR = ROOT / ".artifacts" / "grand_arcanum_convocations_smoke" / "captures"
SCENE = "res://tests/grand_arcanum_convocations_smoke.tscn"
...
def main() -> int:
    ...
    environment["GRAND_ARCANUM_CONVOCATION_CAPTURE_DIR"] = str(CAPTURE_DIR)
