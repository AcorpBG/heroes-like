...
const REPORT_ID := "UNIT_SUNVAULT_SHARD_GUARD_CURATED_ART_REPORT"
const OUTPUT_DIR := "res://.artifacts/unit_sunvault_shard_guard_curated_art_report"
...
const TARGET_IDS := ["unit_shard_guard"]
const DISTINCT_CURATED_UNIT_ID := "unit_sunvault_shard_wardens"
const UNITS := [
	{
		"unit_id": "unit_shard_guard", "label": "Shard Guard", "ability_ids": ["brace", "shielding"],
		"source_path": "res://art/units/source/curated/unit_shard_guard.png", "portrait_path": "res://art/units/portraits/unit_shard_guard.png", "icon_path": "res://art/units/battle_icons/unit_shard_guard.png", "overworld_icon_path": "res://art/units/overworld_icons/unit_shard_guard.png", "sheet_path": "res://art/animation/runtime/units/unit_shard_guard.png",
		"source_sha256": "03f31b58e721b917e36394effbaf8b6fc23d0b1b40a6ebe38dc2e78f4de59c67", "portrait_sha256": "6ea66d1c7224a9f5d523504dc8bbc311c63f6880469986eb679d3de531f2df53", "icon_sha256": "1c5e279a5707c3dce76cbec0291267f75820807a9d0bafa983c8f42a29bda599", "overworld_icon_sha256": "5ae6c7123ab76955411ada8a67e4327ba7f92c34cc614a2fcfecbd5c31dd2393", "sheet_sha256": "540e8261d2f85c135a9c1c0928d10a3c49c514cd7426337db34e5cbc46ac9f63",
...
func _validate_assets_and_provenance() -> void:
	...
	_expect(String(distinct_art.get("unit_id", "")) == DISTINCT_CURATED_UNIT_ID and String(distinct_art.get("art_source_kind", "")) == "curated_original_character_v1" and String(distinct_art.get("curated_source", "")) == "res://art/units/source/curated/unit_sunvault_shard_wardens.png", "Production Shard Wardens must remain a distinct curated unit record.")
