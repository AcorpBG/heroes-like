...
const HERO_HIRE_TEXTURE_PATH := "res://art/town/runtime/vfx/hero_hire.png"
...
func _summary_exact(summary: Dictionary) -> bool:
	return String(summary.get("manifest_path", "")) == "res://content/town_vfx_manifest.json" \
		...
		and summary.get("mapped_cue_ids", []) == ["vfx_placeholder_build_complete", "vfx_placeholder_recruit_muster", "vfx_placeholder_town_hero_hire", "vfx_placeholder_town_market_exchange", "vfx_placeholder_town_route_response", "vfx_placeholder_town_spell_study"] \
		and summary.get("texture_paths", []) == [TEXTURE_PATH, RECRUIT_TEXTURE_PATH, HERO_HIRE_TEXTURE_PATH, MARKET_EXCHANGE_TEXTURE_PATH, ROUTE_RESPONSE_TEXTURE_PATH, SPELL_STUDY_TEXTURE_PATH] \
		and summary.get("loaded_texture_paths", []) == [TEXTURE_PATH, RECRUIT_TEXTURE_PATH, HERO_HIRE_TEXTURE_PATH, MARKET_EXCHANGE_TEXTURE_PATH, ROUTE_RESPONSE_TEXTURE_PATH, SPELL_STUDY_TEXTURE_PATH] \
