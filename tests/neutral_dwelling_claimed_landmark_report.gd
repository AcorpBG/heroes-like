...
const CASES := [
	...
	{"site_id": "site_cinder_kiln", "placement_id": "dwelling_cinder_kiln", "unclaimed_asset_id": "mapobj_cinder_kiln", "claimed_asset_id": "resource_site_neutral_cinder_kiln"},
	{"site_id": "site_frostbeacon_bothy", "placement_id": "dwelling_frostbeacon_bothy", "unclaimed_asset_id": "mapobj_frostbeacon_bothy", "claimed_asset_id": "resource_site_neutral_frostbeacon_bothy"},
