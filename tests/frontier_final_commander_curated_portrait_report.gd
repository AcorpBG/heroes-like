...
const REPORT_ID := "FRONTIER_FINAL_COMMANDER_CURATED_PORTRAIT_REPORT"
const VIEWPORT_SIZES := [Vector2i(1280, 720), Vector2i(1920, 1080)]
const CASES := [
	{
		"hero_id": "hero_seren",
		"hero_name": "Seren Valechant",
		"faction_id": "faction_embercourt",
		"archetype": "starseer",
		"campaign_id": "campaign_frontier_claims",
		"scenario_id": "charter-bastion-counterseal",
		"chapters": [
			{"campaign_id": "campaign_frontier_claims", "scenario_id": "charter-bastion-counterseal"},
		],
		"source_path": "res://art/heroes/source/curated/hero_seren.png",
		"source_sha256": "bbda05517d37396328e4b1e4cf37472786d8f0c5fcfa1df2fbcb5f3e12803ec5",
		"portrait_path": "res://art/heroes/portraits/hero_seren.png",
		"portrait_sha256": "633330c6c0436f194d5498fe309dccd41f328716d0fec7397478cb40b222149e",
		"starting_spell_ids": ["spell_trailglyph", "spell_coal_rain", "spell_stone_veil", "spell_quickmarch_hymn"],
...
func _portrait_contained(frame: Control, portrait: Control, viewport_size: Vector2i) -> bool:
	...
	if not contained:
		print("FRONTIER_FINAL_COMMANDER_PORTRAIT_GEOMETRY ", JSON.stringify({
