...
func _run() -> void:
	...
	_expect(atlas != null and atlas.get_size() == Vector2(1152, 192), "The recovered commission landmark atlas must remain exactly 1152x192.")
