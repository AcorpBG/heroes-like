...
const REPORT_ID := "FRONTIER_LATE_COMMANDERS_CURATED_PORTRAIT_REPORT"
const VIEWPORT_SIZES := [Vector2i(1280, 720), Vector2i(1920, 1080)]
const CASES := [
	{
		"hero_id": "hero_mireclaw_kessa_chainboom",
		"hero_name": "Kessa Chainboom",
		"faction_id": "faction_mireclaw",
		"archetype": "chainbreaker",
		"campaign_id": "campaign_frontier_claims",
		"scenario_id": "nightglass-ledger-reversal",
		"chapters": [
			{"campaign_id": "campaign_frontier_claims", "scenario_id": "nightglass-ledger-reversal"},
		],
		"source_path": "res://art/heroes/source/curated/hero_mireclaw_kessa_chainboom.png",
		"source_sha256": "9358ad99048d7ca6990e5d0476d3df3ff0a44f22d03ce71e0a386f795e530a25",
		"portrait_path": "res://art/heroes/portraits/hero_mireclaw_kessa_chainboom.png",
		"portrait_sha256": "aeff7010dde819a595541bda7f8224ce156ad2f5834fa1f3dd4769ce7901dc8b",
		"starting_spell_ids": ["spell_relay_drum", "spell_bulwark_litany", "spell_coal_rain"],
		"starting_specialties": ["armsmaster"],
		"battle_traits": ["vanguard", "bogwise"],
	...
	{
		"hero_id": "hero_neral",
		"hero_name": "Neral Glasswind",
		"faction_id": "faction_sunvault",
		"archetype": "starseer",
		"campaign_id": "campaign_frontier_claims",
		"scenario_id": "halo-reserve-refraction-claim",
		"chapters": [
			{"campaign_id": "campaign_frontier_claims", "scenario_id": "halo-reserve-refraction-claim"},
		],
		"source_path": "res://art/heroes/source/curated/hero_neral.png",
		"source_sha256": "3164299eee42a11d40fe30472890a77b422460c89823c722147751888328114a",
		"portrait_path": "res://art/heroes/portraits/hero_neral.png",
		"portrait_sha256": "6ef43a4c54f4a109c4150c36b9946ba7b9eecc137f00efeef1f98431a96d4ec6",
		"starting_spell_ids": ["spell_sunlance_arc", "spell_prism_bastion", "spell_trailglyph"],
...
func _portrait_contained(frame: Control, portrait: Control, viewport_size: Vector2i) -> bool:
	...
	if not contained:
		print("FRONTIER_LATE_COMMANDERS_PORTRAIT_GEOMETRY ", JSON.stringify({
