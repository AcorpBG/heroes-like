...
const REPORT_ID := "SIX_FACTION_ROSTER_SCHOLARS_CURATED_PORTRAIT_REPORT"
const VIEWPORT_SIZES := [Vector2i(1280, 720), Vector2i(1920, 1080)]
const CASES := [
	{
		"hero_id": "hero_embercourt_jorun_beaconscribe",
		"hero_name": "Jorun Beaconscribe",
		"faction_id": "faction_embercourt",
		"archetype": "beaconscribe",
		"fixture_scenario_id": "river-pass",
		"roster_index": 9,
		"source_path": "res://art/heroes/source/curated/hero_embercourt_jorun_beaconscribe.png",
		"source_sha256": "8496e8867ff5158f8c4127667fa17ece1cb90eaf34c632747a704bb24572bb95",
		"portrait_path": "res://art/heroes/portraits/hero_embercourt_jorun_beaconscribe.png",
		"portrait_sha256": "6002c599c606be7b8b3a482caf7829e38912255cfabb7147b89a42f0eec89aa5",
		"starting_spell_ids": ["spell_beacon_path", "spell_quickmarch_hymn", "spell_lantern_phalanx"],
	...
	{
		"hero_id": "hero_mireclaw_edda_rotlamp",
		"hero_name": "Edda Rotlamp",
		"faction_id": "faction_mireclaw",
		"archetype": "sporewake",
		"fixture_scenario_id": "bogbound-oath",
		"roster_index": 7,
		"source_path": "res://art/heroes/source/curated/hero_mireclaw_edda_rotlamp.png",
		"source_sha256": "c86d8f36fc598940eddd7841bb7368d5e7292f2de1b1c91e8820effdc05cb836",
		"portrait_path": "res://art/heroes/portraits/hero_mireclaw_edda_rotlamp.png",
		"portrait_sha256": "319afd649b4fe46b99faf9207199dd09f8e36a1b906b68471d72514e1378fa96",
		"starting_spell_ids": ["spell_coal_rain", "spell_stone_veil", "spell_bloodwake_drum"],
		"starting_specialties": ["spellwright"],
		"battle_traits": ["bogwise", "artillerist"],
		"command": {"attack": 0, "defense": 1, "power": 2, "knowledge": 1},
		"base_movement": 10,
		"recruit_cost": {"gold": 1200},
	},
	{
		"hero_id": "hero_sunvault_essa_daynote",
		"hero_name": "Essa Daynote",
		"faction_id": "faction_sunvault",
		"archetype": "harmonicscholar",
		"fixture_scenario_id": "prismhearth-watch",
		"roster_index": 7,
		"source_path": "res://art/heroes/source/curated/hero_sunvault_essa_daynote.png",
		"source_sha256": "78ed84d723d15c8bb654db47e935f41599376005aa1b235d2671fadcd930d31a",
		"portrait_path": "res://art/heroes/portraits/hero_sunvault_essa_daynote.png",
		"portrait_sha256": "49b0a122fe356e4bb34f31db5c01f58f0df3ed9defcfb1daedd2796926d6c853",
		"starting_spell_ids": ["spell_resonant_chorus", "spell_prism_bastion", "spell_sunlance_arc"],
		"starting_specialties": ["spellwright"],
	...
	{
		"hero_id": "hero_thornwake_ralka_mossvein",
		"hero_name": "Ralka Mossvein",
		"faction_id": "faction_thornwake",
		"archetype": "mossmemory",
		"fixture_scenario_id": "mireford-skirmish",
		"roster_index": 8,
		"source_path": "res://art/heroes/source/curated/hero_thornwake_ralka_mossvein.png",
		"source_sha256": "bde2e26f446ac59b0a6a75e2e0d7978ca441c40138fe0f6ab0be07658b2561f7",
		"portrait_path": "res://art/heroes/portraits/hero_thornwake_ralka_mossvein.png",
		"portrait_sha256": "50eb10c7476d5a862ca85f9c115a2e0e5337b43c78579f09912f824a35776d7a",
		"starting_spell_ids": ["spell_graft_mend", "spell_resonant_chorus", "spell_stone_veil"],
		"starting_specialties": ["ledgerkeeper"],
		"battle_traits": ["bogwise", "packhunter"],
		"command": {"attack": 0, "defense": 0, "power": 3, "knowledge": 1},
		"base_movement": 11,
		"recruit_cost": {"gold": 1200},
	},
	{
		"hero_id": "hero_brasshollow_lina_gaugesavant",
		"hero_name": "Lina Gauge-Savant",
		"faction_id": "faction_brasshollow",
		"archetype": "pressuremath",
		"fixture_scenario_id": "orevein-contract",
		"roster_index": 7,
		"source_path": "res://art/heroes/source/curated/hero_brasshollow_lina_gaugesavant.png",
		"source_sha256": "62c8105b3444f185f4d60c6c746b1c5c754c9020f0cda6524e10a5765589e67e",
		"portrait_path": "res://art/heroes/portraits/hero_brasshollow_lina_gaugesavant.png",
		"portrait_sha256": "1ae9e3b1d66fcd837211e5a707593ae99cd73cbd604be5c3c7a6944d6358d2aa",
		"starting_spell_ids": ["spell_pressure_clause", "spell_heat_rite", "spell_resonant_chorus"],
		"starting_specialties": ["spellwright"],
		"battle_traits": ["artillerist", "linekeeper"],
	...
	{
		"hero_id": "hero_veilmourn_sael_mirrorbell",
		"hero_name": "Sael Mirrorbell",
		"faction_id": "faction_veilmourn",
		"archetype": "mirrornavigator",
		"fixture_scenario_id": "bellwake-wreck-claim",
		"roster_index": 7,
		"source_path": "res://art/heroes/source/curated/hero_veilmourn_sael_mirrorbell.png",
		"source_sha256": "b159b801fbc2eea5784e47a8cbc8b67ff6b1310303ce4f35e74110076e72109b",
		"portrait_path": "res://art/heroes/portraits/hero_veilmourn_sael_mirrorbell.png",
		"portrait_sha256": "1e71b7ce6d3ab979e7615135f8fa068a6a01e200ce1a783f5981e44d5c0f8bdf",
		"starting_spell_ids": ["spell_fogwake_step", "spell_obituary_mark", "spell_resonant_chorus"],
		"starting_specialties": ["spellwright"],
		"battle_traits": ["ambusher", "artillerist"],
		"command": {"attack": 0, "defense": 0, "power": 2, "knowledge": 3},
		"base_movement": 11,
		"recruit_cost": {"gold": 1250},
	},
...
func _validate_roster_tavern_authority() -> bool:
	...
	if town.is_empty():
		_fail("Roster scholar tavern fixture has no player town.")
		return false
	...
	if hero_id not in recruitable or matching_actions.size() != 1 or session.to_dict() != authority_before:
		_fail("Roster scholar tavern authority failed for %s: %s" % [hero_id, JSON.stringify(actions)])
		return false
	return true
...
func _portrait_contained(frame: Control, portrait: Control, viewport_size: Vector2i) -> bool:
	...
	if not contained:
		print("SIX_FACTION_ROSTER_SCHOLARS_PORTRAIT_GEOMETRY ", JSON.stringify({
