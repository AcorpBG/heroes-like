...
const REPORT_ID := "UNIT_NEUTRAL_ICEHOOK_TRAPPER_LODGE_CURATED_ART_REPORT"
const OUTPUT_DIR := "res://.artifacts/unit_neutral_icehook_trapper_lodge_curated_art_report"
const SHARED_ARMY_ID := "army_neutral_icehook_trapper_lodge_watch"
...
const AUTHORED_SITE_ROWS := [
	{"scenario_id": "ninefold-confluence", "placement_id": "dwelling_icehook_trapper_lodge", "site_id": "site_icehook_trapper_lodge", "x": 2, "y": 28},
]
const UNITS := [
	{
		"unit_id": "unit_neutral_icehook_trappers", "label": "Icehook Trappers", "count": 7, "tier": 2, "role": "melee", "growth": 5, "cost": {"gold": 95}, "ability_ids": ["backstab"], "hp": 10, "attack": 6, "defense": 4, "min_damage": 3, "max_damage": 5, "speed": 6, "initiative": 8, "retaliations": 1, "ranged": false, "shots": -1,
		"source_path": "res://art/units/source/curated/unit_neutral_icehook_trappers.png", "portrait_path": "res://art/units/portraits/unit_neutral_icehook_trappers.png", "icon_path": "res://art/units/battle_icons/unit_neutral_icehook_trappers.png", "overworld_icon_path": "res://art/units/overworld_icons/unit_neutral_icehook_trappers.png", "sheet_path": "res://art/animation/runtime/units/unit_neutral_icehook_trappers.png",
		"source_sha256": "cc58d7b423e34a3cd15b6dbe667c07cabd72c9577c2871f9b53898203a55d18c", "portrait_sha256": "d264aecab94cf6f46046f43533d89b8fa1cc41396595179976434f4dfebe34ee", "icon_sha256": "61d3a950e112d1e3b1a48acd9ae74b220de03cdde43e4a72d30cb374f0d46050", "overworld_icon_sha256": "7abd0d7df7bae2907c999057b594da055f88db51952a910e24c7ef4f8baba2d3", "sheet_sha256": "a7385d234ca895ad6e7042602159029ea7830285b85c71c91453d1db7a8bdaea",
		"old_portrait_sha256": "b26199a4dfe35ce45c73c49b15ef69f68ccd590d31efdb2b197d0eae8c2182c7", "old_icon_sha256": "b1e26c575330a0819749dbfcf9fac2be6121b1003513e120b37ca0896f18eb5e", "old_overworld_icon_sha256": "16a497018654e10caed76749bfd4c4e3dfc03f158d7fd95346204874c6d4d3a3", "old_sheet_sha256": "8c5a5a66258cba1a73f9f7a1460c66ca45dc7b0b0fb4155a3616b5ff8c6650de",
	},
	{
		"unit_id": "unit_neutral_whitepike_keepers", "label": "Whitepike Keepers", "count": 3, "tier": 2, "role": "melee", "growth": 5, "cost": {"gold": 100}, "ability_ids": ["reach"], "hp": 12, "attack": 5, "defense": 5, "min_damage": 3, "max_damage": 5, "speed": 4, "initiative": 6, "retaliations": 1, "ranged": false, "shots": -1,
		"source_path": "res://art/units/source/curated/unit_neutral_whitepike_keepers.png", "portrait_path": "res://art/units/portraits/unit_neutral_whitepike_keepers.png", "icon_path": "res://art/units/battle_icons/unit_neutral_whitepike_keepers.png", "overworld_icon_path": "res://art/units/overworld_icons/unit_neutral_whitepike_keepers.png", "sheet_path": "res://art/animation/runtime/units/unit_neutral_whitepike_keepers.png",
		"source_sha256": "6a5a5384435894f3be29b2f771dd93bb72d63842a62caa336f584749f3fdf7e8", "portrait_sha256": "e3ed0f91e5427e934d0206f6398c5a773e1249ee95f99b93490f17ee822e161f", "icon_sha256": "ce4705bad91b78ad20472de5a7520834756a559bfb177621ebbddae4efbaf8de", "overworld_icon_sha256": "4f5b6ea2c956bd58e2c24d0c5a125d26b5967ad30470a6e7e8d6862d25d36ddc", "sheet_sha256": "5abc975447f60fb313a1c81ff387cab247d1530f73fd8d0aff1d5189b29350ce",
		"old_portrait_sha256": "b93b0f4259309ce5c01c907adb0f2e3c2d6c5b33f6c3f0917a23da8a8d7fe3fe", "old_icon_sha256": "cfc4d5b9b9d6db8583f31072d8017efc893230fb739ac3bfb21ab8f4d5a76249", "old_overworld_icon_sha256": "65f780cb78d28b4229694a6f9834d5fb381df3761f3032713a2ccdbe6bb7e139", "old_sheet_sha256": "95015905300f1e69e894e4f16bbfdc0522e609c51f7b14e9dbfcf9fe5a8f3e42",
	},
]
...
func _validate_content_authority() -> void:
	var dwelling: Dictionary = ContentService.get_neutral_dwelling("neutral_dwelling_icehook_trapper_lodge")
	_expect(dwelling.get("unit_ids", []) == ["unit_neutral_icehook_trappers", "unit_neutral_whitepike_keepers"], "Icehook Trapper Lodge unit order changed.")
	_expect(dwelling.get("site_ids", []) == ["site_icehook_trapper_lodge"] and dwelling.get("map_object_ids", []) == ["object_icehook_trapper_lodge"], "Icehook Trapper Lodge site/object graph changed.")
	_expect(dwelling.get("army_group_ids", []) == [SHARED_ARMY_ID] and dwelling.get("encounter_ids", []) == ["encounter_icehook_trapper_lodge_watch"], "Icehook Trapper Lodge army/encounter graph changed.")
	var generated_site_rows: Array = RandomMapGeneratorRulesScript.DWELLING_SITE_CANDIDATES.filter(func(row): return row is Dictionary and String(row.get("site_id", "")) == "site_icehook_trapper_lodge")
	_expect(generated_site_rows.is_empty(), "Icehook Trapper Lodge must not gain a RandomMapGeneratorRules candidate as part of its art-only slice.")
	...
	var native_proxy_rows: Array = proxy_entries.filter(func(row): return row is Dictionary and String(row.get("native_proxy_object_id", "")) == "object_icehook_trapper_lodge")
	_expect(native_proxy_rows.is_empty(), "Icehook Trapper Lodge must not gain a Native-RMG proxy as part of its art-only slice.")
	_report["native_rmg_proxy_rows"] = native_proxy_rows.duplicate(true)
	var site: Dictionary = ContentService.get_resource_site("site_icehook_trapper_lodge")
	_expect(_resource_cost_contract(site.get("claim_rewards", {})) == {"gold": 75} and _resource_cost_contract(site.get("claim_recruits", {})) == {"unit_neutral_icehook_trappers": 2, "unit_neutral_whitepike_keepers": 1}, "Icehook Trapper Lodge claim reward/recruit contract changed.")
	_expect(_resource_cost_contract(site.get("control_income", {})) == {"gold": 30} and _resource_cost_contract(site.get("weekly_recruits", {})) == {"unit_neutral_icehook_trappers": 1}, "Icehook Trapper Lodge control income/weekly muster changed.")
	var encounter: Dictionary = ContentService.get_encounter("encounter_icehook_trapper_lodge_watch")
	_expect(String(encounter.get("enemy_group_id", "")) == SHARED_ARMY_ID and String(encounter.get("terrain", "")) == "forest" and encounter.get("battlefield_tags", []) == ["fog_bank", "ambush_cover"] and int(encounter.get("max_rounds", 0)) == 13, "Icehook Trapper Lodge encounter authority changed.")
...
func _validate_authored_site_authority() -> void:
	...
	for expected_variant in AUTHORED_SITE_ROWS:
		...
		_expect(not placement.is_empty() and String(placement.get("site_id", "")) == String(expected["site_id"]) and int(placement.get("x", -1)) == int(expected["x"]) and int(placement.get("y", -1)) == int(expected["y"]), "%s must retain authored Icehook Trapper Lodge site %s at its exact placement." % [String(expected["scenario_id"]), String(expected["placement_id"])])
...
func _validate_live_icehook_trapper_lodge_battle_board() -> void:
	...
	var expected_counts := {"unit_neutral_icehook_trappers": 7, "unit_neutral_whitepike_keepers": 3}
	var shared_army: Dictionary = ContentService.get_army_group(SHARED_ARMY_ID)
	_expect(String(shared_army.get("id", "")) == SHARED_ARMY_ID and _stack_counts(shared_army) == expected_counts, "Shared Icehook Trapper Lodge Watch ids/counts changed.")
	var placement := {"placement_id": "icehook_trapper_lodge_curated_art_fixture", "encounter_id": "encounter_icehook_trapper_lodge_watch", "enemy_army": shared_army.duplicate(true), "x": 4, "y": 4, "resolved": false}
	...
	_expect(_battle_stack_counts(enemy_stacks) == expected_counts, "Public Icehook Trapper Lodge battle payload changed its exact enemy roster.")
	for spec_variant in UNITS:
		var spec: Dictionary = spec_variant
	...
	for spec_variant in UNITS:
		...
		_expect(matches.size() == 1, "BattleBoard must expose exactly one %s Icehook Trapper Lodge stack." % String(spec["label"]))
		if matches.size() == 1:
	...
	_expect(session.to_dict() == authority_before, "BattleBoard art observation must not mutate the live Icehook Trapper Lodge battle/session.")
