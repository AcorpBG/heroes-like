...
- The clean terrain-fill boundary now exposes the recovered terrain portion of final generated-cell tile writeout `0x49b2b6`: 1296 tile byte-0 terrain ids, byte-1 terrain art indices, and byte-6 terrain flip bits are packed from `cell+0x24/+0x28` semantics for the seed-1 small land inspection case; road/river overlay bytes remain pending and are not synthesized.
