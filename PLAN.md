...
- The partial package adoption deliberately sets `native_runtime_authoritative: false`, `full_parity_claim: false`, and `no_authored_writeback: true` while preserving explicit `pending_0x4ab37f_road_adapter_path_port` and `h3maped_0x4a79a3_link_guard_payload_ported_guard_object_materialization_pending` statuses.
- `tests/native_rmg_small_h3maped_port_boundary_report.tscn` passed with `status: h3maped_small_clean_restart_template_selection_ready`, `archive_status: previous_native_catalog_auto_generator_archived_debug_only`, `accepted_template_count: 13`, `selected_template: h3maped_template_018`, `generated_validation_status: pass`, `generation_status: h3maped_small_clean_restart_phase_package_adoption_partial`, `generated_town_count: 3`, `generated_mine_count: 12`, `generated_connection_count: 5`, `generated_connection_status: h3maped_0x4a79a3_link_payload_semantics_ported_geometry_roads_guards_pending`, `out_of_scope_generation_status: archived_legacy_native_rmg_disabled`, and explicit pending road/guard statuses. The footprint counts changed because the clean order now consumes the two `0x49b53d` terrain RNG calls before `0x4a3a03`.
