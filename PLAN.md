...
- The first footprint helper, `0x4a2777`, is disassembled into the boundary report without faking materialization. It records endpoint clipping through `0x4a2b33`, cell-buffer line writes through `0x4a261a`, flagged jittered/interpolated writes through `0x4a2413`, footprint vertex appends to `runtime_zone+0x3f4`, 48-byte cell stride, zone-word writes at `cell+0x20`, reserved-cell flagging at `cell+0x2b`, and the remaining runtime layout blockers needed before real cells can be painted.
