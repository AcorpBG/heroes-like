...
- Pending before runtime generation: TerrainPlacement art/index/flip byte selection and project-grid/package adoption from the inspected terrain-cell buffer, owned towns, roads, blockers, guards, mines, rewards, and final writeout.
