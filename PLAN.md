...
Completed slice on 2026-05-25: `economy-fastest-capstone-rare-pacing-followup-20260525-10184` paused new gate creation and audited current economy/town evidence as a player-balance pass before tuning. Findings: Brasshollow, Thornwake, and Veilmourn currently have the strongest economic identity because rare pressure appears across more late civic/support decisions, while Embercourt, Mireclaw, and Sunvault have real payoff hooks but still lean more on renamed rare-resource pressure and repeated curve patterns; active authored rare-source placement remains narrow, especially for Verdant Grafts, Brass Scrip, and Memory Salt, and strict Small generated-map economy evidence is useful but scoped to 36x36 land/template breadth rather than broad RMG approval. The implemented tuning keeps the late Embercourt/Sunvault capstone rare-pressure correction and fixes player-facing duplicate town-building names in Embercourt, Mireclaw, and Sunvault so build curves no longer read as repeated buildings. Existing reports, without adding new gates, keep authored town completion day 28-30, deterministic scorecard 15/15, active source routes 54/54 player and 60/60 enemy reachable, unique payoff runtime green, and town buildable display names unique per authored town. This is player-balance/readability tuning, not campaign production work, final economic identity, active rare-source breadth completion, or broad generated-map economy approval.

Completed slice on 2026-05-25: `economy-thin-faction-town-identity-metadata-20260525-10184` responds to the player-balance audit finding that Embercourt, Mireclaw, and Sunvault had real town economy hooks but thinner faction-unique non-unit identity evidence than Brasshollow, Thornwake, and Veilmourn. Existing faction-flavored, already-authored non-unit buildings now carry faction ownership, so live town payoff evidence reads those towns as faction-specific without changing build costs, target counts, unit tiers, or the 30-turn development pacing contract. Existing reports, without adding new gates, keep authored town completion at day 27-30 and raise runtime unique non-unit identity coverage to Embercourt 11, Mireclaw 11, Sunvault 10, with all 165 unique-building runtime payoff cases passing. The runtime-inclusive economy/town scorecard remains 35/35. This is town identity/evidence alignment using existing reports, not campaign production work, final art direction, or broad generated-map economy approval.

Completed slice on 2026-05-25: `economy-active-ai-town-pacing-floor-20260525-10184` responds to the player-balance audit finding that active AI town development could overrun the intended economy pacing floor when authored scenario sources were abundant. The existing enemy town governor now reports and enforces development pacing eligibility, idling when a target-development build would make the full town curve finish before day 24 while preserving one build per town per turn and completion inside the 30-turn runway. The existing runtime-inclusive scorecard, without adding a new gate, now passes 35/35; active AI town evidence covers 20 enemy towns, completion day 24-28, 20/20 pacing-floor cases, rare spend, same-day build blocking, delayed-source save/resume, and six-faction seven-tier recruitment. The scorecard also keeps recruitment-market recovery focused on actual wood/ore market purchases while the existing market-cap persistence runtime report owns weekly reset evidence. This is a runtime balance tuning slice, not campaign production work, final strategic AI quality, or broad generated-map economy approval.

Completed slice on 2026-05-25: `economy-mireclaw-final-upgrade-pressure-20260525-10184` continues production town-balance tuning by strengthening Mireclaw's final upgrade pressure after the prior pass left it with the softest rare bottleneck floor. `Oathmire Court` now costs more gold, ore, and `peatwax`, keeping the pressure on the final civic upgrade rather than reshaping the whole swamp ladder. Existing reports, without adding new gates, keep authored town completion inside day 27-30, all Mireclaw towns complete on day 28, Mireclaw late rare bottleneck counts improve to 3-4 days, `peatwax` ends at 0, max ending ore falls from 9 to 8, and deterministic economy/town scorecard remains 15/15. This is narrow player-balance content tuning, not broad generated-map economy generalization or final combat/AI balance.

Completed slice on 2026-05-25: `economy-veilmourn-late-common-surplus-pressure-20260525-10184` continues production town-balance tuning by spending Veilmourn's late gold and ore surplus without weakening its memory-salt identity. `Leviathan Sounding` and `Memory-Rite Court` now cost more gold and ore, keeping the same rare-resource curve while making the final harbor rite and leviathan command pier consume more of the common economy. Existing reports, without adding new gates, keep authored town completion inside day 27-30, both Veilmourn towns complete on day 28, Veilmourn ending gold falls by 2000 per town, ending ore falls from 7 to 3, memory-salt ends at 0, and deterministic economy/town scorecard remains 15/15. This is narrow player-balance content tuning, not broad generated-map economy generalization or final combat/AI balance.

Completed slice on 2026-05-25: `economy-sunvault-late-wood-surplus-pressure-20260525-10184` continues production town-balance tuning by spending Sunvault's leftover wood in its late magical/civic finish instead of letting the faction coast on surplus framing material. `Daybreak Matrix` and `Zenith Court` now cost more wood and gold, preserving the aetherglass rare curve and Sunvault relay identity while making the late optical works consume more of the common economy. Existing reports, without adding new gates, keep authored town completion inside day 27-30, Halo Spire completes on day 27, Prismhearth completes on day 30, Sunvault ending wood falls from 10/9 to 6/5, global max ending wood falls to 6, and deterministic economy/town scorecard remains 15/15. This is narrow player-balance content tuning, not broad generated-map economy generalization or final combat/AI balance.

Completed slice on 2026-05-25: `economy-brasshollow-late-cost-mix-pressure-20260525-10184` continues production town-balance tuning by making Brasshollow's late industrial curve read less like a single forced ore choke. `Redline Assembly Yard`, `Brassbound Directorate`, and `Warrant Engine House` now move one point of cost pressure from ore into wood and higher gold costs, preserving Brasshollow's industrial identity while spending more of the gold/wood that previously piled up unused. Existing reports, without adding new gates, keep authored town completion inside day 27-30, both Brasshollow towns complete on day 28, Brasshollow common-material bottleneck days drop from 9 to 5, ending gold falls from roughly 9k-9.6k to 4.7k-5.2k, ending wood falls from 10 to 6, and deterministic economy/town scorecard remains 15/15. This is narrow player-balance content tuning, not broad generated-map economy generalization or final combat/AI balance.

Completed slice on 2026-05-25: `economy-mireclaw-late-rare-capstone-pressure-20260525-10184` continues production town-balance tuning by tightening Mireclaw's softest late rare-resource finish. Mireclaw `Oathmire Court` now costs 5 `peatwax` instead of 3, improving late rare pressure across all Mireclaw towns without adding new gates, changing the seven-tier unit ladder, or touching campaign production. Existing reports keep authored town completion inside day 27-30, all Mireclaw towns complete on day 27, Mireclaw late rare bottleneck counts improve to 2-3 days, affected towns end with 0 `peatwax`, and deterministic economy/town scorecard remains 15/15. This is narrow player-balance content tuning, not broad generated-map economy generalization or final combat/AI balance.

Completed slice on 2026-05-25: `economy-thornwake-late-ore-pressure-tuning-20260525-10184` continues production town-balance tuning by reducing unused ore surplus in Thornwake's late 30-turn development curve. Thornwake `Bastion Seed Conclave` and `Rootlaw Moot` now each cost 4 ore instead of 2, making late civic development consume more common material without changing rare-resource identity or the seven-tier unit ladder. Existing reports, without adding new gates, keep authored town completion inside day 26-30, deterministic economy/town scorecard 15/15, Thornwake completion at day 30, and reduce Thornwake ending ore from 11 to 7 while lowering the global observed max ore surplus from 11 to 9. This is narrow player-balance tuning, not campaign production work, final combat balance, or broad generated-map economy generalization.

Completed slice on 2026-05-25: `economy-fastest-town-late-rare-capstone-pacing-20260525-10184` continues production town-balance tuning by pulling the fastest authored town completions closer to the 30-turn target. Embercourt `Charter Flame` now costs 5 `embergrain` and Sunvault `Zenith Court` now costs 5 `aetherglass`, increasing late rare-resource pressure on their final upgrade steps without changing common-resource dominance or seven-tier unit ladders. Existing reports, without adding new gates, keep authored town completion inside day 26-30, deterministic economy/town scorecard 15/15, Riverwatch/Highwater completion at day 27, Halo Spire at day 27, and Prismhearth still at day 30. This is narrow player-balance tuning, not campaign production work, final combat balance, or broad generated-map economy generalization.

Completed slice on 2026-05-25: `economy-high-tier-early-spike-build-curve-tuning-20260525-10184` continues production town-balance tuning by removing the remaining day-4/day-5 tier-5 spikes from Brasshollow, Thornwake, and Veilmourn authored towns. Brasshollow `Pressure Rail` now requires `Scalehouse`, Thornwake `Pilgrim Orchard` now requires `Rootroad Markers`, and Veilmourn `Obituary Vault` now requires `Salt Counting House`, so each high-tier rare unit step waits behind a faction-specific economy or route-support identity step. Existing reports, without adding new gates, keep authored town completion inside day 24-30, deterministic economy/town scorecard 15/15, and move affected tier-5 timing to day 6 for Brasshollow/Thornwake and day 9 for Veilmourn. This is narrow player-balance tuning, not campaign production work, final combat balance, or broad generated-map economy generalization.

Completed slice on 2026-05-25: `economy-sunvault-early-relay-build-curve-tuning-20260525-10184` continues the player-balance town curve pass by tightening Sunvault's first-week town identity. Sunvault `Lens Gallery` now requires `Lens Tithe`, `Harmonic Cloister` now requires `Relay Scribes`, and Prismhearth/Halo Spire build ordering now surfaces `Lens Tithe` and `Relay Scribes` before the generic filler curve can hide that identity. Existing reports, without adding new gates, keep authored town completion inside day 24-30, deterministic economy/town scorecard 15/15, and Sunvault completion at day 25 for Halo Spire and day 30 for Prismhearth. This is narrow player-balance tuning, not campaign production work, final generated-map economy generalization, or a new validation gate.

Completed slice on 2026-05-25: `economy-embercourt-mireclaw-early-identity-build-curve-tuning-20260525-10184` responds to the player-balance audit finding that Embercourt and Mireclaw still read too much like renamed rare-resource pressure because their early town curves could sprint through T2 unit support before faction economy support. Embercourt `Tollstone Weir` now requires `Lockhouse Tally`, and Mireclaw `War Drum Circle` now requires `Reed Toll`, making first-week development pass through visible toll/route economy identity before T2/T3 acceleration. Existing reports, without adding new gates, keep authored town completion inside day 24-30, deterministic economy/town scorecard 15/15, and affected Embercourt/Mireclaw town completion on days 24-27. This is narrow player-balance tuning, not campaign production work, final economy identity completion, broad generated-map generalization, or a new validation gate.

Completed slice on 2026-05-25: `economy-ninefold-rare-source-breadth-tuning-20260525-10184` responds to the player-balance audit finding that active rare-resource placement was too narrow, especially for `verdant_grafts`, `brass_scrip`, and `memory_salt`. Ninefold Confluence now gives Thornwake, Brasshollow, and Veilmourn towns a second reachable matching rare-source front near their enemy town claims, turning those rare economies from single scripted dependencies into a small contested local economy. Existing evidence, without adding new gates, shows each affected Ninefold town now has 2/2 matching rare-source candidates reachable through the active source-route report, while the deterministic economy/town scorecard remains 15/15. This is authored skirmish/campaign breadth-map tuning only, not campaign production work, broad rare-source distribution completion, generated-map generalization, or a final economy identity pass.

Completed slice on 2026-05-25: `economy-town-player-readability-surface-scorecard-20260525-10184` responds to OpenClaw review feedback that recent economy work was too validation-led and not enough about reading the economy as a player. TownShell resource/build UI now exposes a compact player-readable economy plan in the live town resource tooltip and validation snapshot: daily income, next build, build bottleneck, next muster, field-site value, and rare-resource bottleneck identity. The focused TownShell economy resource UI report and runtime-inclusive economy/town scorecard now fail unless all six faction seed towns expose that player-readable economy plan, surface missing rare resources as build bottlenecks, and still preserve common-only market and one-build-per-day guards. Current evidence passes 6/6 player-readable economy plan cases, 6/6 rare bottleneck surface cases, 6/6 ready build plan surface cases, 6/6 same-day build lockout cases, deterministic 15/15 scorecard, and runtime-inclusive 35/35 scorecard. This is player-facing town economy readability work, not campaign production work.

Completed slice on 2026-05-25: `economy-generated-package-neutral-town-capture-runway-scorecard-20260525-10184` extends strict Small generated/native package town-development evidence from owned player/enemy towns to capturable neutral expansion towns. The native package adoption report and runtime-inclusive economy/town scorecard now prove generated neutral towns can transition to player ownership, then complete live town development inside the day-24-to-day-30 pacing window with rare spend, one-build-per-day guards, minimal required-resource source adoption, and seven-tier recruitment. Current evidence passes 4/4 generated neutral town capture/development cases, completion days 24-28, 85 total neutral-capture builds, 12 secured generated sources, and the runtime-inclusive economy/town scorecard passes 35/35. This is generated-map economy/town development evidence only, not campaign production work, player-facing economy readability, larger-size generated-map economy approval, final strategic AI quality, final encounter pacing, or final route-safety approval.

Completed slice on 2026-05-25: `economy-generated-package-neutral-town-source-route-scorecard-20260525-10184` extends the strict Small generated/native package economy source-route contract from generated player/enemy towns to every generated economy town, including neutral towns. Native package session adoption now adds local required-source support for neutral generated towns after exact native masks are applied, generated support placement prefers walkable town approach starts with a local fallback for mask-caged neutral towns, and source-route validation rejects borrowing another town's generated support nodes. The native package adoption report and runtime-inclusive economy/town scorecard now fail unless all generated player, enemy, and neutral town routes to wood, ore, and faction-rare sources are reachable, guarded source pressure is retained, and breadth route totals match total generated town totals. Current evidence passes 7/7 active generated town route cases, including 4 neutral generated town route cases, 21/21 active generated package town source routes reachable, 7/7 active generated towns retaining guarded source and guarded rare-source pressure, max source acquisition day 2 <= 6, 119 active generated resource nodes, 3/3 deterministic breadth cases, 15/15 breadth generated towns with route coverage, 45/45 breadth source routes reachable, 15/15 breadth guarded faction-rare source routes, and 256 breadth resource nodes. The runtime-inclusive economy/town scorecard passes 34/34. This is generated-map economy/town development evidence only, not campaign production work, larger-size generated-map economy approval, final strategic AI quality, final encounter pacing, or final route-safety approval.

Completed slice on 2026-05-25: `economy-generated-package-breadth-rare-source-guard-pressure-scorecard-20260525-10184` strengthens strict Small generated/native package economy breadth evidence by applying the guarded source-route contract to every deterministic breadth case instead of only the active startup package. Native package session adoption now adds local required-source support for generated player/enemy towns after exact native masks are applied, so inter-town guard blocking no longer leaves a generated town without reachable wood, ore, or faction-rare source access. The native package adoption report now embeds `generated_package_town_economy_source_routes_v1` evidence inside each `generated_package_town_economy_breadth_v1` case and fails unless every breadth case keeps all generated player/enemy town source routes reachable, every generated town retains guarded source pressure, every generated town has a guarded faction-rare source route, and rare-source acquisition stays inside the generated source acquisition window. Current evidence passes 3/3 breadth cases, 9/9 breadth player/enemy town route cases, 27/27 breadth source routes reachable, 9/9 breadth guarded faction-rare source routes, max breadth source acquisition day 2 <= 6, 15 total breadth towns, 238 breadth resource nodes, three generated project factions, and six generated town templates. The runtime-inclusive economy/town scorecard gates the same multi-seed route-pressure totals through `generated_package_town_economy_breadth_runtime` and passes 34/34. This is strict Small 36x36 one-level land generated economy breadth guard-pressure evidence, not campaign production work, larger-size generated-map economy approval, final strategic AI quality, final encounter pacing, or final route-safety approval.

Completed slice on 2026-05-25: `economy-generated-package-rare-source-guard-pressure-scorecard-20260525-10184` strengthens strict Small generated/native package economy evidence by preventing generated faction-rare source routes from becoming unguarded pickups. Native mine package objects now preserve protected-mine vector identity for mine guards, shared connection guards can retain protected-resource links, generated package session adoption materializes a real linked guard encounter for any generated rare source that still lacks one, and resource claiming now rejects linked guard-protected sources until the guard is cleared. The native package adoption report now fails unless every generated player/enemy town has a guarded faction-rare source route and proves that guarded rare sources block direct claiming before guard clear; the runtime-inclusive economy/town scorecard gates `generated_package_rare_source_guard_pressure_runtime`. Current focused evidence passes 3/3 generated package towns retaining guarded rare-source pressure, 3 guarded rare-source routes, guarded rare-source claim rejection, max source acquisition day 4, source acquisition limit 6, and 9/9 generated package town source routes reachable. This is strict Small 36x36 one-level land generated rare-source guard-pressure evidence, not campaign production work, broad larger-size generated-map economy approval, final strategic AI quality, final encounter pacing, or final route-safety approval.

Completed slice on 2026-05-25: `economy-generated-package-source-guard-pressure-scorecard-20260525-10184` strengthens strict Small generated/native package economy evidence by preventing generated player/enemy town source routes from becoming free unguarded pickups. The native package adoption report now derives route-based source acquisition days from generated source-route steps, applies a guarded-source delay, and fails unless every generated player/enemy town retains at least one guarded generated economy-source route while acquisition remains inside the 30-turn town-development runway. The runtime-inclusive economy/town scorecard now gates `generated_package_source_guard_pressure_runtime`. Current evidence passes 3/3 generated package towns retaining guarded source pressure, 3 guarded source routes, 3 guarded common-source routes, max source acquisition day 3, source acquisition limit 6, and the full runtime-inclusive scorecard passes 33/33. This is strict Small 36x36 one-level land generated economy-source pressure evidence, not campaign production work, broad larger-size generated-map economy approval, final strategic AI quality, final encounter pacing, or final route-safety approval.

Completed slice on 2026-05-25: `economy-generated-package-town-source-route-scorecard-20260525-10184` strengthens the owner-directed production-ready economy/town goal by making strict Small generated/native package towns prove reachable generated source routes instead of only proving that source objects exist. Native package adoption now reserves guard-control clearance around town starts so generated guards still block route chokepoints without caging a town start, and runtime town lookup no longer treats broad package town visit metadata as route-blocking interaction tiles. The native package adoption report emits `generated_package_town_economy_source_routes_v1`, and the runtime-inclusive economy/town scorecard gates `generated_package_town_source_route_runtime`. Current evidence passes 9/9 generated package town source routes across the generated player town and two generated enemy towns, with wood/ore/faction-rare routes reachable, max common route length 8 steps, max rare route length 26 steps, and hard limits of 40 common steps and 56 rare steps. This is strict Small 36x36 one-level land generated source-route evidence, not campaign production work, broad larger-size generated-map economy approval, final strategic AI quality, final encounter pacing, or final route-safety approval.

Completed slice on 2026-05-25: `economy-generated-package-town-economy-breadth-scorecard-20260525-10184` strengthens the owner-directed production-ready economy/town goal by making strict Small generated/native package town-economy evidence cover multiple deterministic package seeds instead of only the active startup package. The native package adoption report now emits `generated_package_town_economy_breadth_v1`, and the runtime-inclusive economy/town scorecard gates `generated_package_town_economy_breadth_runtime`. Current evidence passes 3/3 generated package economy breadth cases with distinct map/scenario package hashes, 15 total generated towns, 211 generated resource nodes, authored town templates, seven-tier town ladders, rare-resource development identities, common `gold`/`wood`/`ore` source coverage in every breadth case, player-required rare source coverage in every breadth case, three generated project factions, and six generated town templates. This is strict Small 36x36 one-level land generated package economy breadth evidence, not campaign production work, campaign balance, larger-size RMG economy approval, final route safety, strategic AI quality, final encounter pacing, or final exact-price approval.

Completed slice on 2026-05-25: `economy-active-runway-pacing-floor-scorecard-20260525-10184` tightens the owner-directed production-ready economy/town balance goal by applying the same day-24-to-day-30 development pacing window and minimal required-resource source adoption policy to active authored player-town and AI-town runway evidence. Active player-town reports now fail if any covered town completes before day 24, after day 30, or receives every matching authored economy source up front; current focused/runtime evidence passes 18/18 player cases with completion days 24-26, 18/18 pacing-floor cases, and 18/18 minimal source-adoption cases. Active AI-town reports now apply the same pacing and source-adoption contract while persistent economy sources grant control income without dumping one-time claim rewards into AI treasury setup; current focused/runtime evidence passes 20/20 enemy cases with completion days 24-30, 20/20 pacing-floor cases, 20/20 minimal source-adoption cases, rare spend, same-day guards, delayed-source save/resume, six-faction AI coverage, and seven-tier recruitment. This is existing authored launch-surface economy/town runway evidence only, not campaign-content production, campaign balance, final route safety, encounter pacing, strategic AI quality, broad generated-map economy, or final exact-price approval.

Completed slice on 2026-05-25: `economy-active-launch-surface-coverage-scorecard-20260525-10184` strengthens the owner-directed production-ready economy/town goal by splitting active authored economy evidence by campaign and skirmish launch surfaces instead of allowing aggregate active-scenario counts to hide missing player-facing modes. The active resource matrix, source-route report, player-town runway, AI-town runway, and top-level scorecard now gate 15 campaign scenarios, 16 skirmish scenarios, 17 campaign player-town cases, 18 skirmish player-town cases, 19 campaign enemy-town cases, and 20 skirmish enemy-town cases, while preserving all-nine-resource source coverage, 54/54 player source routes, 60/60 enemy source routes, 18/18 player runway completion, 20/20 enemy runway completion, delayed-source save/resume, rare spend, one-build-per-day guards, six-faction AI coverage, and seven-tier recruitment. This is current authored campaign/skirmish launch-surface economy evidence, not final encounter pacing, strategic AI quality, manual campaign balance, broad generated-map economy, route safety approval, or final exact-price approval.

Completed slice on 2026-05-25: `economy-generated-package-enemy-town-pacing-scorecard-20260525-10184` continues the owner-directed production-ready town-balance target by applying the same day-24-to-day-30 generated town pacing expectation to strict Small generated/native package enemy-town runway evidence. Generated enemy source adoption now uses minimal required-resource coverage, and pre-secured persistent mines contribute control income without also dumping one-time claim rewards into the AI treasury on day 1. Current evidence passes the focused native package report and runtime-inclusive 30/30 economy/town scorecard checks: 2/2 generated enemy towns complete with 44 total builds, completion days 24-25, day-24 pacing-floor compliance, 7 total secured generated sources, rare spend, same-day build guards, full live treasury tracking, governor report coverage, generated source coverage, seven-tier recruitment candidates, and selected affordable recruitment. This is strict Small 36x36 one-level land generated enemy-town pacing evidence, not broad generated-map economy balance, route safety, strategic AI quality, campaign/skirmish balance, or final encounter pacing approval.

Completed slice on 2026-05-25: `economy-generated-package-player-town-pacing-scorecard-20260525-10184` tightens the owner-directed production-ready town-balance target by applying the authored day-24-to-day-30 town pacing expectation to strict Small generated/native package player-town runway evidence. Generated package player-town source adoption now uses minimal required-resource coverage instead of securing every matching generated source up front, and the runtime scorecard gates the generated player-town completion floor. Current evidence passes the focused native package report and runtime-inclusive 30/30 economy/town scorecard checks: `town_highwater_keep` builds 22 initially missing targets on completion day 24, secures 3 generated sources for `embergrain`, `gold`, `ore`, and `wood`, spends rare resources, blocks same-day second builds, and recruits all seven tiers. This is strict Small 36x36 one-level land generated player-town pacing evidence, not broad generated-map economy balance, route safety, strategic AI quality, campaign/skirmish balance, or final encounter pacing approval.

Completed slice on 2026-05-25: `economy-town-common-surplus-pressure-scorecard-20260525-10184` tightens the owner-directed production-ready town-balance target by adding deterministic post-development common-resource surplus pressure. The town-development balance report and top-level scorecard now reject authored town curves that finish with excessive unspent gold, wood, or ore reserves, using absolute caps of gold 10000, wood 12, ore 12 and surplus-ratio caps of gold 0.30, wood 0.50, ore 0.50. Current evidence passes deterministic 15/15 and runtime-inclusive 30/30 economy/town scorecard checks, with observed ending common surplus maxima of gold 9600, wood 10, ore 11 and observed ratio maxima of gold 0.2602, wood 0.4348, ore 0.4783. This is deterministic surplus-envelope evidence for current authored towns, not final exact-price approval, campaign economy approval, route safety, strategic AI quality, or encounter balance.

Completed slice on 2026-05-25: `economy-town-development-phase-curve-scorecard-20260525-10184` strengthens the owner-directed 30-turn town-balance target by turning the existing deterministic day-24-to-day-30 evidence into a hard phase-curve gate. The town-development balance report and top-level scorecard now reject authored town curves that finish before the day-24 production pacing floor, skip required early/mid/late build distribution, or lack late development work even if they technically complete within 30 turns. Current evidence passes deterministic 14/14 and runtime-inclusive 29/29 economy/town scorecard checks, with completion days spanning 24-30 and phase minimums of early 10, mid 6, and late 2 builds. This is deterministic economy/town curve evidence for current authored towns, not final campaign economy approval, route safety, strategic AI quality, encounter balance, or exact manual price approval.

Completed slice on 2026-05-25: `economy-town-ui-build-lockout-scorecard-20260525-10184` strengthens the owner-directed one-build-per-town-turn requirement by making the live TownShell resource/build UI surface prove same-day construction lockout after a build selected from the TownShell action surface. `town_economy_resource_ui_surface_report_v1` now proves 6/6 faction seed towns expose zero post-build construction actions, zero enabled post-build construction actions, recorded `last_build_day`, and same-day guards on remaining unbuilt targets after the selected rare-cost build completes. The runtime-inclusive economy/town scorecard now gates `town_resource_ui_same_day_build_lockout_runtime` and passes 28/28 checks. This is a UI/runtime regression gate for the current town economy loop, not final town UI art, campaign balance, exact price approval, or broad UX polish.

Completed slice on 2026-05-25: `economy-active-enemy-source-route-scorecard-20260525-10184` strengthens the owner-directed economy/town goal by extending active authored scenario source-route evidence from player towns to enemy towns. `active_scenario_town_economy_source_route_report_v1` now checks both player-owned and enemy-owned active towns against reachable wood, ore, and faction-rare resource sources through live overworld blocker, action-destination, route-interaction, and corner-cut rules. Current focused evidence covers 16 active scenarios, 18 player-town cases with 54/54 player source routes reachable, and 20 enemy-town cases with 60/60 enemy source routes reachable. The runtime-inclusive economy/town scorecard now gates `active_scenario_enemy_source_route_runtime` and passes 27/27 checks. This is active authored source-route evidence for current economy runways, not final encounter pacing, route safety, strategic AI quality, campaign balance, or broad generated-map economy approval.

Completed slice on 2026-05-25: `economy-generated-package-enemy-town-runway-scorecard-20260525-10184` strengthens the owner-directed economy/town goal by promoting strict Small generated/native package enemy-town development into live AI runtime evidence. `EnemyTurnRules` now resolves enemy faction configs from authored scenarios, valid native package runtime records, or synthesized generated package town controllers when package labels are non-project H3M ids, so generated enemy towns can use the live AI town governor instead of silently skipping economy turns. The native package adoption report now emits `generated_package_enemy_town_development_runway_v1`; current evidence covers 2 generated enemy towns, 44 total AI builds, all cases complete, rare spend, same-day build guards, full live treasury keys, governor report coverage, generated source coverage, seven-tier recruitment candidates, and selected affordable recruitment. The runtime-inclusive economy/town scorecard now passes 26/26 checks. This is strict Small generated package enemy-town runway evidence, not broad generated-map economy balance across sizes/templates, final strategic AI quality, route safety, encounter pacing, or campaign/skirmish balance.

Completed slice on 2026-05-25: `economy-generated-package-town-identity-diversity-scorecard-20260525-10184` strengthens the owner-directed economy/town goal by preventing strict Small generated/native package towns from collapsing H3M town identities back into one or two project templates. `NativeRandomMapPackageSessionBridge` now maps supported h3maped/H3M town tokens into original project faction/town identities before session town state materialization, and invalid start-contract H3M faction labels no longer override the resolved project player faction. The generated package town-economy surface now gates identity diversity with 4 generated project factions and 5 generated town templates across 7 generated towns, while preserving authored town templates, seven-tier ladders, rare-development identities, 98 generated resource nodes, and player-required `gold`, `wood`, `ore`, and `embergrain` source coverage. The generated player-town runway now distinguishes total template targets from initially missing targets, proving `town_highwater_keep` builds 22 initially missing targets by day 22, spends rare resources, preserves one-build-per-day blocking, advances generated package economy days, and recruits all seven tiers. The runtime-inclusive economy/town scorecard still passes 25/25 checks. This is strict Small generated package identity/diversity and player-town runway evidence, not broad generated-map economy balance across sizes/templates, final route safety, final encounter pacing, or campaign/skirmish balance.

Completed slice on 2026-05-25: `economy-generated-package-player-town-runway-scorecard-20260525-10184` strengthens the owner-directed economy/town goal by promoting strict Small generated/native package player-town development from wiring evidence into live runtime behavior evidence. The native package adoption report now emits `generated_package_player_town_development_runway_v1`; current evidence proves the disk-loaded generated package player town (`town_riverwatch`, Embercourt) secures generated development sources for `gold`, `wood`, `ore`, and `embergrain`, builds all 22 town targets by day 22 inside the 30-turn target, preserves one-build-per-day blocking, observes rare-resource spend, advances generated package economy days, and recruits all seven unit tiers through live town rules. The runtime-inclusive economy/town scorecard now passes 25/25 checks with the new `generated_package_player_town_runway_runtime` gate. This is generated strict Small player-town runway coverage, not broad generated-map economy balance across sizes/templates, route safety, final encounter pacing, or final campaign/skirmish balance.

Completed slice on 2026-05-25: `economy-generated-package-town-economy-scorecard-20260525-10184` strengthens the owner-directed economy/town goal by extending runtime scorecard coverage from authored scenarios into strict Small native/generated package sessions. `NativeRandomMapPackageSessionBridge` now adapts H3M rare mine proxies into original live rare-resource fronts instead of collapsing those mines into common/gold-only economy, and generated town states normalize invalid H3M faction labels back to the authored town template faction. The native package adoption report now emits `generated_package_town_economy_surface_v1`; current evidence passes with 7/7 generated package towns backed by authored town templates, 7/7 seven-tier ladders, 7/7 rare-resource development identities, 98 generated resource nodes, generated source coverage for `gold`, `wood`, `ore`, `aetherglass`, `embergrain`, `peatwax`, and `memory_salt`, and no missing player-required common or rare resource sources. The full runtime-inclusive economy/town scorecard now passes 24/24 checks. This is strict Small generated package town-economy wiring evidence, not broad generated-map economy balance, larger-size RMG approval, final encounter pacing, or final campaign/skirmish balance.

Completed slice on 2026-05-25: `economy-town-active-source-route-scorecard-20260525-10184` strengthens the owner-directed economy/town goal by promoting active player-town source route reachability into the runtime-inclusive scorecard. The scorecard now runs `active_scenario_town_economy_source_route_report_v1` and gates `active_scenario_source_route_runtime`, requiring every active player town to have reachable wood, ore, and faction-rare source routes through live overworld route rules, with common routes capped at 24 steps and rare routes capped at 40 steps. Current focused evidence passes 16 active scenarios, 18 player-town cases, 54/54 reachable source routes, and the full runtime-inclusive economy/town scorecard passes 23/23 checks. This is stronger route-access evidence for current authored scenario economy, not final encounter pacing, route safety, campaign balance approval, combat/reward tuning, or broad generated-map economy approval.

Completed slice on 2026-05-25: `economy-town-active-ai-six-faction-runtime-scorecard-20260525-10184` strengthens the owner-directed economy/town goal by making active AI town-development runtime evidence prove all six controller factions and all six native town-ladder factions are represented. The active AI town runway now emits `unique_faction_count`, `covered_faction_ids`, `unique_ladder_faction_count`, and `covered_ladder_faction_ids`; the runtime-inclusive economy/town scorecard now gates `active_ai_six_faction_town_coverage`. Current focused evidence passes with 16 active scenarios, 20/20 active enemy-town cases, 6/6 controller factions, 6/6 native town-ladder factions, and 140/140 seven-tier AI recruitment candidates; the full runtime-inclusive economy/town scorecard passes 22/22 checks. This is stronger live AI town-economy coverage for current authored scenarios, not final strategic AI quality, final route safety, encounter pacing, campaign balance approval, or broad enemy objective-play approval.

Completed slice on 2026-05-25: `economy-town-runtime-recruitment-market-coverage-scorecard-20260525-10184` strengthens the owner-directed economy/town goal by making the live recruitment runway prove the common-only town market can recover from post-development wood/ore pressure. Runtime town-development reports now count recruitment market purchases and weekly market-cap reset waits, and the runtime-inclusive scorecard gates `runtime_recruitment_market_coverage`. Current focused evidence passes with 2 authored runtime towns using market coverage, 14 common-market purchases, and 10 market-reset waits while preserving 15/15 live runtime town-development/recruitment cases; the full runtime-inclusive economy/town scorecard passes 21/21 checks. This is runtime evidence for current authored-town recruitment affordability after material pressure, not final market UX, final campaign economy balance, rare-resource market expansion, or broad strategic AI economy quality.

Completed slice on 2026-05-25: `economy-town-common-material-pressure-scorecard-20260525-10184` strengthens the owner-directed town-balance goal by making wood and ore create actual development pacing pressure, not only total-cost accounting. Authored town development income/start stock now creates at least one wood/ore bottleneck day in every authored town while preserving 30-turn completion, one-build-per-town-turn limits, rare-resource high-tier pressure, market-cap boundaries, and seven-tier unit ladders. The deterministic economy/town scorecard now passes 13/13 checks and the runtime-inclusive scorecard passes 20/20 checks, including 15/15 live runtime town-development/recruitment cases and active player recruitment through common-market coverage when material bottlenecks leave low post-development ore. This is current authored-town material-pressure balance evidence, not final exact-price approval, final scenario-wide economy tuning, route safety, campaign balance approval, or final market UX approval.

Completed slice on 2026-05-25: `economy-town-market-cap-scorecard-20260525-10184` strengthens the owner-directed economy/town balance goal by folding persisted weekly town-market caps into the runtime-inclusive economy/town scorecard. Current evidence passes 12/12 deterministic scorecard checks and 19/19 runtime-inclusive checks, including persisted common-resource buy/sell cap exhaustion, save/resume continuity, next-week reset, and rare-resource market exclusion through `runtime_market_cap_persistence_report_v1`. This closes a top-level gate gap where focused runtime coverage already proved common-resource buy/sell caps, save/resume persistence, next-week reset, and rare-resource market exclusion, but the goal scorecard could still pass without that market-cap evidence. This is a resource-exchange production-readiness gate for current town development and recruitment affordability, not final scenario-wide economy tuning, final market UI art, broad AI economy strategy, or campaign balance approval.

Completed slice on 2026-05-25: `economy-town-ai-seven-tier-recruitment-scorecard-20260525-10184` strengthens enemy town-development end-to-end evidence by making the active AI town runway prove that completed enemy towns expose their native town line's seven-tier recruitment ladder through the live AI governor recruitment surface. Current evidence passes 12/12 deterministic scorecard checks and 18/18 runtime-inclusive checks, including 20/20 active AI town runway cases with rare-resource spend, full-session execution, same-day build guards, delayed-source save/resume, 140/140 expected AI seven-tier recruitment candidates, and 20/20 affordable selected recruitment cases. The gate also covers the mixed-control Halo Spire edge where a Sunvault town controlled by Mireclaw must expose the native Sunvault ladder while still using the controller faction for AI treasury/recruitment priorities. This is an AI economy/town runtime gate for current authored scenario towns, not final strategic AI quality, army grouping balance, encounter difficulty, or campaign economy approval.

Completed slice on 2026-05-25: `economy-town-runtime-ui-surface-scorecard-20260525-10184` strengthens the production-readiness evidence for fully wired resources and end-to-end town development by folding the live TownShell resource/build and seven-tier recruitment UI surfaces into the runtime-inclusive economy/town scorecard. Current evidence passes 12/12 deterministic scorecard checks and 18/18 runtime-inclusive checks, including 6/6 TownShell resource/build UI cases proving all nine resources, rare-resource build bottlenecks, ready rare-resource builds, and common-only market boundaries, plus 42/42 TownShell seven-tier recruitment UI cases with tier labels, affordability, and loaded unit portraits. The scorecard now rejects regressions where backend town development still passes but player-facing town management no longer exposes the economy/town model. This is a player-facing runtime scorecard gate for current authored town management surfaces, not final town art, final layout approval, campaign economy approval, or final exact-price tuning.

Completed slice on 2026-05-25: `economy-town-active-runtime-rare-session-scorecard-20260525-10184` strengthens runtime active-scenario evidence by making the top-level economy/town scorecard reject player or AI runway cases that complete without rare-resource spend or without running inside full active scenario session state. Current evidence passes 12/12 deterministic scorecard checks and 16/16 runtime-inclusive checks, including 18/18 active player-town runway cases with rare spend and full-session execution and 20/20 active AI-town runway cases with rare spend and full-session execution. This closes a top-level evidence gap where the focused reports already exposed `rare_spend_case_count` and `full_session_case_count`, but the scorecard did not require those counts to match all active player/enemy town cases. This is a runtime scorecard gate for current authored scenario town development, not final route safety, encounter pacing, campaign economy approval, or broad strategic AI quality.

Completed slice on 2026-05-25: `economy-town-late-rare-bottleneck-scorecard-20260525-10184` strengthens high-tier rare-resource balance by proving rare resources create actual late-development waiting pressure, not only authored total spend. The deterministic town-development balance report now emits per-town late rare bottleneck days where an available high-tier or upgrade building is unaffordable because of the faction rare resource; the top-level economy/town scorecard gates that every authored town has at least one such day 18+ bottleneck. Oathmire Court's peatwax cost was raised from 2 to 3 so Reedbarrow Ferry also has a real late rare bottleneck while staying inside price-band limits and the 30-turn completion target. Current deterministic evidence passes 12/12 scorecard checks and runtime-inclusive evidence passes 16/16 checks. This is a deterministic balance gate for current authored town curves, not final exact-price approval, campaign pacing approval, generated-map reward ecology, or broad strategic AI economy quality.

Completed slice on 2026-05-25: `economy-town-unique-payoff-diversity-scorecard-20260525-10184` strengthens the owner-directed faction-town identity requirement by making unique non-unit town buildings prove payoff-domain diversity, not only unique ids and some runtime delta. The live unique-building payoff report now emits per-building/town/faction payoff domains and profile counts, gates at least four payoff domains per faction and authored town, and is wired into the optional economy/town goal scorecard. Current focused evidence covers 6 factions, 15 authored towns, 127/127 runtime payoff cases, and at least 5 payoff domains per authored town; the runtime-inclusive economy/town scorecard now passes 15/15 checks. This is a production-readiness gate for current authored faction-town feel, not final town art, final exact-price approval, final campaign economy balance, or broad strategic AI quality.

Completed slice on 2026-05-25: `economy-town-price-band-sanity-scorecard-20260525-10184` strengthens exact-price regression coverage by adding deterministic price-band sanity limits to the cost-curve report and top-level economy/town scorecard. The cost-curve report now rejects extreme authored total-cost regressions for `gold`, `wood`, `ore`, faction rare spend, target count, and rare-cost building count while preserving the existing 30-turn completion and runtime runway gates. Current evidence passes 11/11 deterministic scorecard checks and 14/14 runtime-inclusive checks. This is a price-band regression gate, not final human exact-price approval, final campaign pacing approval, or final town UI/art approval.

Completed slice on 2026-05-25: `economy-town-scorecard-harness-resource-coverage-20260525-10184` strengthens the top-level economy/town goal scorecard by folding in the full-resource balance/headless harness accounting contract. The scorecard now passes 10/10 deterministic checks and fails if shared economy pressure or economy delta evidence regresses to common-only `gold`, `wood`, and `ore` accounting. Validator coverage also requires the balance/headless rules and focused report assertions to preserve the nine-resource contract. This is top-level regression coverage for current authored economy/town resource wiring, not final campaign economy balance, generated-map reward ecology, strategic AI economy quality, exact price approval, or final town UI/art approval.

Completed slice on 2026-05-25: `economy-balance-harness-full-resource-coverage-20260525-10184` closes a common-only accounting gap in the automated balance harness. `BalanceRegressionReportRules` and `HeadlessSimulationHarnessRules` now use the full nine-resource live stockpile contract for economy pressure and economy delta evidence, including zero-valued rare-resource rows. The focused balance regression and headless simulation reports assert the full `gold`, `wood`, `ore`, `aetherglass`, `embergrain`, `peatwax`, `verdant_grafts`, `brass_scrip`, and `memory_salt` set, while the repo validator now rejects regressions in the rules and report assertions. This is harness/resource-accounting coverage, not final campaign economy balance, generated-map reward ecology, strategic AI economy quality, or final town UI/art approval.

Completed slice on 2026-05-25: `economy-generated-package-full-stockpile-session-20260525-10184` closes a remaining full-resource wiring gap in the native/generated package session path. Generated/native package sessions now seed the same full nine-resource live stockpile contract as authored scenarios, preserving the opening `gold`, `wood`, and `ore` values while carrying each rare resource at zero. The native package-session adoption smoke now gates both the direct bridge and active disk-loaded package startup paths with `bridge_resource_stockpile` and `active_resource_stockpile` evidence, and the repo validator rejects a return to common-only package session resources. This is generated-session resource wiring, not final generated-map economy balance, broad RMG parity, campaign economy balance, or final town UI/art approval.

Completed slice on 2026-05-25: `economy-town-rare-upgrade-chain-balance-20260525-10184` strengthens the owner-directed economy/town goal by making high-tier rare-resource upgrades explicit rather than relying only on rare-cost parallel late buildings. Six late faction unique/capstone buildings now carry `upgrade_from` chains behind their tier-7 signature development, the deterministic cost-curve report emits `rare_upgrade_buildings`, and the top-level scorecard gates `rare_upgrade_chain_pressure`. Current deterministic evidence passes 9/9 scorecard checks and 15/15 authored towns have at least one rare-cost high-tier upgrade chain while preserving 30-turn town completion, one-build-per-town-turn policy, common-resource-dominant costs, 4/8/10 high-tier rare pressure, and seven-tier faction ladders. This closes the explicit rare-upgrade-chain regression gap for current authored town content, not final campaign balance, encounter pacing, strategic AI quality, final UI/art approval, exact price approval, or future-template economy pacing.

Completed slice on 2026-05-25: `economy-town-high-tier-pacing-balance-20260524-10184` strengthens the owner-directed production-ready economy/town balance goal by turning high-tier unit timing into an explicit regression gate instead of only checking eventual 30-turn completion. The six faction signature unit-building ladders now use a stronger 4/8/10 faction-rare curve on tiers 5-7, the deterministic balance report records tier 5-7 signature build days, and the top-level scorecard now gates `high_tier_unit_build_pacing` with floors of day 4, day 12, and day 22. Current deterministic evidence passes 8/8 scorecard checks with 15 authored towns completing between day 24 and day 30 and tier 7 signature unit buildings arriving between day 22 and day 28. Runtime-inclusive evidence passes 11/11 checks, preserving 15/15 live runtime town-development and recruitment cases, 105/105 authored-town tier recruit cases, 18/18 active player-town runways with 126/126 recruited tiers, and 20/20 active AI-town runways with delayed-source save/resume and same-day build guards. This tightens current authored economy/town balance, not final campaign balance, encounter pacing, strategic AI quality, final UI/art approval, exact price approval, or future-template economy pacing.

Completed slice on 2026-05-24: `economy-town-runtime-scorecard-integration-20260524-10184` strengthens the owner-directed economy/town balance goal by extending the top-level scorecard with optional runtime evidence. `tests/economy_town_goal_scorecard_report.py --include-runtime` now runs the live Godot authored-town runtime balance report, active player-town scenario runway report, and active AI-town scenario runway report, then folds their summaries into the same objective scorecard. Current runtime-inclusive evidence passes 10/10 checks: 15/15 live runtime towns complete and recruit through all seven tiers, 105/105 authored-town tier recruit cases pass, 18/18 active player-town runways complete delayed-source replay/save-resume and recruit 126/126 tiers, and 20/20 active AI-town runways complete delayed-source replay/save-resume while preserving same-day build guards. The default repo validator keeps the fast deterministic scorecard path while validating that the runtime-inclusive mode and documentation exist. This is stronger runtime regression evidence for current authored economy/town readiness, not final campaign balance, encounter pacing, route safety, strategic AI quality, final town UI/art approval, final exact-price approval, or future-template economy pacing.

Completed slice on 2026-05-24: `economy-town-goal-scorecard-20260524-10184` strengthens the owner-directed economy/town balance goal by adding a single top-level regression scorecard over the explicit requirements. The new Python report `economy_town_goal_scorecard_report_v1` composes deterministic balance, cost-curve, faction asymmetry, and active-scenario resource matrix evidence, then gates seven requirements: all nine live resources wired with active-scenario source coverage, 15 authored towns fully developing within 30 turns, one build per town turn, common-resource-dominant costs, high-tier 2/4/6 rare-resource pressure, distinct six-faction town/unit/economy identity with unique non-unit buildings, and seven unit tiers with seven matching unit-unlocking town buildings. Current scorecard evidence passes 7/7 checks with completion days 23-28 and active-scenario coverage across 16 scenarios, 18 player-town cases, and 20 enemy-town cases. This is a top-level regression gate for the current authored economy/town model, not final campaign balance, encounter pacing, route safety, strategic AI quality, final town UI/art approval, final exact-price approval, or future-template economy pacing.

Completed slice on 2026-05-24: `economy-town-rare-pressure-balance-20260524-10184` strengthens the owner-directed economy/town balance goal by making faction rare resources a real late-development constraint instead of a token blocker. The six faction signature unit-building ladders now use a 2/4/6 rare-resource tier curve on tiers 5-7, selected late unique buildings carry additional faction-rare costs, and the deterministic balance/cost-curve gates require every authored town to spend at least 14 faction rare resources while ending completion with no more than 13 unspent faction rare. Current evidence still covers all 15 authored towns, preserves the 30-turn completion target and day-20 pacing floor, keeps development mostly shaped around gold, wood, and ore, keeps normal markets common-resource only, and proves active player and AI scenario runways still complete after the tighter rare costs. This is rare-pressure production-readiness evidence for current authored town development, not final campaign balance, encounter pacing, route safety, strategic AI quality, final town UI/art approval, or final exact-price approval.

Completed slice on 2026-05-24: `economy-active-scenario-resource-availability-matrix-20260524-10184` strengthens the owner-directed economy/town balance goal by adding an all-nine-resource active-scenario source matrix. The new deterministic report `active_scenario_resource_availability_matrix_v1` covers all 16 active authored scenarios, 18 player-town cases, and 20 enemy-town cases, proving that every live stockpile resource has active-scenario source observations, every common resource appears in every active scenario source ecology, every rare resource has persistent source coverage and active town-development use, and every active player/enemy town development case has persistent scenario-authored source coverage for all non-gold required resources. Normal markets remain common-resource only, with rare-resource buying disabled. This is resource-wiring and authored source-ecology evidence, not final campaign balance, encounter pacing, route safety, strategic AI quality, or final town UI/art approval.

Completed slice on 2026-05-24: `economy-active-scenario-ai-delayed-source-save-resume-20260524-10184` strengthens the owner-directed economy/town balance goal by applying the delayed-source save/resume gate to enemy town development as well as player town development. The AI active-scenario runway report now saves and restores during every delayed-source replay after target-faction source acquisition has mutated scenario resource nodes and after the first rare-resource building has been constructed through `EnemyTurnRules.run_enemy_town_economy_turn`. The restored session must preserve target enemy treasury, target town buildings, `last_build_day`, recruits, applied source-node claim/control state, overworld resume target, and `SAVE_VERSION`; it must also keep the target-town same-day AI build guard active before continuing the 30-turn runway. Current focused evidence covers all 16 active authored scenarios and 20 enemy-town cases, completes 20/20 delayed-source AI save/resume checkpoints, and still completes 20/20 delayed-source AI replays within the 30-turn target. This is stronger enemy town-economy persistence evidence, not final strategic AI quality, route safety, encounter pacing, campaign balance approval, or final town UI/art.

Completed slice on 2026-05-24: `economy-active-scenario-delayed-source-save-resume-20260524-10184` strengthens the owner-directed economy/town balance goal by combining two previously separate gates: active-scenario delayed source acquisition and town-development save/resume continuity. The player active-scenario runway report now saves and restores during every delayed-source replay after route-derived source acquisition has mutated scenario resource nodes and after the first rare-resource building has been constructed. The restored session must preserve active town state, resources, built buildings, `last_build_day`, recruits, applied source-node claim/control state, town resume target, and `SAVE_VERSION`; it must also keep the same-day build guard active before continuing the 30-turn runway. Current focused evidence covers all 16 active authored scenarios and 18 player-town cases, completes 18/18 delayed-source save/resume checkpoints, and still completes 18/18 delayed-source replays within the 30-turn target. This is stronger active-scenario economy persistence evidence, not final scenario route balance, encounter pacing, campaign balance approval, or final town UI/art.

Completed slice on 2026-05-24: `economy-town-build-per-town-turn-limit-20260524-10184` strengthens the owner-directed economy/town balance goal by proving the construction limit is per town, not a hidden global player build lock. The new focused live Godot report `town_build_per_town_turn_limit_report_v1` creates a two-town runtime session, builds once in Riverwatch, proves Riverwatch rejects a second same-day build and exposes no more build actions that day, then selects Duskfen on the same session day and proves Duskfen can still build. It also proves Duskfen rejects its own second same-day build and both towns expose build actions again on the next day. This is construction-rule readiness evidence for the requested one-build-per-town-per-turn rule, not final town price tuning, campaign pacing approval, or town UI art approval.

Completed slice on 2026-05-24: `economy-active-scenario-ai-delayed-source-runway-20260524-10184` strengthens the owner-directed economy/town balance goal by applying the delayed-source runway proof to enemy town development as well as player town development. The AI full-session report still proves target-faction construction after authored economy sources are secured, but it now also runs `active_scenario_ai_town_delayed_source_replay_v1`: a fresh full scenario replay where target-faction economy source ownership is delayed by live route-derived acquisition days, using 12 route steps per day plus a one-day guarded-source delay before source claims/control are applied. Current evidence covers all 16 active authored scenarios and 20 enemy-town cases, completes 20/20 delayed-source replay cases, keeps delayed AI completion inside the 30-turn target, and currently finishes between days 20 and 23 with at least seven days of remaining margin. Ninefold Confluence now gives Bellwake Harbor local authored wood and ore reserves on its reachable harbor-front economy tile so Veilmourn AI development has common-plus-rare runway access. This is a stronger enemy town-economy pacing gate, not final strategic AI objective quality, manual campaign balance, or encounter difficulty approval.

Completed slice on 2026-05-24: `economy-active-scenario-delayed-source-runway-20260524-10184` strengthens the owner-directed economy/town balance goal by removing a major caveat from the active-scenario player-town runway evidence. The existing full-session report still proves development after authored economy sources are secured, but it now also runs `active_scenario_town_delayed_source_replay_v1`: a fresh full scenario replay where economy source ownership is delayed by live route-derived acquisition days, using 12 route steps per day plus a one-day guarded-source delay before source claims/control are applied. Current evidence covers all 16 active authored scenarios and 18 player-town cases, completes 18/18 delayed-source replay cases, keeps delayed completion inside the 30-turn target, and currently finishes between days 21 and 25 with at least five days of remaining margin. This is a stronger scenario-economy pacing gate, not final manual campaign balance, encounter difficulty approval, or full strategic AI quality.

Completed slice on 2026-05-24: `economy-town-development-pacing-parity-20260524-10184` strengthens the owner-directed economy/town balance goal from simple 30-turn completion to production-shaped town-development pacing. Thornwake, Brasshollow, and Veilmourn authored towns no longer complete as shallow 12-build arcs: their late non-unit town chains now bring every authored town to at least 20 buildable development targets and at least 12 non-unit targets. The deterministic balance report now gates a day-20 production pacing floor and a 30-turn cap, currently completing all 15 authored towns between days 23 and 28. The live Godot runtime report gates the same breadth and day-20 floor through live build rules, same-day build rejection, rare-resource spend, and post-development seven-tier recruitment, currently completing all 15 authored towns between days 20 and 23 under the secured-income fixture. The unique-building payoff report now covers 127 runtime payoff cases and at least 56 faction-unique non-unit buildings. This is a town-development pacing and faction-breadth readiness increment, not final campaign balance, encounter pacing, strategic AI quality, final town UI art, or final economy tuning approval.

Completed slice on 2026-05-24: `economy-town-recruitment-ui-surface-20260524-10184` closes a player-facing recruitment surface gap in the owner-directed economy/town balance goal. Town recruit buttons now include visible tier labels, recruitment reserve text names unlocked and locked units by tier, and the focused Godot TownShell report instantiates all six faction seed towns after seven-tier development to prove 42/42 recruit UI tier cases. Current evidence covers six faction seed towns, 42 live recruitment actions, 42 visible tier-labeled recruit buttons/tooltips, 42 loaded unit portraits, direct affordability for each waiting tier, and TownShell recruitment tooltip text that exposes Tier 1 through Tier 7. This is town recruitment UI readiness evidence for the existing economy and unit-ladder work, not final town art, final UI layout approval, exact price tuning, scenario route safety, or campaign balance approval.

Completed slice on 2026-05-24: `economy-active-scenario-seven-tier-recruitment-runway-20260524-10184` closes the active-scenario post-development recruitment proof gap in the owner-directed economy/town balance goal. The focused Godot active-scenario runway report now keeps completed player towns inside their full authored scenario sessions through the remaining 30-turn economy window, applies recovery relief and weekly musters, validates the owning faction's seven-tier recruit actions, and recruits one unit from every tier through `OverworldRules.recruit_in_active_town`. Current evidence covers 16 active scenarios and 18 player-town cases, completes 18/18 development cases, completes 18/18 recruitment end-to-end cases, and recruits 126/126 tier cases after full development. Highwater bridgehead starts in `ironbridge-stand` and `mireford-skirmish` also gained an authored ore reserve so their turn-30 post-development recruitment runway is supported by scenario content instead of test-only resource injection. This is active-scenario economy and recruitment runway readiness evidence, not final scenario route safety, encounter pacing, strategic AI quality, campaign balance approval, or final town UI/art.

Completed slice on 2026-05-24: `economy-town-development-seven-tier-recruitment-end-to-end-20260524-10184` closes the post-development recruitment proof gap in the owner-directed economy/town balance goal. The live Godot town-development runtime report now requires each fully developed authored town to expose the owning faction's seven-tier unit ladder through live recruit actions, verifies tier labels/metadata, confirms recruits are available and directly affordable after the 30-turn development run, and recruits one unit from every tier through `OverworldRules.recruit_in_active_town`. Current evidence covers 15 authored towns, 15/15 successful end-to-end recruitment town cases, and 105/105 successful tier recruitment cases after full development. This is end-to-end town economy and recruitment readiness evidence, not final combat balance, scenario-wide difficulty approval, final strategic AI quality, or final town UI/art.

Completed slice on 2026-05-24: `economy-active-scenario-ai-full-session-development-runway-20260524-10184` strengthens the active-scenario enemy-town development runway gate for the owner-directed economy/town balance goal. The focused Godot report now keeps AI town construction inside full active scenario sessions with authored map, resource nodes, encounters, and enemy state data preserved instead of rebuilding a stripped 3x3 runway. Current evidence covers 16 active scenarios and 20 enemy-town cases, completes 20/20 within the 30-turn target, observes rare-resource spend in every case, proves all 20 same-day second AI builds are blocked, and proves all 20 cases used full scenario sessions. The target faction receives secured scenario-authored economy sources in its live treasury, construction runs through `EnemyTurnRules.run_enemy_town_economy_turn`, and the report continues proving full treasury tracking and governor report coverage. This is AI town economy runway readiness, not final strategic AI quality, objective routing, route safety, encounter pacing, guard pressure, campaign balance approval, or final town UI/art.

Completed slice on 2026-05-24: `economy-active-scenario-full-session-development-runway-20260524-10184` strengthens the active-scenario player-town development runway gate for the owner-directed economy/town balance goal. The focused Godot report now keeps construction inside full active scenario sessions with authored map, resource nodes, encounters, and enemy state data preserved instead of rebuilding a stripped 3x3 runway. Current evidence covers 16 active scenarios and 18 player-town cases, completes 18/18 within the 30-turn target, observes rare-resource spend in every case, and proves all 18 cases used full scenario sessions. Day advancement uses a focused active-scenario economy-day step over live town income and controlled resource-site income, avoiding the full strategic enemy turn loop while still proving live construction, resource spending, rare-resource gating, common-only market boundaries, and one-build-per-town-per-turn rejection. This is active-scenario economy runway readiness, not final strategic AI quality, route safety, encounter pacing, guard pressure, campaign balance approval, or final town UI/art.

Completed slice on 2026-05-24: `economy-town-unique-building-runtime-payoff-20260524-10184` closes the six-faction unique non-unit town development payoff gap in the owner-directed economy/town balance goal. Embercourt, Mireclaw, and Sunvault now have five faction-specific non-unit economy/support/magic/defense/civic buildings each, while Thornwake, Brasshollow, and Veilmourn existing parity buildings now carry explicit faction ownership metadata. The focused Godot report covers six factions, 15 authored towns, 30 faction-unique non-unit buildings, 75 runtime payoff cases, and proves every authored faction town exposes at least five unique non-unit buildings, every faction has at least one rare-cost unique building using its faction rare, and every unique building builds through live `TownRules`/`OverworldRules` surfaces while changing income, readiness, pressure, reinforcement, spell, or market state. This is faction town-development payoff readiness, not final scenario balance, final town UI/art, broad strategic AI quality, campaign pacing approval, or final economy tuning.

Completed slice on 2026-05-24: `economy-active-scenario-ai-town-start-economy-20260524-10184` closes the natural active-scenario first-week enemy-town economy evidence gap in the owner-directed economy/town balance goal. Enemy town starts now seed faction treasuries from authored town `development_balance.starting_resources` during `ScenarioFactory.create_session`, and `EnemyTurnRules.run_enemy_town_economy_turn` exposes a focused live AI income/construction path without strategic pressure or raid routing. The focused Godot report boots all 16 active authored scenarios and 20 enemy-town cases, uses natural enemy town/treasury/resource-node state without injected source capture, and proves every enemy-town start completes at least three first-week AI builds, spends wood or ore through live construction, observes the one-build-per-town-per-turn guard, and normalizes all nine live treasury ids. This is first-week AI town economy readiness evidence, not final strategic AI quality, route safety, encounter pacing, guard pressure, campaign balance approval, final town UI/art, or scenario difficulty approval.

Completed slice on 2026-05-24: `economy-active-scenario-town-start-economy-20260524-10184` closes the natural active-scenario first-week town economy evidence gap in the owner-directed economy/town balance goal. The focused live Godot report boots all 16 active authored scenarios and 18 player-town starts, uses the natural starting town/stockpile/resource-node state without injected source capture, and drives first-week construction through live `OverworldRules` and `TownRules` surfaces. Current evidence proves every player-town start completes at least three first-week builds, spends wood or ore through live construction, observes the one-build-per-day guard, blocks same-day follow-up build actions, and normalizes all nine live stockpile ids. This is first-week town economy readiness evidence, not final campaign balance, route safety, encounter pacing, strategic AI quality, final town UI/art, or scenario difficulty approval.

Completed slice on 2026-05-24: `economy-town-development-save-resume-20260524-10184` closes the authored town-development save/resume continuity gap in the owner-directed economy/town balance goal. The focused live Godot report drives all 15 authored towns through live construction until the first rare-resource build, saves immediately after that checkpoint, restores through `SaveService`, proves built buildings/resources/recruits/active-town flags/last-build-day state survive, keeps manual summaries resuming to town, preserves the one-build-per-day guard after restore, and then completes each town within the 30-turn target. This is save/resume continuity evidence for town development, not final price tuning, campaign balance, route/encounter pacing, final town UI/art, or scenario difficulty approval.

Completed slice on 2026-05-24: `economy-town-development-cost-curve-20260524-10184` closes the authored town-development cost-shape regression gap in the owner-directed economy/town balance goal. The deterministic cost-curve report parses all 15 authored towns and all six faction signature ladders, proving every development target costs gold, every town spends wood and ore, gold remains the dominant numeric cost, each town keeps at least a 2:1 common-only to rare-cost building ratio, rare costs use only the town faction rare, and rare-cost buildings are gated behind tier 5+ signature development or a tier 5+ prerequisite chain. This is cost-curve production-readiness evidence, not final campaign balance, exact price tuning, route safety, or final town UI/art.

Completed slice on 2026-05-24: `economy-active-scenario-town-economy-source-route-20260524-10184` closes the active-scenario town economy route-access gap in the owner-directed economy/town balance goal. The focused report boots all 16 active authored scenarios through live `ScenarioFactory` sessions and checks all 18 player-town cases for reachable wood, ore, and faction-rare source routes using live overworld blocker, interaction-destination, and blocked-corner movement rules. Current evidence covers 54/54 reachable route cases, keeps guarded sources as combat-pressure metadata, and corrects Lockmarsh Surge so Riverwatch and Murkward have reachable common-resource routes. This is route-access evidence before the existing 30-turn runway assumptions, not final encounter pacing, guard balance, or campaign balance approval.

Completed slice on 2026-05-24: `economy-town-resource-ui-surface-20260524-10184` closes the live TownShell resource-ledger and rare-cost readiness surface gap in the owner-directed economy/town balance goal. TownShell keeps its compact visible stockpile line while exposing a full nine-resource ledger tooltip and validation snapshot, and the focused report boots six faction seed towns through live TownShell, stages an authored high-tier rare-cost building, proves missing rare resources block construction without normal-market coverage, then stocks the rare resource and proves the same action becomes directly affordable. This is TownShell economy-surface evidence, not final town UI art, scenario-wide pacing, or final campaign balance approval.

Completed slice on 2026-05-24: `economy-six-faction-town-development-breadth-parity-20260524-10184` closes the six-faction town-development breadth gap in the owner-directed economy/town balance goal. Thornwake, Brasshollow, and Veilmourn towns no longer count as fully developed after only seven unit-ladder buildings; each now has faction-flavored non-unit economy/support/magic/civic buildings in addition to the seven-tier ladder. The deterministic and live Godot town-development reports now require every authored town to expose at least 12 buildable development targets and at least 5 non-unit development targets while still completing within the 30-turn cap, preserving one-build-per-turn enforcement, rare-resource high-tier spend, and common-only normal markets. This is town-development breadth and balance-shape evidence, not final campaign balance, final town UI/art, or full strategic AI quality.

Completed slice on 2026-05-24: `economy-active-scenario-ai-town-development-runway-20260524-10184` closes the active-scenario enemy-town development runway gap in the owner-directed economy/town-development goal. Enemy treasuries now preserve the full nine-resource live stockpile, enemy town construction honors the same one-build-per-town-per-turn guard used by player construction, and town-market affordability no longer treats common-market coverage as a substitute for restricted rare-resource deficits. Rare-resource front sites now provide gold pacing plus rare income, active enemy towns have matching scenario-authored rare-resource access, and the focused Godot report boots all 16 active authored scenarios, secures scenario-authored economy sources, and drives live `EnemyTurnRules.run_enemy_turn` construction for all 20 active enemy-town cases. Current evidence completes 20/20 enemy-town cases within the 30-turn target, observes rare-resource spending in every case, and proves same-day second AI builds are rejected. This is active-scenario AI town-development runway evidence, not final strategic AI quality, route safety, encounter pacing, guard pressure, campaign balance approval, or final town UI/art.

Completed slice on 2026-05-24: `economy-active-scenario-development-runway-20260524-10184` closes the active-scenario common-resource runway gap in the owner-directed economy/town-development goal. The existing wood wagon and ore crate source sites now behave as persistent capturable common-resource sources (`wood` and `ore` income), their linked map objects use persistent-control metadata, and the focused Godot report boots all 16 active authored scenarios, secures only scenario-authored economy sources, and drives live `TownRules`/`OverworldRules` construction for all 18 active player-town cases. Current evidence completes 18/18 player-town cases within the 30-turn target, observes rare-resource spending in every case, proves same-day second builds are rejected, and keeps normal market surfaces common-resource only. This is active-scenario development-runway evidence, not final route safety, encounter pacing, guard pressure, campaign balance approval, or final town UI/art.

Completed slice on 2026-05-24: `economy-town-unit-tier-runtime-surface-20260524-10184` closes the live unit-tier action-surface gap in the owner-directed economy/town-development goal. `TownRules.get_build_actions` now exposes `unlocked_unit_id`, `unit_tier`, and `tier_label` for unit-unlocking buildings, `TownRules.get_recruit_actions` exposes `unit_tier` and `tier_label` for recruit orders, and the focused Godot report validates six faction signature ladders across 42 live tier cases. The gate covers 39 live build-action cases, 3 seed-town starting signature cases through recruit actions, and 18 high-tier rare-resource cases. The slice also corrects Mireclaw's signature unit-building order, prerequisites, and rare-resource cost placement so tiers 1-4 stay common-resource only and tiers 5-7 cost `peatwax`. This is runtime town-development surface and content-order evidence, not final scenario-wide economy tuning, final town UI layout/art, campaign balance approval, or broad AI economy planning.

Completed slice on 2026-05-24: `economy-active-scenario-rare-access-20260524-10184` closes the active authored-scenario rare-resource access gap in the owner-directed economy/town-development goal. Every active campaign/skirmish scenario with a player-owned town now contains at least one matching rare-resource source for that town's `development_balance.rare_resource_id`, and the focused Godot report boots all 16 active scenarios, claims 18 player-town rare-source cases through `OverworldRules.collect_active_resource`, verifies player control through `OverworldRules.controlled_resource_site_income`, and advances a day through `OverworldRules.end_turn` to prove next-day rare income. Rare resources remain authored-source driven and normal town markets remain common-resource only. This is active-scenario economy access evidence, not final scenario-wide economy tuning, route safety, encounter pacing, campaign balance, or final town UI/art.
