...
- Latest native RMG implementation update: `h3maped_rmg_core` now follows the recovered `0x4ac552` order through source-record replay, route/free-cell `0x4a8260/0x4a4c8e`, and the recovered post-`0x4a4c8e` `0x4a8c15 -> 0x49a962` cleanup scan. It then fails closed at the first unported relation-vector callee, `0x4a4913`, before bridge `0x4a5767`, `0x4a4fc5`, `0x4a79a3`, `0x4a9d6a`, relation scan, reward/guard, connection/decorative/road-river, or final writeout can run. The current blocker is `0x4a8c15_relation_vector_loop_0x4a4913_unported_after_post_0x4a4c8e_cleanup_before_0x4a5767`; the next implementation target is source-backed replay of `0x4a4913` in the active shared workflow. This is not parity and not final map output.
