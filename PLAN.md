...
- Current strategic AI implementation slice: `strategic-ai-multi-origin-task-planner-10184` makes coordinated task-board planning evaluate every owned enemy town and configured spawn origin, so multi-town/generated-map empires can plan from local fronts instead of one global origin. Emergency garrison safety and true commander rebuild still outrank planned prep; this is a live behavior slice, not a broad report-only gate or a full production-readiness claim.
- Current strategic AI follow-up after this slice: broaden the generated-map runner from focused smoke into the full 100-seed eight-week matrix, then continue deeper generated-map army/economy timing, retreat/personality, and live-client pacing review. Guarded object routing, encounter-arrival risk, hero-intercept risk, town-assault risk, coordinated pre-deployment task planning, task-board recruitment prep, and focused long-run smoke are not a full strategic AI release-readiness claim.
