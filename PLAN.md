...
- Normal 36x36 one-level land `native_catalog_auto` generation now returns `h3maped_small_clean_restart_generation_not_ready`; medium/large/XL and other out-of-scope catalog-auto generation returns `archived_legacy_native_rmg_disabled` unless `allow_archived_legacy_native_rmg` is explicitly passed for local debug/evidence.
...
- The boundary exposes an executable phase ledger and keeps later map-materialization phases pending: terrain fill/repaint schedule `0x4a3f27/0x4bcff5/0x4bd099`, one-level TerrainPlacement art/index/flip normalization, owner/repaint cell grids, town/castle field consumption, direct candidate scanning, direct validity prechecking, mine/reward source field ledgers, the `0x4a9911` mine template/record/guard handoff ledger, and the `0x4a9641` mine candidate scan/selection/body-cell marking are ported for inspection; runtime map adoption, generalized production object-cell stamping, reward/monster placement, guarding, and final cell/object passes remain pending.
- `tests/native_rmg_small_h3maped_port_boundary_report.tscn` passed with `status: h3maped_small_clean_restart_template_selection_ready`, `archive_status: previous_native_catalog_auto_generator_archived_debug_only`, `accepted_template_count: 13`, `selected_template: h3maped_template_018`, `assignment_status: 0x4ac62a_player_slot_assignment_ported_inspection_only`, `runtime_zone_build_status: 0x4a218c_runtime_zone_records_and_49b53d_terrain_ported_inspection_only`, `object_category_placement_status: 0x4a8d2c_0x4a93a2_0x49aa93_town_49a09c_and_writeout_ledger_ported_inspection_only`, `guard_reward_monster_placement_status: 0x4a9d6a_0x4a9911_0x4a9641_0x4aab7e_mine_constraint_scan_ported_package_adoption_pending`, `minimum_settlement_call_count: 4`, `direct_candidate_scan_call_count: 4`, `direct_validity_precheck_call_count: 3`, `direct_validity_precheck_eligible_total: 451`, `direct_owner_minus_one_fail_count: 1`, `object_metadata_table_status: 0x57c648_runtime_object_metadata_table_bound_to_text_sources_inspection_only`, `objects_table_declared_row_count: 1326`, `town_template_row_count: 9`, `random_town_template_row_count: 1`, `town_mask_model_status: objects_txt_text_mask_offsets_ported_for_0x49a6f9_inspection`, `town_passability_body_cell_count: 13`, `town_action_cell_count: 1`, `town_footprint_mask_eligible_total: 97`, `town_footprint_49a09c_status: 0x49a09c_town_footprint_pass_ported_for_current_generated_cell_grid`, `town_footprint_49a09c_pass_total: 97`, `town_footprint_49a09c_rejected_bounds_count: 135`, `town_footprint_49a09c_rejected_bit22_count: 1`, `town_footprint_49a09c_rejected_bit25_count: 22`, `town_footprint_49a09c_rejected_owner_count: 196`, `town_footprint_49a09c_rejected_terrain9_count: 0`, `town_footprint_49a09c_rejected_water_class_count: 0`, `project_town_writeout_status: 0x4a93a2_object_record_writeout_ledger_ported_project_adoption_pending`, `project_town_writeout_record_count: 3`, `project_town_writeout_generator_f44_next: 3`, `project_town_writeout_record_size_bytes: 40`, `project_town_writeout_constructor_address: 0x49ba89`, `project_town_writeout_town_vtable_address: 0x540a9c`, `object_cell_materialization_status: 0x4a93a2_direct_town_record_random_tie_and_bit22_body_marking_ported_inspection_only`, `object_record_stamped_count: 3`, `object_occupied_cell_mark_count: 39`, `object_record_random_tie_selection_count: 1`, `object_record_random_tie_rng_call_count: 1`, `minimum_mine_count: 18`, `mine_density_weight: 18`, `mine_template_row_count: 46`, `mine_minimum_helper_call_count: 18`, `mine_placement_constraint_scan_call_count > 0`, `mine_placement_constraint_selected_count > 0`, `treasure_band_density_weight: 96`, `terrain_selection_status: 0x49b53d_runtime_terrain_selector_ported_inspection_only`, `early_link_placement_status: 0x4a1f3b_endpoint_control_flow_ported_inspection_only`, `coordinate_placement_status: 0x4a218c_interleaved_runtime_and_coordinate_replay_inspection_only`, `coordinate_rng_order_status: 0x4a218c_interleaved_replay_ported_inspection_only`, `zone_footprint_placement_status: 0x4a3a03_0x4a3710_footprint_helpers_ported_terrain_visual_ready`, `boundary_traversal_status: 0x4a2777_real_source_node_cycle_traversal_ported_boundary_materialized`, `boundary_unique_cell_count: 221`, `span_fill_status: 0x4a325d_real_0x4a2777_boundary_span_fill_executed_terrain_schedule_ready`, `span_fill_unique_filled_cell_count: 890`, `span_fill_remaining_unassigned_cell_count: 185`, `adjacency_finalizer_status: 0x4a3710_small_land_no_appended_zone_finalizer_ported`, `terrain_fill_repaint_status: 0x4a3f27_terrain_fill_repaint_schedule_ported_inspection_only`, `terrain_repaint_call_count: 1111`, `terrain_art_index_flip_status: TerrainPlacement_visual_selection_ported_inspection_only`, `terrain_visual_transition_cell_count: 413`, `terrain_visual_fallback_count: 20`, `generation_status: h3maped_small_clean_restart_generation_not_ready`, and `out_of_scope_generation_status: archived_legacy_native_rmg_disabled`. The footprint counts changed because the clean order now consumes the two `0x49b53d` terrain RNG calls before `0x4a3a03`.
