...
- Latest native RMG implementation update: `h3maped_rmg_core` now follows the recovered source order through source-record replay, route/free-cell `0x4a8260/0x4a4c8e`, post-`0x4a4c8e` cleanup, relation normalization/scan/high-owner propagation, one-level-land `0x4a4fc5`, mine/resource materialization, and reward/guard materialization before connection-tail replay. The reward/guard direct stream no longer runs the `0x4ad7f7` projection-order fallback from inside failed direct `0x4aa9b7` scans, and positive `0x4aa354` attach values now use relation-fed `0x4a5c07` monster allocation instead of reusing the selected reward descriptor. No-Godot Small seed 10, Small seed 58, and Medium seed 10 still fail closed at `reward_guard_materialization_0x4aab7e_zero_successful_0x4aa9b7_commits_before_connection_tail` before `0x4a79a3`, D-014 endpoint prep, decorative dispatch, road/river, or final writeout run. Current observed attempts are Small seed 10 = 144, Small seed 58 = 90, and Medium seed 10 = 126, with zero successful `0x4aa9b7` commits and `last_projection_order_invoked_0x4ad7f7=0` in all three snapshots. The direct-stream blocker is now isolated to `0x4aa603` feasibility against current generated-cell bit26/owner state: Small seed 10 and Small seed 58 first reject at `0x4aa603_0x49a6f9_footprint_existing_bit26_rejected`, while Medium seed 10 first rejects at `0x4aa603_0x49a6f9_footprint_owner_byte_rejected`. This is still not parity and not final map output. The required next implementation slice is direct `0x4aa603/0x49a6f9` generated-cell state parity for reward/guard commits in recovered source order. Downstream generic source-order replay, connection/decorative/road-river, and final writeout remain blocked behind successful reward/guard commits.
