...
- Latest native RMG implementation update: `h3maped_rmg_core` now separates TerrainPlacement generated-cell byte2 semantics from reward/guard source-owner semantics. Relation-owner boundary handoffs keep the recovered source owner in the boundary payload word, but write the relation-owner vector slot into generated-cell `+0x20` byte2; `0x4a2105/0x49b66d` indexes relation owners directly from that byte; and `0x4a3f27` compares generated-cell byte2 to the current relation-owner loop index. Reward/guard/source-owner helpers were not widened by this slice. Focused no-Godot Medium seed-10 setup-0 still fails closed at `native_final_tile_stream_mismatch_against_same_run_0x49b2b6_payload`: tile bytes remain 36288 vs 36288 with first mismatch offset 1 (`native=55`, `h3maped=54`), and generated-object payload remains short/order-diverged at 8116 native bytes vs 17057 H3MapEd bytes. This is source-backed TerrainPlacement behavior progress, not final-payload parity or runtime map-output authorization.
