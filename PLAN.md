...
- Latest native RMG implementation update: `h3maped_rmg_core` now gates reward/guard materialization on the recovered projection-object caller sequence `0x540b14 -> 0x49c0a6 -> 0x4ad947 -> 0x4ad7f7` instead of invoking `0x4aa354`, `0x4aa1db`, or `0x4a9f1c` with null/source-less inputs. The no-Godot CLI now blocks at `0x49c0a6_projection_object_0x540b14_live_input_pending_before_0x4ad947`, which means the next implementation target is the source-backed selected-create/constructor feed for the `0x540b14` projection object, then the `0x4ad947` global table/coordinate inputs, wrapper/member handoff, remaining reward/guard selected descriptor flow, connection/road/river phases, and final tile/object/header writeout. This is not parity and not final map output.
