...
- Pending before runtime generation: `0x4a17f5` coordinate candidates, `0x4a1701` spacing validation, `0x49b53d` terrain choice, `0x4a3a03` zone footprints, owned towns, roads, blockers, guards, mines, rewards, and final writeout.
