...
- The recovered guard-value scaler `0x4a65a5` is now ported for the small reset boundary: raw connection `Value` guards are scaled through the recovered threshold/slope tables using global monster strength, and mine guard bases flow through the `0x4a960a` effective local/global strength rule before `0x4a65a5`. Seed 1 reports connection scaled guard total 16000 and minimum-mine scaled guard total 59500; actual guard object placement through `0x4a5e03` remains pending.
