...
- Pending before runtime generation: wire real h3maped boundary cells into the ported `0x4a325d` span-fill primitive, then terrain/cell writeout, owned towns, roads, blockers, guards, mines, rewards, and final writeout.
