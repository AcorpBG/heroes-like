...
- Current implementation slice: `strategic-ai-encounter-objective-task-board-10184`, completed to make objective-front encounter targets first-class durable strategic AI tasks with saved-task reuse, lifecycle cleanup, and no save-version migration.
