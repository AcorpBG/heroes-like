...
- The partial package adoption deliberately sets `native_runtime_authoritative: false`, `full_parity_claim: false`, and `no_authored_writeback: true` while preserving explicit `h3maped_0x4ab52a_0x4ab37f_road_adapter_boundary_recovered_toolkit_pending` and `h3maped_0x4a79a3_link_guard_payload_ported_guard_object_materialization_pending` statuses. The road boundary records `generator+0x14b0` coordinate-vector sources from `0x4a959b` direct town append and `0x4a6bb4` generic object append through `0x4ae1fd`, `0x4ab52a` coordinate-vector iteration, the ported `0x4aae2f` generated-cell path-state reset ledger, pending `0x4aae7b` path propagation, `0x4ab37f` adapter construction, and the still-unported `0x4b4243` road toolkit; it emits no synthetic road segments.
