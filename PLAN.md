...
- Current strategic AI follow-up: broaden the new generated-map runner from focused smoke into the full 100-seed eight-week matrix and coordinated multi-hero planning. Guarded object routing, encounter-arrival risk, hero-intercept risk, town-assault risk, and focused long-run smoke are not a full strategic AI release-readiness claim.
