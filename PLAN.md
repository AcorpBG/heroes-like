...
- Pending before runtime generation: terrain/cell writeout from the real `0x4a325d` zone-word buffer, owned towns, roads, blockers, guards, mines, rewards, and final writeout.
