...
- Current native-vs-H3MapEd finding: Medium seed-10 input/template identity is now corrected for the controlled 4-player land reference. Native manifest-derived export preserves `human_count=4`, `player_count=4`, `computer_count=0` and selects H3MapEd template 015 / `2SM4d(2)` from a 23-entry accepted vector, matching the H3MapEd selector trace (`71 % 23 = 2`). The next blocker is earlier than objects, roads, rivers, or final writeout: the valid H3MapEd `0x4a4c8e` generated-cell checkpoint for that setup still mismatches native at `pre_0x4a4c8e` across `word_0x20`, `word_0x24`, and `word_0x28` for all 5,184 cells. The named parity target is coordinate replay / zone footprint / TerrainPlacement live-feedback private-state parity around `0x4a218c`, `0x4a1f3b`, `0x4a3a03`, `0x4a2777`, `0x4a325d`, `0x4a3710`, `0x4bb74b`, `0x4bc5f0`, and `0x49acf6`.
