...
- Latest strategic AI completed slice: `strategic-ai-resource-front-support-10184` makes contested resource-front commanders use proactive strength checks and active-front support, so fragile resource attackers regroup or stage around support instead of solo-claiming high-value fronts. Emergency garrison safety and true commander rebuild still outrank resource pressure; this is a live behavior slice, not a broad report-only gate or a full production-readiness claim.
- Current strategic AI follow-up: broaden the generated-map runner from focused smoke into the full 100-seed eight-week matrix, then continue deeper generated-map army/economy timing, retreat/personality, and live-client pacing review. Guarded object routing, encounter-arrival risk, hero-intercept risk, town-assault risk, coordinated pre-deployment task planning, task-board recruitment prep, multi-origin planning, resource-front support, and focused long-run smoke are not a full strategic AI release-readiness claim.
