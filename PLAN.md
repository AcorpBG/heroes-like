...
- Latest native RMG implementation update: `h3maped_rmg_core` now follows the recovered `0x4ac552` order through source-record replay and route/free-cell `0x4a8260/0x4a4c8e`, then fails closed at the unported remainder of the recovered `0x4a8c15` materialization bridge (`0x4a4913 -> 0x4a5767 -> 0x4a4fc5 -> 0x4a79a3`) before `0x4a9d6a`, relation scan, reward/guard, connection/decorative/road-river, or final writeout can run. The current blocker is `0x4a8c15_materialization_bridge_0x4a4913_0x4a5767_0x4a4fc5_0x4a79a3_unported_after_0x4a8260_0x4a4c8e_before_0x4a9d6a`; the next implementation target is source-backed replay of that bridge in the active shared workflow. This is not parity and not final map output.
