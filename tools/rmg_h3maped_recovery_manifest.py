...
FUNCTIONS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "runtime_trace": "Constructor trace records 2 sampled 0x49cac2 entries, each immediately paired with 0x49c0d3 returning to 0x49caf0.",
    ...
    },
    {
        ...
        "ghidra_dump": "Instruction recovery shows this is the reward/guard attachment attempt wrapper around 0x49cf34 and a temporary consumer/mutator of +0xc8, +0x1104, and +0xf5c. Ghidra dump .artifacts/rmg_recovery/ghidra_4ad947_4adb72_projection_driver_dump proves direct vtable caller 0x49c019 and downstream 0x4ad7f7. Constructor summary .artifacts/rmg_recovery/direct_generation_49cac2_projection_constructor_hit_trace/49c_projection_constructor_summary.json proves sampled constructors pair with 0x49c0d3; separate wrapper no-hit ledger .artifacts/rmg_recovery/direct_generation_49c019_49c0a6_projection_driver_hit_trace/winedbg_recovery_trace_ledger.json generated a 36x36 map with 0 hits at 0x49c019/0x49c0a6/0x4adb72/0x4ad947/0x4ad7f7/0x4adef7. Runtime ordered replay for 0x4adb72 remains pending.",
    },
    {
        "address": "0x499f60",
