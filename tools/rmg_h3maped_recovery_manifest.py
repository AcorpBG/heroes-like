...
FUNCTIONS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "reads": [
            ...
            "source handler vtable slots +0x00/+0x04/+0x08/+0x0c/+0x10/+0x14/+0x18",
        ...
        "callers": ["0x4afa99"],
        "ghidra_dump": "Focused dump .artifacts/rmg_recovery/ghidra_4af463_source_handler_init_dump recovers this initializer and proves generator+0xed8 is the stack-supplied source handler consumed later by 0x4af910. Exact source-handler vtable slot semantic names and same-run ordered replay remain pending.",
    },
    {
        "address": "0x4af910",
        ...
        "reads": [
            ...
            "source handler pointer at generator+0xed8 assigned by 0x4af463",
        ...
        "writes": [
            ...
            "calls generator+0xed8 vtable slot +0x20 with the queued entry first dword",
        ...
        "ghidra_dump": "Focused dump .artifacts/rmg_recovery/ghidra_499ee8_cell_reference_removal_dump/caller_004af910_FUN_004af910.txt recovers this pending-object cleanup path and its handoff into 0x49eb8d. Focused dump .artifacts/rmg_recovery/ghidra_4af463_source_handler_init_dump proves generator+0xed8 is the stack-supplied source handler. Exact source-handler vtable slot +0x20 semantics and same-run ordered replay remain pending.",
    },
    {
        "address": "0x49d2c7",
