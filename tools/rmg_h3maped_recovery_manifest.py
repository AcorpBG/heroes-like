...
FUNCTIONS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "remaining_gap": "0x4a696b and 0x4a7605 now have static callee-side surfaces and the sampled 0x4a7605 direct 0x4a7312 commit path is live-replayed, but runtime ordered replay is still missing for 0x4a696b selected-cell mutations, delegated 0x4a746b/0x4a5e73 generated-cell writes, exact +0xc8/+0xd8 record semantic names, and full before/after GeneratedCell+0x20/+0x24/+0x28/+0x2c state before changing native RMG behavior.",
    },
    {
        "address": "0x4a696b",
    ...
    },
    {
        ...
        "remaining_gap": "Runtime ordered replay is still pending for the 0x4a746b/0x4a5e73 delegated endpoint-writer path, 0x4a5e03 outcomes, generated-cell before/after state, full candidate-vector contents around 0x4a7312 appends/RNG, and exact source/relation/vector-entry semantic names.",
    },
    {
        "address": "0x49b3fb",
