...
FUNCTIONS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "remaining_gap": "0x4a696b and 0x4a7605 now have static callee-side surfaces, but runtime ordered replay is still missing for selected coordinates, GeneratedCell+0x20/+0x24/+0x28/+0x2c before/after state, delegated 0x4a7605 callee outcomes, exact +0xc8 record semantic names, and the connection from those writes back to the 0x4a79a3 dispatch record pair before changing native RMG behavior.",
    },
    {
        "address": "0x4a696b",
    ...
    },
    {
        ...
        "runtime_trace": "Prior 0x4a79a3 dispatch summary proves at least one fallback 0x4a7605 call returned from the 0x4a79a3 +0xc8 dispatch path in the sampled run.",
        ...
        "remaining_gap": "Runtime ordered replay is still pending for delegated 0x4a7312/0x4a746b/0x4a5e03 outcomes, selected coordinates, before/after GeneratedCell state, and exact source/relation/vector-entry semantic names.",
    },
    {
        "address": "0x49b3fb",
