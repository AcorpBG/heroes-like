...
FUNCTIONS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "status": "candidate_static_copy_adapter_not_recovered_producer",
        "reads": [
        ...
        "ghidra_dump": "Full offset scan .artifacts/rmg_recovery/connection_record_offset_access_scan.txt found this as the only non-stack global +0x09 write candidate: 0x4b3c37 MOV byte ptr [EAX+0x09],CH. Objdump shows this function is a copy/adapter around a vtable-returned local record, not yet tied to generator+0xc8/+0xcc ownership or to the 0x4a79a3 compact connection-record stream.",
        "remaining_gap": "Recover the owning caller/vtable source behind 0x4b3c03, or use a runtime watchpoint on generator+0xc8 record byte +0x09 before 0x4a79a3 consumes it, before treating this as the semantic producer of connection_recipe.endpoint_stamping_enabled.",
    },
    {
        "address": "0x49cf34",
