...
FUNCTIONS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "ghidra_dump": "Focused dump recovers the candidate feasibility filter underneath 0x4aa9b7. Exact semantic names for relation+0x0c and 0x49a09c side effects remain replay-pending.",
    },
    {
        "address": "0x49a6f9",
