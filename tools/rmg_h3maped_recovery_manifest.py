...
FUNCTIONS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "status": "ghidra_target_dumped_replay_pending",
        "calls": ["0x42ccc6", "0x42cc99", "0x49b89c", "0x40bb26"],
        "ghidra_dump": "Focused dump generated at .artifacts/rmg_recovery/ghidra_object_projection_helper_dump. References and instruction flow show candidate rectangle scans, generated-cell bit checks, terrain checks, route/adjacency tests, and output-vector appends, but the full score/output field semantics are not recovered yet.",
    },
    {
        "address": "0x49e700",
...
STRUCTS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "status": "recovered_static_constructor_fields",
