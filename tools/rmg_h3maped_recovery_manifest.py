...
FUNCTIONS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "remaining_gap": "Use a runtime write watch or earlier phase boundary snapshot on an actual generator+0xc8 record byte +0x09 before 0x4a79a3 consumes it; if the byte is already initialized, move the trace boundary earlier and name that earlier producer. Do not treat 0x4b3c03 as the semantic producer of connection_recipe.endpoint_stamping_enabled without new evidence.",
    },
    {
        "address": "0x49cf34",
