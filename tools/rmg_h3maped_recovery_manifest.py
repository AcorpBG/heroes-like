...
FUNCTIONS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "callers": ["0x4afa99"],
        "ghidra_dump": "Focused dump .artifacts/rmg_recovery/ghidra_4af463_source_handler_init_dump recovers this initializer and proves generator+0xed8 is the stack-supplied source handler consumed later by 0x4af910. Focused dump .artifacts/rmg_recovery/ghidra_4802ac_source_handler_constructor_dump and objdump artifact .artifacts/rmg_recovery/ghidra_53eafc_source_handler_vtable_dump/vtable_53eafc_objdump.txt recover the concrete vtable slot functions for this caller. Exact underlying container helper semantics and same-run ordered replay remain pending.",
    },
    {
        "address": "0x4802ac",
    ...
    },
    {
        ...
        "status": "recovered_static_disassembly",
        "slots": {
        ...
        "ghidra_dump": "Focused dump .artifacts/rmg_recovery/ghidra_53eafc_source_handler_vtable_dump plus saved objdump disassembly vtable_53eafc_objdump.txt recover the concrete slot table installed by 0x4802ac.",
    },
    {
        "address": "0x4af910",
