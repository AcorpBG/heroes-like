...
FUNCTIONS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "status": "recovered_static_contract_edge_helper_pending",
        ...
        "ghidra_dump": "Focused dump .artifacts/rmg_recovery/ghidra_53eafc_source_handler_erase_helpers_dump recovers the key erase/free-list mutation. The larger edge-maintenance helper 0x42b127 remains semantically pending if exact replay reaches the branch where the removed key is not container+0x10.",
    },
    {
        "address": "0x42abe8",
