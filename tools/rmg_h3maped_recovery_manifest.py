...
FUNCTIONS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "ghidra_dump": "Focused dump .artifacts/rmg_recovery/ghidra_53eafc_source_handler_vtable_dump plus saved objdump disassembly vtable_53eafc_objdump.txt recover the concrete slot table installed by 0x4802ac. Focused dumps .artifacts/rmg_recovery/ghidra_53eafc_source_handler_helpers_dump and .artifacts/rmg_recovery/ghidra_53eafc_source_handler_nested_helpers_dump recover the helper chain used by the slots, except deeper copy-on-write/vector erase helpers that remain pending only if exact source-side replay requires them.",
    },
    {
        "address": "0x42a1ec",
    ...
    },
    {
        ...
        "status": "recovered_static_contract_deeper_erase_pending",
        ...
        "callers": ["0x48047c"],
        "ghidra_dump": "Focused dump .artifacts/rmg_recovery/ghidra_53eafc_source_handler_helpers_dump recovers the queued-key cleanup wrapper used by source-handler vtable slot +0x20. Exact lower erase helper 0x42ab68 remains pending if source-side replay needs it.",
    },
    {
        "address": "0x42034a",
        ...
        "ghidra_dump": "Focused dump .artifacts/rmg_recovery/ghidra_53eafc_source_handler_nested_helpers_dump recovers the source cleanup vector wrapper; exact 0x432d56 and 0x42ab68 internals remain pending.",
    },
    {
        "address": "0x432c27",
