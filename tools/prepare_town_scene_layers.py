...
BRASSHOLLOW_BRIEFS = json.loads((ROOT/'art/towns/source/generated/scene_layers/faction_brasshollow/scene_briefs.json').read_text())
FACTION_BRIEFS = {FACTION: BRIEFS, 'faction_embercourt': EMBERCOURT_BRIEFS, 'faction_mireclaw': MIRECLAW_BRIEFS,
                 ...
                 'faction_brasshollow': BRASSHOLLOW_BRIEFS}
