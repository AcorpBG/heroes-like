...
`tests/native_random_map_package_session_adoption_report.tscn` also covers generated/native package sessions. It validates both the direct package bridge and the active disk-loaded package startup path, requiring the opening session stockpile to contain all nine live resources with `gold`, `wood`, and `ore` at the generated-map opening amounts and each rare resource present at zero. The same report now emits `generated_package_town_economy_surface_v1`, proving generated package towns are backed by authored town templates and seven-tier ladders while player-required common and rare resource sources are present in the live generated resource-node surface. It also gates generated town identity diversity so the strict Small package cannot collapse all towns into one template family; current evidence covers 4 generated project factions and 5 generated town templates across 7 generated towns. It also emits `generated_package_town_economy_source_routes_v1`, proving 21/21 generated package town source routes reachable for player, enemy, and neutral town wood, ore, and faction-rare sources after exact H3M body/block masks and guard-control surfaces are applied, including 4 neutral generated town route cases, while requiring guarded generated economy-source pressure and guarded faction-rare source pressure for every generated player/enemy/neutral town. It also emits `generated_package_town_economy_breadth_v1`, proving 3/3 deterministic strict Small package economy breadth cases with distinct package hashes preserve authored town templates, seven-tier ladders, common resource sources, player-required rare-resource sources, 45/45 reachable generated town source routes, guarded source pressure, and 15/15 guarded faction-rare source routes across 15 total generated towns and 256 generated resource nodes. It also emits `generated_package_player_town_development_runway_v1`, proving the generated player town can use generated resource sources to build all initially missing targets within 30 turns, spend rare resources, preserve one-build-per-day blocking, and recruit all seven tiers; current evidence builds 22 initially missing `town_highwater_keep` targets by day 24. It also emits `generated_package_neutral_town_capture_development_runway_v1`, proving 4/4 generated neutral towns capture into player ownership and then complete live town development with rare spend, one-build-per-day guards, minimal required-resource source adoption, and seven-tier recruitment; current evidence covers completion days 24-28, 85 total neutral-capture builds, and 12 secured generated sources. The report also emits `generated_package_enemy_town_development_runway_v1`, proving 2/2 generated package enemy-town runway cases complete live AI town development with 44 total builds, rare spend, one-build-per-day guards, full live treasury keys, governor report coverage, generated source coverage, seven-tier recruitment candidates, and selected affordable recruitment.
