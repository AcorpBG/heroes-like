...
The art pass is in progress. Embercourt has 16 separate original paintings with matching construction icons: four hall stages, three fortifications, five magic guilds, two markets and two storehouses. Each upgrade changes the architecture. The revised river-quay backdrop provides empty terraces and an open lock, preventing obsolete painted stalls and gates from doubling up beneath the active layers. Older dwelling and support paintings have authored terrace placements while their replacements remain pending.
...
The civic and hall regressions pass 133 and 43 focused Windows Godot checks respectively. All 16 stages and developed-town compositions were visually inspected; all 23 active buildings retain exposed painted click areas for either dwelling branch. The preceding hall slice also passed 676 shared-town checks. Remaining building lines, distinct alternate dwellings and the other factions still need the art pass. No full suite or Linux execution was performed for these art slices.
