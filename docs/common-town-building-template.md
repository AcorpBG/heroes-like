...
The art pass is in progress across factions. All 51 active Embercourt building stages now have separate original paintings and matching construction icons: four halls, three fortifications, five magic guilds, two markets, two storehouses, a tavern, three growth buildings, three hero schools, an artifact exchange, three faction specials and 24 dwelling stages. The dwellings cover both exclusive T1-T5 branches and T6/T7, each with an architectural upgrade. Barracks, boarding schools, siege yards, court/archive buildings, sanctuaries, containment vaults and the colossus foundry have distinct structures and equipment. These are separate paintings, not scaled or recolored copies. The convoy office includes a barge on the river side of its dock. Authored terrace placements and the revised river-quay backdrop keep the lock open without obsolete painted buildings beneath active layers.

Mireclaw's first integrated batch adds 16 separate original stages: four halls, three fortifications, five magic guilds, two markets and two storehouses. Blackbranch timber, reed roofs, structural bone and chain braces establish its marsh-clan identity; guilds use nightglass lenses and the upgraded storehouse adds peatwax processing. The hall develops from a low council lodge through an oath porch and tall longhouse to a broad covenant seat. A newly cleared marsh backdrop removes the old embedded hall, with all 23 plots placed on authored earthen terraces and boardwalk edges. Its remaining 35 support, special and dwelling stages still use their previous paintings pending replacement. The other four factions await this art pass. Approved overworld town sprites are unchanged.
...
Mireclaw's hall and foundation runs pass 182 focused Windows Godot checks (47 hall and 135 foundation), verifying its 16 stages, faction-specific icons, actual cleared-backdrop selection, construction/information routes and exposed input for both developed-town branches. The initial visual review caught a stale hard-coded backdrop selection; the renderer path and regression checks now cover the new scene. The new masters and live compositions were visually reviewed. The 72 creature upgrade identities and animations remain a separate pending pass. No full suite or Linux execution was performed for these art slices.
