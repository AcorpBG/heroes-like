...
The art pass is in progress. Embercourt has 27 separate original paintings with matching construction icons: four hall stages, three fortifications, five magic guilds, two markets, two storehouses, a tavern, three growth buildings, three hero schools, an artifact exchange and three faction specials. Each upgrade changes the architecture. Support buildings express their function through their structure and equipment; the convoy office includes a barge on the river side of its dock. The revised river-quay backdrop provides empty terraces and an open lock, preventing obsolete painted stalls and gates from doubling up beneath the active layers. Older dwelling paintings have authored terrace placements while their 24 branch and upgrade replacements remain pending.

The active hall's alpha-shaped hotspot opens construction and replaces the obsolete backdrop hotspot. Other painted buildings open their information panels. Faction-specific icons are selected by the visiting town; other factions retain their existing artwork.
...
The expanded civic/support regression passes 210 focused Windows Godot checks. The preceding hall slice passed 43 art/input checks and 676 shared-town checks. All 27 paintings and developed-town compositions were visually inspected; all 23 active buildings retain exposed painted click areas for either dwelling branch. Distinct alternate dwellings and the other factions still need the art pass. No full suite or Linux execution was performed for these art slices.
