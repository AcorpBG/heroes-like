...
Mireclaw's complete art run passes 464 focused Windows Godot checks (212 civic/support and 126 per dwelling branch), covering all replacement stages, faction icons, actual backdrop selection, construction/information routes and exposed input for all 23 buildings in both developed branches. The preceding hall/foundation slice passed 182 checks. The original paintings, stage renders and both developed-town compositions were visually reviewed. The 72 creature upgrade identities and animations remain a separate pending pass. No full suite or Linux execution was performed for these art slices.

Sunvault now has 16 original civic stages and matching icons: four council halls, three lens-gate fortifications, five prism guilds, two markets and two storehouses. Ivory limestone, aged brass and blue-violet glazing distinguish the faction; upgrades add wings, floors, lens apparatus and new silhouettes. A cleared sandstone plateau replaces obsolete baked buildings, with all 23 active plots placed on terraces. The civic slice passes 182 focused Windows checks (47 hall and 135 foundation); both developed layouts were reviewed after moving foreground plots above the viewport edge. Exposed input checks now reject off-screen pixels. Its remaining 35 support/special/dwelling stages and the other three factions are still in progress. No full suite or Linux execution.
