...
5. `0x4bb74b/0x4bc5f0` live feedback:
   ...
   - the recovered `0x4ba938` base selector argument surface is now ported: ordinary `0x4bcfc3` calls pass `-1`, final-sweep current-record calls pass the current art row, and the probability threshold uses the source unsigned logical shift.
