...
- generated package town-economy runtime surface coverage, so strict Small native package sessions expose authored town templates, seven-tier town ladders, rare-resource development identity, and live generated common plus player-faction rare resource sources;
- generated package player-town development runway coverage, so the actual disk-loaded strict Small native package player town builds all targets through live rules within 30 turns, spends rare resources, blocks same-day second builds, advances generated economy days, and recruits all seven tiers;
