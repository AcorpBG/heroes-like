...
- The deterministic balance report now requires at least 20 buildable development targets, at least 12 non-unit targets, a day-20 production pacing floor, and at least one late rare-resource bottleneck day per authored town while preserving the 30-turn cap.
...
- Deterministic report: 15/15 authored towns pass, minimum buildable target count is 20, minimum non-unit count is 12, every authored town has late rare-resource bottleneck evidence, and completion days now range from day 24 to day 30.
