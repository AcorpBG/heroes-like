...
- all six faction seed towns complete their authored buildable development within the 30-turn target;
- town construction uses live Godot build rules, not a Python-only simulation;
- every seed town rejects a same-day second build with the live one-build-per-town-per-day guard;
...
Current focused completion days:
...
This is not final scenario-wide economy balance, final market cap persistence, final AI economy planning, or final town UI/art. It is a focused runtime proof that the requested town-development loop is viable through live rules for the six seed faction towns.
