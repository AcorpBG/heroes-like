...
Owner-approved highest-priority Phase 6 queue, 2026-09-12. Combat consequences and bounded tooltips are **completed**; the remaining three slices are **pending**. PLAN.md sets selection order; ops/progress.json owns operational status. The overall goal and fresh Small-map acceptance remain open.
