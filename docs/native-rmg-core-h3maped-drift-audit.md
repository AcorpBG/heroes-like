...
5. Preserve full copied `0x4c` source records and descriptor/source identity through runtime zones and object selection.
6. Expand generated-cell state to real stride-`0x30` records, including object-reference vectors, `+0x14/+0x18`, and `+0x2b`, before claiming a checkpoint.
7. Port relation/scoring/object caller order before route/object/package consumers.
8. Only then add town/object/reward/guard/connection/road/final-writeout phases in recovered order.
