...
- ports runtime terrain selection `0x49b53d` as inspection-only evidence: match-to-town zones use table `0x540908`, treasure zones choose from source terrain flags through h3maped RNG, and terrain cells remain pending `0x4a3f27`;
