...
- ports late connection payload and same-level dispatch evidence from `0x4a79a3`, `0x4a61bc`, `0x4a696b`, `0x4a6cf2`, `0x4a7605`, `0x4a65a5`, `0x4a5e03`, `0x4a5e73`, and `0x4a5a23`; this marks five unique links and ten reciprocal records, scales guard values through the recovered strength helper, records that `0x4a6cf2` returns false for all current one-level links, identifies `0x4a61bc`/`0x4a696b` as the same-level endpoint helpers, and exposes the low/high owner-byte precondition they need, but does not materialize road/river geometry, endpoint objects, or guards;
