...
8. Roads and rivers: `0x4ab52a` and `0x4aae7b` are active only as a private coordinate-vector/pair-cost boundary using town/castle `generator+0x14b0` records. `0x4ab37f`, `0x4b4243`, `0x458a2f`, `0x458893`, and road/river `0x49b2b6` overlay serialization remain blocked. No public road or river bytes are materialized yet.
