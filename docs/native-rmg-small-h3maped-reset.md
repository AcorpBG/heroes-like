...
6. `object_category_placement` - `0x4a8d2c`, `0x4a93a2`, `0x49a1d8`, `0x49aa93`, `0x4a8db2`, `0x4a8c15` - town/castle field consumption, direct owner-byte candidate scanning, and direct validity precheck ported for inspection only; full eligibility/collision, object-cell materialization, weighted placement, and cleanup still pending.
