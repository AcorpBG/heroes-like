...
- decodes the `0x4bcff5` TerrainPlacement static visual table/toolkit boundary from `h3maped.exe`, with live repaint/queue feedback and package adoption still blocked;
