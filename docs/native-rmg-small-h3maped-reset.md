...
- decodes the `0x4bcff5` TerrainPlacement static visual table/toolkit boundary from `h3maped.exe`, runs the private live `0x4bb74b`/`0x4bc5f0` repaint/queue feedback pass, and projects live generated-cell terrain/art/flag words through the private `0x49b2b6` terrain tile-byte contract, with roads/rivers and object placement still blocked;
