...
5. Terrain writeout and TerrainPlacement: `0x49b53d` runtime terrain selection and `0x4a3f27` private terrain cell writeout are active non-public state. `0x4bcff5`, `0x4bb74b`, `0x4bc5f0`, and `0x49b2b6` TerrainPlacement/tile-byte work remain pending in the active compiled restart. Package output remains blocked until terrain art, town, road, object, guard, and final-writeout phases are executable-derived.
