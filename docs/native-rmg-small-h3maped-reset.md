...
8. `final_cell_object_passes` - `0x49eb8d`, `0x4ab52a`, `0x4ac4ae` - `0x4ab52a` pair iteration, `0x4aae2f` path-state reset, the `0x4aae7b` seed-cell low-word initialization, the `0x5a2658` neighbor direction table, and normal-neighbor path-cost propagation are ported for the current clean generated-cell grid; special vectors, object-lane propagation, `0x4b4243` road toolkit writes, and final object passes pending clean port.
