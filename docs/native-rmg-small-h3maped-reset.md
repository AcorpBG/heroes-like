...
7. `guard_reward_monster_placement` - `0x4a9d6a`, `0x4a9911`, `0x4a9c7c`, `0x4a9641`, `0x4aab7e`, `0x4aa354` - mine/reward source field ledgers, `0x4a9911` mine template/record/guard handoff ledger, recovered terrain-mask filtering, `0x4a9641` mine candidate scan/selection/body-cell marking, `0x4aab7e` treasure scheduler density/product/sqrt/accumulator math, and `0x4aa354` reward value RNG selection ported for inspection; production package adoption, `0x4aa1db` reward object lookup, and guarding still pending.
