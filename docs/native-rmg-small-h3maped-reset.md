...
7. `guard_reward_monster_placement` - `0x4a9d6a`, `0x4a9911`, `0x4a9c7c`, `0x4a9641`, `0x4aab7e` - mine/reward source field ledgers, `0x4a9911` mine template/record/guard handoff ledger, recovered terrain-mask filtering, `0x4a9641` mine candidate scan/selection/body-cell marking, and `0x4aab7e` treasure scheduler density/product/sqrt/accumulator math ported for inspection; production package adoption, reward object placement through `0x4aa354`, and guarding still pending.
