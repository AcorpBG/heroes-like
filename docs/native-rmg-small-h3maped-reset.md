...
7. `guard_reward_monster_placement` - `0x4a9d6a`, `0x4a9911`, `0x4a9c7c`, `0x4a9641`, `0x4aab7e`, `0x4aa354`, `0x4aa1db` - mine/reward source field ledgers, `0x4a9911` mine template/record/guard handoff ledger, recovered terrain-mask filtering, `0x4a9641` mine candidate scan/selection/body-cell marking, `0x4aab7e` treasure scheduler density/product/sqrt/accumulator math, `0x4aa354` reward value RNG selection, and `0x4aa1db` object-lookup control-flow ledger ported for inspection; actual `0x4a9f1c` candidate execution, production package adoption, native proxy mapping, and guarding still pending.
