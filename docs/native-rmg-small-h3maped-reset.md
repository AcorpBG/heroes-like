...
- ports late connection payload and same-level dispatch evidence from `0x4a79a3`, `0x4a61bc`, `0x4a696b`, `0x4a6cf2`, `0x4a7605`, `0x4a65a5`, `0x4a5e03`, `0x4a5e73`, and `0x4a5a23`; this marks five unique links and ten reciprocal records, scales guard values through the recovered strength helper, records that `0x4a6cf2` returns false for all current one-level links, and identifies `0x4a61bc`/`0x4a696b` as the same-level endpoint helpers, but does not materialize road/river geometry, endpoint objects, or guards;
...
8. Connections, blockers, and guards: `0x4a79a3`, `0x4a61bc`, `0x4a696b`, `0x4a6cf2`, `0x4a7605`, `0x4a65a5`, `0x4a5e03`, `0x4a5e73`, and `0x4a5a23` (late payload postprocess, guard value scaling, corrected `0x4a6cf2` same-level return-false gate, and same-level dispatch readiness active inspection only; actual `0x4a61bc`/`0x4a696b` endpoint scans, guard object stamping, blockers, mines, rewards, and final adoption still pending).
