...
- runs private partial-vector `0x4ab52a` road pair iteration, `0x4aae7b` path-cost propagation, `0x4ab37f` predecessor-chain road adapter work, `0x458a2f`/`0x458893` road art/flip classification, and `0x49b2b6` road-overlay serialization evidence from the currently materialized town coordinate records only, without public road, river, runtime-grid, or package adoption;
- reports the strict executable-port backlog with every phase after private partial roads marked `pending_strict_port`;
...
7. Roads and rivers: `0x4ab52a`, `0x4aae7b`, `0x4ab37f`, `0x4b4243`, `0x458a2f`, `0x458893`, and `0x49b2b6` are active only as private partial-vector road overlay candidates from currently materialized town coordinate records. Complete `generator+0x14b0` vector parity, river bytes, object-vector producers, public road adoption, and final package writeout remain blocked.
