...
5. Terrain writeout and TerrainPlacement: `0x4a3f27` is active through private terrain cell writeout only, and `0x4bcff5` is active through static visual-table/toolkit decoding only. `0x4bb74b`, `0x4bc5f0`, and `0x49b2b6` remain pending.
