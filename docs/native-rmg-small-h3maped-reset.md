...
- decodes the `0x4bcff5` TerrainPlacement static visual table/toolkit boundary from `h3maped.exe` and runs the private live `0x4bb74b`/`0x4bc5f0` repaint/queue feedback pass, with package tile-byte adoption still blocked;
