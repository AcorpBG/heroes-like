...
8. `final_cell_object_passes` - `0x49eb8d`, `0x4ab52a`, `0x4ac4ae` - `0x4ab52a` pair iteration ported; `0x4aae7b` path-cost mutation, `0x4b4243` road toolkit writes, and final object passes pending clean port.
