...
The active module materializes private inspection-only zone boundary buffers for `0x4a2777`, private inspection-only span-fill buffers for `0x4a325d`, private `0x4a3710` small-land finalizer scheduling evidence, private `0x4a3f27` terrain/cell word evidence, private TerrainPlacement static visual-table evidence, and private town/start placement candidates. It still does not materialize terrain art, runtime players, public towns, roads, blockers, guards, mines, rewards, public runtime grids, or packages.
