...
The active module must not expose `active_generation_state`, `small_generation_state`, `private_generation_context`, private town/object ledgers, or partial package payloads. Previous private footprint, terrain, town, mine, reward, road, blocker, and guard ledgers are archived evidence only; they are not accepted as active generation progress. The next active implementation step is the narrow executable port of `0x4a3a03` / `0x4cc788` zone-footprint source-node setup over the coordinate replay output.

Seed `1`, one human, three total players currently selects `h3maped_template_018` -> `translated_rmg_template_019_v1` through h3maped RNG first value `41` and selected vector index `2`, fills `generator+0xee0/+0xee4` assignment/mapping slots as `[0, 1, 2, -1, -1, -1, -1, -1]`, builds six runtime-zone records with owner colors `[0, 1, -1, 2, -1, -1]`, builds five link seeds with guard values `[3000, 3000, 3000, 6000, 6000]`, and replays coordinates to scaled zone centers `(23,11)`, `(21,22)`, `(12,23)`, `(18,4)`, `(18,30)`, and `(12,11)`. Zone footprints, terrain, towns, mines, rewards, roads, guards, blockers, package adoption, and final writeout remain pending executable ports.
...
4. Coordinate replay and zone-footprint phase: `0x4a1f3b`, `0x4a17f5`, `0x4a1701`, `0x4a1ad8`, and `0x4a19ed` are active through coordinate replay and bbox rescale only. `0x4a3a03`, `0x4cc788`, `0x4ccb64`, `0x4ccdfc`, `0x4a2777`, `0x4a2b33`, `0x4a261a`, `0x4a2413`, `0x4a325d`, and small-land `0x4a3710` remain pending.
...
7. Mines, rewards, and object-vector producers: `0x4a9d6a`, `0x4a9911`, `0x4a9641`, `0x4a9c7c`, `0x4aab7e`, `0x4aa354`, `0x4a9f1c`, `0x4aa9b7`, `0x4aa603`, and `0x4aa3e9`.
