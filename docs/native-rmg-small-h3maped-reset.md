...
7. `guard_reward_monster_placement` - `0x4a9d6a`, `0x4a9911`, `0x4a9c7c`, `0x4a9641`, `0x4aab7e` - mine/reward source field ledgers, `0x4a9911` mine template/record/guard handoff ledger, and the `0x4a9641` placement constraint scan/ranking boundary ported for inspection; `0x4a9641` candidate execution, `0x4aa354`, physical object placement, and guarding still pending.
