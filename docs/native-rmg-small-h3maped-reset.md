...
10. Ports the top-level zone-footprint schedule `0x4a3a03` for inspection: one land level collects six runtime zones, records the `0x4cc788` initial source-node rectangle `-200..400`, records the `0x4ccb64` split-insertion gate and six scheduled `0x4cca55` locator calls, records the `0x4ccdfc` finalized-coordinate gate through `0x4ccd69`, skips the synthetic fallback zone, and records the helper sequence `0x4a2777 -> 0x4a325d -> 0x4a3710`.
