...
1. Port final object serializer payload bodies called by the recovered `0x4ad3eb` two-pass loops, then continue through `0x4ad3de -> 0x4ae09a` from the now-staged generated-cell/object/header private state.
