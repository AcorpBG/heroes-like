...
1. Port the scan-consumer object-materialization branch after the now-native no-object projection path, plus the remaining `0x49a318` object-metadata branch before route/object/package consumers run.
