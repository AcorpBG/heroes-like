...
1. Recover/provide the source-backed Small zero-water `0x4a79a3` fallback record feed for `0x4a7605/0x4a5e03`.
2. Resolve the Medium `0x4a4fc5` source-water input/mutation path or prove source-backed exclusion for supported one-level land.
