...
1. Port source-order `0x4a8c15` relation-vector loop through `0x4a4913` after the recovered post-`0x4a4c8e` cleanup scan, then continue bridge `0x4a5767`, `0x4a4fc5`, and `0x4a79a3`.
