...
This fixes death-event presentation retention. It does not add final authored death timing, camera work, imported VFX/audio, corpse persistence, or combat balance tuning.
