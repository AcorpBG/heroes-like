...
for source,cols,rows,scale,names in [('idle_v2',2,4,.65,['idle']*8),('move_v1',4,2,.73,['move']*8),('attack_v1',4,2,.73,['attack']*8),('reactions_v1',4,2,.73,['hit']*4+['defend']*4),('death_v1',4,2,.73,['death']*8),('cast_v2',2,4,.65,['cast']*8)]:
...
unit={'unit_id':uid,'reference_height':256,'source_facing':'right','alpha_noise_cutoff':8,'frames':frames,'clips':clips,'accepted_clips':[],'preserve_clips':[],'source_scale_by_image':scales,'source_scale_reason':'One fixed scale per original source: 1774x887 sheets at .73, larger per-creature 1024x1536 sheets at .65; matched torso volume, no per-pose size normalization.','visual_review':{'status':'pending','notes':'Artist inspected all 48 poses. New idle fixes old idle/action size mismatch. Root motion review pending. v1 idle edge clipping and v1 support fused silhouettes rejected; originals retained.'}}
