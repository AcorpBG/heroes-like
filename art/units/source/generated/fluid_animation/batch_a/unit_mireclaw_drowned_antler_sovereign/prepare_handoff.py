...
for source,cols,rows,scale,names in [('move_v1',2,4,.65,['move']*8),('attack_v1',2,4,.65,['attack']*8),('reactions_v1',2,4,.65,['hit']*4+['defend']*4),('death_v1',2,4,.61,['death']*8),('cast_v1',2,4,.65,['cast']*8)]:
...
unit={'unit_id':uid,'reference_height':256,'source_facing':'right','alpha_noise_cutoff':8,'frames':frames,'clips':clips,'accepted_clips':[],'preserve_clips':['idle'],'source_scale_by_image':scales,'source_scale_reason':'One fixed scale per original source; normal 320-pixel crown-to-ground at .65 matches inherited 209-pixel idle. Death standing body painted at 344 pixels uses .61. No per-pose size normalization.','visual_review':{'status':'pending','notes':'Artist inspected all 40 new poses plus existing eight-pose idle: original has articulated forepaw weight shift and flexible tail/reed motion, retained pending root motion review. New actions preserve unusual broad feet, long tail and charm crown; single antler thrust and physical bow support, monotonic collapse.'}}
