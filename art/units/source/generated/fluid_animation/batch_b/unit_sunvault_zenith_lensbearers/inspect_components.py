...
import numpy as np
p=Path('art/units/source/generated/fluid_animation/batch_b/unit_sunvault_zenith_lensbearers')
for name in ['attack_v1','hit_defend_v1','death_v1','ranged_v1','cast_v1']:
