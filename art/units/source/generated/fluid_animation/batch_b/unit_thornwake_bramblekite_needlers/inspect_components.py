...
import numpy as np
p=Path('art/units/source/generated/fluid_animation/batch_b/unit_thornwake_bramblekite_needlers')
for name in ['move_v1','defend_v2','attack_v1','hit_defend_v1','death_v1','ranged_v1','cast_v1']:
